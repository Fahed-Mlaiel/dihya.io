...
# from components.metiers.environnement.utils.views.partials.partials_utils import ...
from backend.components.metiers.environnement.utils.views.partials import partials_views
