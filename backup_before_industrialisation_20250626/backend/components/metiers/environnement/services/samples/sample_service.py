"""
Service Python d'exemple ultra avancé pour Environnement, endpoints, logique métier, validation, audit, etc.
"""
...
def hello_sample():
    ...
    return {"message": "Hello from Environnement sample service!"}
