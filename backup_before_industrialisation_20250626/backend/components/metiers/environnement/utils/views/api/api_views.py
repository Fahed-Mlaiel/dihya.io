"""
api_views.py – Helpers et vues API avancées pour le module environnement
...
class EnvironnementAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/environnement/render")
def render_environnement_api(data: EnvironnementAPIModel) -> Dict[str, Any]:
