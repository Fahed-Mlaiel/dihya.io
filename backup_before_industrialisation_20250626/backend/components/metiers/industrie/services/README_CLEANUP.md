...
- Les fichiers `services_industrie.py` et `services_industrie.js` sont supprimés pour éviter toute confusion et redondance.
...
- Les fichiers principaux à utiliser sont :
  - `service_industrie.py` / `service_industrie.js` (logique métier principale)
