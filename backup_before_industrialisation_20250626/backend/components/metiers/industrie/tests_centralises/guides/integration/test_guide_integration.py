...
def test___init___content():
    assert "intégration" in "guide intégration avancé – Métier Industrie".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.industrie.guides.integration import guide_integration
