...
# from components.metiers.transport.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.transport.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Transport</h1>"
