...
# from components.metiers.publicite.utils.views.partials.partials_utils import ...
from backend.components.metiers.publicite.utils.views.partials import partials_views
