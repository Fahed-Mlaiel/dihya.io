# Config – Module Publicite Ultra Avancé

Ce dossier regroupe tous les fichiers, helpers et logiques config spécifiques au métier **Publicite**.
...
## 👩‍💻 Contact référent
- Product Owner : po-publicite@dihya.io
