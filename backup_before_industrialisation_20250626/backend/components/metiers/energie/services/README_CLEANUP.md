...
- Les fichiers `services_energie.py` et `services_energie.js` sont supprimés pour éviter toute confusion et redondance.
...
- Les fichiers principaux à utiliser sont :
  - `service_energie.py` / `service_energie.js` (logique métier principale)
