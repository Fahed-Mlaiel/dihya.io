# Config – Module Recherche Ultra Avancé

Ce dossier regroupe tous les fichiers, helpers et logiques config spécifiques au métier **Recherche**.
...
## 👩‍💻 Contact référent
- Product Owner : po-recherche@dihya.io
