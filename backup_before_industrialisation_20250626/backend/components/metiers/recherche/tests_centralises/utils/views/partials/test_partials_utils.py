...
# from components.metiers.recherche.utils.views.partials.partials_utils import ...
from backend.components.metiers.recherche.utils.views.partials import partials_views
