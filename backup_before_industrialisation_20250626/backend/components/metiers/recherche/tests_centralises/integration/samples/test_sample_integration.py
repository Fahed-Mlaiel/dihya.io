...
"""
Exemple ultra avancé de test d’intégration pour le métier recherche.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.recherche.integration.samples import integration_sample_python
