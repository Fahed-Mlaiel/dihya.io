...
def test___init___content():
    ...
    assert "fonctionnel" in "guide fonctionnel avancé – Métier Hotellerie".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.hotellerie.guides.functional import guide_fonctionnel
