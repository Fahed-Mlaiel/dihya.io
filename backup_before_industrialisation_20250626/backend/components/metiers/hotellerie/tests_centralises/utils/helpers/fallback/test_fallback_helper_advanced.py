...
import pytest
from backend.components.metiers.hotellerie.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.hotellerie.utils.helpers.fallback.fallback import fallback_helper
