...
# from components.metiers.hotellerie.utils.views.partials.partials_utils import ...
from backend.components.metiers.hotellerie.utils.views.partials import partials_views
