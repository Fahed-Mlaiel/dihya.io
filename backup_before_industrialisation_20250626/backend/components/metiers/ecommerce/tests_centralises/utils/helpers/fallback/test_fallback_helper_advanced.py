...
import pytest
from backend.components.metiers.ecommerce.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.ecommerce.utils.helpers.fallback.fallback import fallback_helper
