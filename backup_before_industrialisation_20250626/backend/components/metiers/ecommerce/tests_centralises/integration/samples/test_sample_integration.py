...
"""
Exemple ultra avancé de test d’intégration pour le métier ecommerce.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.ecommerce.integration.samples import integration_sample_python
