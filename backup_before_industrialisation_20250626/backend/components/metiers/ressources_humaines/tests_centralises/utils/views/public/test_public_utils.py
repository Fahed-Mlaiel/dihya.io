...
# from components.metiers.ressources_humaines.utils.views.public.public_utils import ...
from backend.components.metiers.ressources_humaines.utils.views.public import public_views
