...
"""
Exemple ultra avancé de test d’intégration pour le métier ressources_humaines.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.ressources_humaines.integration.samples import integration_sample_python
