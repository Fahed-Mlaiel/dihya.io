...
from backend.components.metiers.ressources_humaines.fixtures.services.services_environnement import services
...
def test_services_fixture_nominal(services):
    val = services
    assert val["service"] == "ressources_humaines_env"
