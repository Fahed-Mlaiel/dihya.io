...
"""
Exemple ultra avancé de test d’intégration pour le métier assurance.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.assurance.integration.samples import integration_sample_python
