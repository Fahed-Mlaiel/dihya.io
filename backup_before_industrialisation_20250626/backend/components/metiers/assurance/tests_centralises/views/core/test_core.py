...
# from components.metiers.assurance.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.assurance.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Assurance</h1>"
