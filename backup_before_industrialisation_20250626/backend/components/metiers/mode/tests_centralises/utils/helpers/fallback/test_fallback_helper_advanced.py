...
import pytest
from backend.components.metiers.mode.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.mode.utils.helpers.fallback.fallback import fallback_helper
