# Config – Module Mode Ultra Avancé

Ce dossier regroupe tous les fichiers, helpers et logiques config spécifiques au métier **Mode**.
...
## 👩‍💻 Contact référent
- Product Owner : po-mode@dihya.io
