...
import pytest
from backend.components.metiers.a_i.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.a_i.utils.helpers.fallback.fallback import fallback_helper
