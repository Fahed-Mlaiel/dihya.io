// api_views.js – Helpers et endpoints API avancés pour le module medias
 ...
 *     responses:
 *       200:
 *         description: Vue medias rendue
 */
router.post('/medias/render', (req, res) => {
