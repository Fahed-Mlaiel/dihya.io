# Config – Module Medias Ultra Avancé

Ce dossier regroupe tous les fichiers, helpers et logiques config spécifiques au métier **Medias**.
...
## 👩‍💻 Contact référent
- Product Owner : po-medias@dihya.io
