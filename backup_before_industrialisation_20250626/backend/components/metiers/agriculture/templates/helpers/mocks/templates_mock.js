// templates_mock.js – Mocks pour tests unitaires et intégration des templates Agriculture (JS)
// Inclut : scénarios spécifiques, edge cases, CI/CD, audit, accessibilité

module.exports = {
  mockRapportAudit: { date: '2025-06-03', result: 'OK' },
  mockEmailNotification: { details: 'Nouvelle scène agriculture créée' },
