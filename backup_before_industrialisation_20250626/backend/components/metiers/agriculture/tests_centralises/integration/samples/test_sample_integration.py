...
"""
Exemple ultra avancé de test d’intégration pour le métier agriculture.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.agriculture.integration.samples import integration_sample_python
