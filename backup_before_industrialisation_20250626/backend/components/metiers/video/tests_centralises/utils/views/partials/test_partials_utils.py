...
# from components.metiers.video.utils.views.partials.partials_utils import ...
from backend.components.metiers.video.utils.views.partials import partials_views
