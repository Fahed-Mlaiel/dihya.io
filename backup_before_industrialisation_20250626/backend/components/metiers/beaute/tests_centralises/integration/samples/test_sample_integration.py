...
"""
Exemple ultra avancé de test d’intégration pour le métier beaute.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.beaute.integration.samples import integration_sample_python
