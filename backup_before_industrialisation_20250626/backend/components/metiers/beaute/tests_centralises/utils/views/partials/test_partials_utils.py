...
# from components.metiers.beaute.utils.views.partials.partials_utils import ...
from backend.components.metiers.beaute.utils.views.partials import partials_views
