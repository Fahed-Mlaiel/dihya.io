...
def test___init___content():
    ...
    assert "fonctionnel" in "guide fonctionnel avancé – Métier RestauratioN".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.restauration.guides.functional import guide_fonctionnel
