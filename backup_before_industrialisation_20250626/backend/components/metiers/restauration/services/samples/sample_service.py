"""
Service Python d'exemple ultra avancé pour RestauratioN, endpoints, logique métier, validation, audit, etc.
"""
...
def hello_sample():
    ...
    return {"message": "Hello from RestauratioN sample service!"}
