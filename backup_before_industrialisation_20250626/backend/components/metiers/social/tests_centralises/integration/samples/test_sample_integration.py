...
"""
Exemple ultra avancé de test d’intégration pour le métier social.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.social.integration.samples import integration_sample_python
