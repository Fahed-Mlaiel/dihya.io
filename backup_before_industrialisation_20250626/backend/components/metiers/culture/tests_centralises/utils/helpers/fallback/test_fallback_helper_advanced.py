...
import pytest
from backend.components.metiers.culture.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.culture.utils.helpers.fallback.fallback import fallback_helper
