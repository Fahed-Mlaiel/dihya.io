...
# from components.metiers.culture.utils.views.partials.partials_utils import ...
from backend.components.metiers.culture.utils.views.partials import partials_views
