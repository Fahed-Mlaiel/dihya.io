...
"""
Exemple ultra avancé de test d’intégration pour le métier culture.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.culture.integration.samples import integration_sample_python
