// test_sample_accessibility.js – Test ultra avancé des samples accessibilité API Banque_Finance (centralisé)

const { sampleAccessibilityCheck } = require('../../../api/samples/accessibility');

describe('Samples Accessibilité API Banque_Finance', () => {
