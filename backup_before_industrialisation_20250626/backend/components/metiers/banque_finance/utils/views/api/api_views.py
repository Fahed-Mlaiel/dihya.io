"""
api_views.py – Helpers et vues API avancées pour le module banque_finance
...
class Banque_FinanceAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/banque_finance/render")
def render_banque_finance_api(data: Banque_FinanceAPIModel) -> Dict[str, Any]:
