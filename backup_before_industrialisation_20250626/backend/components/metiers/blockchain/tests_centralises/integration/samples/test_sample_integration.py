...
"""
Exemple ultra avancé de test d’intégration pour le métier blockchain.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.blockchain.integration.samples import integration_sample_python
