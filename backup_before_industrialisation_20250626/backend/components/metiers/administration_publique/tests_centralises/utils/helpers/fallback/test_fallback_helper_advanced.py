...
import pytest
from backend.components.metiers.administration_publique.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.administration_publique.utils.helpers.fallback.fallback import fallback_helper
