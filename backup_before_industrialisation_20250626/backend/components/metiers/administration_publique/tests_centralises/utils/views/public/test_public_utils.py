...
# from components.metiers.administration_publique.utils.views.public.public_utils import ...
from backend.components.metiers.administration_publique.utils.views.public import public_views
