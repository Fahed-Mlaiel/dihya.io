# Config – Module Administration_publique Ultra Avancé

Ce dossier regroupe tous les fichiers, helpers et logiques config spécifiques au métier **Administration_publique**.
...
## 👩‍💻 Contact référent
- Product Owner : po-administration_publique@dihya.io
