"""
services.py – Services d’audit avancés pour le legacy administration_publique
...
from backend.components.metiers.administration_publique.legacy.audit.models.models import AuditLog
