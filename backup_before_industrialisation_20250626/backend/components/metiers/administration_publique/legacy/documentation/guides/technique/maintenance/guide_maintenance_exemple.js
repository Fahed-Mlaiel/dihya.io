// Guide maintenance automatisé legacy administration_publique (JS)
// Ultra avancé, clé en main, conforme au cahier des charges
function guideMaintenanceExemple() {
  console.log('# Guide maintenance legacy administration_publique\n');
