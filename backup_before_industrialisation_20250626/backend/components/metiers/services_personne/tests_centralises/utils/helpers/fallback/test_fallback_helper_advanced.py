...
import pytest
from backend.components.metiers.services_personne.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.services_personne.utils.helpers.fallback.fallback import fallback_helper
