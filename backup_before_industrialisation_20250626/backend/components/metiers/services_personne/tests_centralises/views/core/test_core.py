...
# from components.metiers.services_personne.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.services_personne.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur ServicesPersonne</h1>"
