...
## Objectif
Tests avancés pour l’API REST/GraphQL de gestion du tourisme (agences, offices, IA, VR, AR, etc.)
...
## Structure des tests
- `test_tourisme.js` : tests d’intégration API (GET, POST, sécurité, i18n, plugins, RGPD, audit)
...
```bash
npm run test:integration -- --testPathPattern=tourisme
```
...
# Integration Tests – Tourism (English)
