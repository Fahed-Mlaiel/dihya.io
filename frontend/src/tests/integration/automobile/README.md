# Tests d'intégration pour le secteur Automobile

Ce dossier contient les tests d'intégration pour les fonctionnalités liées à l'automobile dans la plateforme Dihya Coding.

## Objectifs
- Vérifier l'intégration des modules IA, VR, AR pour l'automobile.
...
- Couvrir les cas d'usage métier (gestion de flotte, IA prédictive, etc.).
...
## Exécution
```bash
npm run test:integration -- --sector=automobile
```
...
# Integration Tests for Automobile Sector

This folder contains integration tests for automobile-related features in the Dihya Coding platform.

## Goals
- Validate integration of AI, VR, AR modules for automobile.
...
- Cover business use cases (fleet management, predictive AI, etc.).
