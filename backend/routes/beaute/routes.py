"""
Ultra-Industrialisation : Module Beauté (Dihya)
...
from .views import BeauteProjectViewSet, BeauteAssetViewSet
from .schemas import BeauteProjectSchema, BeauteAssetSchema
from .plugins import *
from .audit import *
from .i18n import *
...
router.register(r'beauteProjects', BeauteProjectViewSet, basename='beaute-project')
router.register(r'beauteAssets', BeauteAssetViewSet, basename='beaute-asset')
