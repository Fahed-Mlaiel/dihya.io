"""
Routes backend Django pour la gestion Arts (Dihya)
...
# from .views import ArtsProjectViewSet, ArtsAssetViewSet
# from .schemas import ArtsProjectSchema, ArtsAssetSchema
# from .plugins import *
# from .audit import *
# from .i18n import *
...
# router.register(r'artsProjects', ArtsProjectViewSet, basename='arts-project')
# router.register(r'artsAssets', ArtsAssetViewSet, basename='arts-asset')
