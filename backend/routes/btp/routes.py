"""
Ultra-Industrialisation : Module BTP (Dihya)
...
from .views import BTPProjectViewSet, BTPAssetViewSet
from .schemas import BTPProjectSchema, BTPAssetSchema
from .plugins import *
from .audit import *
from .i18n import *
...
router.register(r'btpProjects', BTPProjectViewSet, basename='btp-project')
router.register(r'btpAssets', BTPAssetViewSet, basename='btp-asset')
