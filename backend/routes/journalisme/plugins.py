"""
Plugins ultra avancés pour le module Journalisme (Django routes)
...
class PluginManager:
    def __init__(self):
        self.plugins: List[JournalismePluginBase] = []

    def register(self, plugin: JournalismePluginBase):
        self.plugins.append(plugin)
        journalisme_audit_logger.log_plugin(plugin.name, 'register')
