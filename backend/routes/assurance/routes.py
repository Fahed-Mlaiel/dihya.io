"""
Ultra-Industrialisation : Module Assurance (Dihya)
...
from .views import AssuranceProjectViewSet, AssuranceAssetViewSet
from .schemas import AssuranceProjectSchema, AssuranceAssetSchema
from .plugins import *
from .audit import *
from .i18n import *
...
router.register(r'assuranceProjects', AssuranceProjectViewSet, basename='assurance-project')
router.register(r'assuranceAssets', AssuranceAssetViewSet, basename='assurance-asset')
