...
"""
Exemple ultra avancé de test d’intégration pour le métier vr_ar.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.vr_ar.integration.samples import integration_sample_python
