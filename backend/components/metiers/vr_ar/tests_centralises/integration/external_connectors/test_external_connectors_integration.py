...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier vr_ar.
...
from backend.components.metiers.vr_ar.integration.external_connectors import integration_external
