...
"""
Tests d’intégration ultra avancés pour le monitoring métier vr_ar.
...
from backend.components.metiers.vr_ar.integration.monitoring import integration_monitoring
