...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier vr_ar.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.vr_ar.integration.pipelines import integration_pipelines
