...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatvr_arDetails préfixe correctement', () => {
        expect(helpers.formatvr_arDetails('Ultra')).toBe('[vr_ar] Ultra');
    });
    ...
    it('formatvr_arDetails gère les détails vides', () => {
        expect(helpers.formatvr_arDetails('')).toBe('[vr_ar] ');
    });
});
