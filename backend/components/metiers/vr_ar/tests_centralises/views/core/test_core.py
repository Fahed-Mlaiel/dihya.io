...
# from components.metiers.vr_ar.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.vr_ar.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur vr_ar</h1>"
