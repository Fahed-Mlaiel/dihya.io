...
import pytest
from backend.components.metiers.vr_ar.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.vr_ar.utils.helpers.fallback.fallback import fallback_helper
