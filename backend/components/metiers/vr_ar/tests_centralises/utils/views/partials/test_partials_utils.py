...
# from components.metiers.vr_ar.utils.views.partials.partials_utils import ...
from backend.components.metiers.vr_ar.utils.views.partials import partials_views
