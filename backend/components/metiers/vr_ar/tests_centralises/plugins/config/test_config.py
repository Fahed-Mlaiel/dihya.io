...
"""
Tests avancés pour la configuration des plugins vr_ar.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.vr_ar.plugins.config.ultra_advanced_config import PluginConfigManager
