...
"""
Tests avancés pour les helpers des plugins vr_ar.
"""
...
def test_advanced_helper_function_exists():
    from backend.components.metiers.vr_ar.plugins.helpers.ultra_advanced_helpers import advanced_helper_function
