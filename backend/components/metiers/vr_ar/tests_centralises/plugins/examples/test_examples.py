...
"""
Tests avancés pour les exemples des plugins vr_ar.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.vr_ar.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
