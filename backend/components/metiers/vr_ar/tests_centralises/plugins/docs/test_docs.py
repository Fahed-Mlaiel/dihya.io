...
"""
Tests avancés pour la documentation des plugins vr_ar.
"""
...
def test_generate_plugin_docs_exists():
    from backend.components.metiers.vr_ar.plugins.docs.ultra_advanced_docs import generate_plugin_docs
