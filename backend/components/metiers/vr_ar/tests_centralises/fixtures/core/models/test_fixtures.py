...
import pytest
from backend.components.metiers.vr_ar.fixtures.core.models.fixtures import (
    sample_vr_ar_asset,
    advanced_vr_ar_model,
    asset_texture,
    user_admin,
)
...
def test_sample_asset(sample_vr_ar_asset):
    asset = sample_vr_ar_asset
    assert asset["name"] == "Cube"

def test_advanced_model(advanced_vr_ar_model):
    model = advanced_vr_ar_model
