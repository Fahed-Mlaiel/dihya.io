/* global console */
# Templates vr_ar – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier vr_ar (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit vr_ar
...
- `templatesvr_ar.templatesvr_ar.js` : template JS avancé
