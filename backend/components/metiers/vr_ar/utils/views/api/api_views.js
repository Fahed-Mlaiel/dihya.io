// api_views.js – Helpers et endpoints API avancés pour le module vr_ar
 ...
 *     responses:
 *       200:
 *         description: Vue vr_ar rendue
 */
router.post('/vr_ar/render', (req, res) => {
