# Utils – Politique de sécurité et conformité (Dihya Coding)
...
## Exemples de règles
- Un invité ne peut pas créer/modifier/supprimer un utilitaire
- Un user peut gérer ses propres utilitaires
