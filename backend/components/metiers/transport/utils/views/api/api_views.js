// api_views.js – Helpers et endpoints API avancés pour le module transport
 ...
 *   post:
 *     summary: Rendu transport via API
 *     tags: [Transport]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *     responses:
 *       200:
 *         description: Vue transport rendue
 */
router.post('/transport/render', (req, res) => {
