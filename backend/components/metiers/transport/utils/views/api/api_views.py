"""
api_views.py – Helpers et vues API avancées pour le module transport
...
class TransportAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/transport/render")
def render_transport_api(data: TransportAPIModel) -> Dict[str, Any]:
