// fixtures.js - Fixtures ultra avancés pour le module transport

module.exports = {
  sampletransportModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle transport est incomplet.' },
