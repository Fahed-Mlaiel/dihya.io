"""
services_controller.py - Contrôleur avancé pour les services Transport (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_transport import ServiceTransport, get_transport_model, list_transport_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_transport_model(model_id)
