...
# from components.metiers.transport.utils.views.partials.partials_utils import ...
from backend.components.metiers.transport.utils.views.partials import partials_views
