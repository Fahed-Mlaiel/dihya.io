...
import pytest
from backend.components.metiers.transport.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.transport.utils.helpers.fallback.fallback import fallback_helper
