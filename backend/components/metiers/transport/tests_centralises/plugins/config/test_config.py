...
"""
Tests avancés pour la configuration des plugins transport.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.transport.plugins.config.ultra_advanced_config import PluginConfigManager
