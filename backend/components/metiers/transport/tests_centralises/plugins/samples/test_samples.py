...
"""
Tests avancés pour les samples des plugins transport.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.transport.plugins.samples.plugins_samples import exemple_plugin_sample
