...
"""
Exemple ultra avancé de test d’intégration pour le métier transport.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.transport.integration.samples import integration_sample_python
