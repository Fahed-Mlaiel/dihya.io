...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier transport.
...
from backend.components.metiers.transport.integration.external_connectors import integration_external
