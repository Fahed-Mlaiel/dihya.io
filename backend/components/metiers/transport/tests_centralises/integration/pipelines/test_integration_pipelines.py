...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier transport.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.transport.integration.pipelines import integration_pipelines
