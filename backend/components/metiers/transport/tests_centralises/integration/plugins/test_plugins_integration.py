...
"""
Tests d’intégration ultra avancés pour les plugins métier transport.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.transport.integration.plugins import integration_plugins
