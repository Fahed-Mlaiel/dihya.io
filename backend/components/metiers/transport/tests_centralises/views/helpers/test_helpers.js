...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatTransportDetails préfixe correctement', () => {
        expect(helpers.formatTransportDetails('Ultra')).toBe('[transport] Ultra');
    });
    ...
    it('formatTransportDetails gère les détails vides', () => {
        expect(helpers.formatTransportDetails('')).toBe('[transport] ');
    });
});
