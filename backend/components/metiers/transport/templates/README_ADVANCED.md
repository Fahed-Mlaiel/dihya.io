/* global console */
# Templates Transport – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier transport (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit transport
...
- `templatestransport.templatestransport.js` : template JS avancé
