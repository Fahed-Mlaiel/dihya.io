"""
services_controller.py - Contrôleur avancé pour les services A_I (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_a_i import ServiceA_I, get_a_i_model, list_a_i_models, audit_model
