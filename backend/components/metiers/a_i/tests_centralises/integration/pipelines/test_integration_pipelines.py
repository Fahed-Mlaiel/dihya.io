...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier a_i.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.a_i.integration.pipelines import integration_pipelines
