...
import pytest
from backend.components.metiers.a_i.fixtures.core.models.fixtures import (
    sample_a_i_asset,
    advanced_a_i_model,
    asset_texture,
    user_admin,
...
def test_sample_asset(sample_a_i_asset):
    asset = sample_a_i_asset
    assert asset["name"] == "Cube"

def test_advanced_model(advanced_a_i_model):
    model = advanced_a_i_model
