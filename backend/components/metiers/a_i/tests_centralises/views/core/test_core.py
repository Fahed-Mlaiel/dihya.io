...
# from components.metiers.a_i.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.a_i.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur A_I</h1>"
