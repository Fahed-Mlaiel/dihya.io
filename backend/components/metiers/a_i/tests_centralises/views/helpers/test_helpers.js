...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatA_IDetails préfixe correctement', () => {
        expect(helpers.formatA_IDetails('Ultra')).toBe('[a_i] Ultra');
    });
    ...
    it('formatA_IDetails gère les détails vides', () => {
        expect(helpers.formatA_IDetails('')).toBe('[a_i] ');
    });
});
