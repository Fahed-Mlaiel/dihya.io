...
"""
Tests avancés pour les helpers des plugins a_i.
"""
...
def test_advanced_helper_function_exists():
    from backend.components.metiers.a_i.plugins.helpers.ultra_advanced_helpers import advanced_helper_function
