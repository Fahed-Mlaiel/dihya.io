...
"""
Tests avancés pour les exemples des plugins a_i.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.a_i.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
