...
"""
Tests avancés pour la configuration des plugins a_i.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.a_i.plugins.config.ultra_advanced_config import PluginConfigManager
