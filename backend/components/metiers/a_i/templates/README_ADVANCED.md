/* global console */
# Templates A_I – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier a_i (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit a_i
...
- `templatesa_i.templatesa_i.js` : template JS avancé
