/* global console */
# Templates Recherche – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier recherche (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit recherche
...
- `templatesrecherche.templatesrecherche.js` : template JS avancé
