...
import pytest
from backend.components.metiers.recherche.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.recherche.utils.helpers.fallback.fallback import fallback_helper
