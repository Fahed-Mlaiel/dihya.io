...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatRechercheDetails préfixe correctement', () => {
        expect(helpers.formatRechercheDetails('Ultra')).toBe('[recherche] Ultra');
    });
    ...
    it('formatRechercheDetails gère les détails vides', () => {
        expect(helpers.formatRechercheDetails('')).toBe('[recherche] ');
    });
});
