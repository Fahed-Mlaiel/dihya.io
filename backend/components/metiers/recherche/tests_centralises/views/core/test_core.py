...
# from components.metiers.recherche.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.recherche.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Recherche</h1>"
