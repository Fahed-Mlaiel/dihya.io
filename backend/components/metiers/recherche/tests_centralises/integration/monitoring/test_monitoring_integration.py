...
"""
Tests d’intégration ultra avancés pour le monitoring métier recherche.
...
from backend.components.metiers.recherche.integration.monitoring import integration_monitoring
