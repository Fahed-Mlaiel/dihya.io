...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier recherche.
...
from backend.components.metiers.recherche.integration.api import integration_api
