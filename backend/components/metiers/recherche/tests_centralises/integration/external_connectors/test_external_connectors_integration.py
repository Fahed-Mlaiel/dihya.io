...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier recherche.
...
from backend.components.metiers.recherche.integration.external_connectors import integration_external
