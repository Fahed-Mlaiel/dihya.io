...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier recherche.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.recherche.integration.pipelines import integration_pipelines
