...
"""
Tests d’intégration ultra avancés pour les plugins métier recherche.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.recherche.integration.plugins import integration_plugins
