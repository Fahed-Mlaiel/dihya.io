...
"""
Tests avancés pour la configuration des plugins recherche.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.recherche.plugins.config.ultra_advanced_config import PluginConfigManager
