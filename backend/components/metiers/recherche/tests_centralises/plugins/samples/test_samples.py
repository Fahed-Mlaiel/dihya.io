...
"""
Tests avancés pour les samples des plugins recherche.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.recherche.plugins.samples.plugins_samples import exemple_plugin_sample
