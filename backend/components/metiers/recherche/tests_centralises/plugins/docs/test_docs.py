...
"""
Tests avancés pour la documentation des plugins recherche.
"""
...
def test_generate_plugin_docs_exists():
    from backend.components.metiers.recherche.plugins.docs.ultra_advanced_docs import generate_plugin_docs
