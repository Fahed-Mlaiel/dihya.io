// fixtures.js - Fixtures ultra avancés pour le module recherche

module.exports = {
  samplerechercheModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle recherche est incomplet.' },
