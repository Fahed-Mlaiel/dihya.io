"""
services_controller.py - Contrôleur avancé pour les services Recherche (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_recherche import ServiceRecherche, get_recherche_model, list_recherche_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_recherche_model(model_id)
