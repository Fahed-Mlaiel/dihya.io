/* global console */
# Services Recherche – Documentation Ultra Avancée
...
# Services Recherche – Documentation Ultra Avancée (complément)
...
### Python
```python
from .services_recherche import get_advanced_recherche_model, audit_advanced_model
print(get_advanced_recherche_model('model-003'))
...
# Services Recherche – Guide Avancé

## Exemples d'utilisation

```python
from .mon_service import traitement_recherche
```
