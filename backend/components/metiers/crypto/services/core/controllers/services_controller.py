"""
services_controller.py - Contrôleur avancé pour les services Crypto (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_crypto import ServiceCrypto, get_crypto_model, list_crypto_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_crypto_model(model_id)
