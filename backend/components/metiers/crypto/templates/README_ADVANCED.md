/* global console */
# Templates Crypto – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier crypto (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit crypto
...
- `templatescrypto.templatescrypto.js` : template JS avancé
