...
"""
Tests avancés pour la configuration des plugins crypto.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.crypto.plugins.config.ultra_advanced_config import PluginConfigManager
