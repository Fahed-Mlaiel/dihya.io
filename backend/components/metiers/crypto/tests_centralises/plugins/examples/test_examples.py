...
"""
Tests avancés pour les exemples des plugins crypto.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.crypto.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
