...
# from components.metiers.crypto.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.crypto.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Crypto</h1>"
