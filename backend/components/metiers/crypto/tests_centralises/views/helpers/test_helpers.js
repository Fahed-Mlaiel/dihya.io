...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatCryptoDetails préfixe correctement', () => {
        expect(helpers.formatCryptoDetails('Ultra')).toBe('[crypto] Ultra');
    });
    ...
    it('formatCryptoDetails gère les détails vides', () => {
        expect(helpers.formatCryptoDetails('')).toBe('[crypto] ');
    });
});
