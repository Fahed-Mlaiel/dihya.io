...
import pytest
from backend.components.metiers.crypto.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.crypto.utils.helpers.fallback.fallback import fallback_helper
