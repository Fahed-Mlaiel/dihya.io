...
# from components.metiers.crypto.utils.views.partials.partials_utils import ...
from backend.components.metiers.crypto.utils.views.partials import partials_views
