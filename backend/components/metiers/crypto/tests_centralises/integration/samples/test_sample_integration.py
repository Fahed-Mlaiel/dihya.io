...
"""
Exemple ultra avancé de test d’intégration pour le métier crypto.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.crypto.integration.samples import integration_sample_python
