...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier crypto.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.crypto.integration.pipelines import integration_pipelines
