...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier crypto.
...
from backend.components.metiers.crypto.integration.api import integration_api
