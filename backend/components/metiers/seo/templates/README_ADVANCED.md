/* global console */
# Templates Seo – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier seo (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit seo
...
- `templatesseo.templatesseo.js` : template JS avancé
