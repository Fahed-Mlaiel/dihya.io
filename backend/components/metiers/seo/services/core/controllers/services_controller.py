"""
services_controller.py - Contrôleur avancé pour les services Seo (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_seo import ServiceSeo, get_seo_model, list_seo_models, audit_model
