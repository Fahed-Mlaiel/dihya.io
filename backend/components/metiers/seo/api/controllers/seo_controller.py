"""
seo_controller.py – Contrôleur ultra avancé API Seo (Python)
...
from ..validators.validators import validate_seo_entity
...
def create_seo(data: dict):
    ...
    validate_seo_entity(data)
    created = db_insert("seo", data)
...
@router.put("/seo/{id}")
def update_seo(id: int, data: dict):
    before_action("update", {"id": id, **data})
    validate_seo_entity(data)
    updated = db_update("seo", id, data)
...
def delete_seo(id: int):
    before_action("delete", {"id": id})
    deleted = db_delete("seo", id)
    audit_entity({"id": id}, "delete")
    after_action("delete", {"id": id})
    return deleted


# Es gibt keine Klasse SeoController, sondern nur Funktions-Exporte.
...
class SeoController:
    ...
    @staticmethod
    def create(data):
        return create_seo(data)

    @staticmethod
    def update(id, data):
        return update_seo(id, data)

    @staticmethod
    def delete(id):
        return delete_seo(id)
