# SEO – Politique de sécurité et conformité (Dihya Coding)
- **RBAC** : Accès par rôle (admin, seo, invité)
...
## Exemples de règles
- Un invité ne peut pas créer/modifier/supprimer une entrée SEO
- Un seo peut gérer ses propres entrées
