...
"""
Tests avancés pour la configuration des plugins seo.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.seo.plugins.config.ultra_advanced_config import PluginConfigManager
