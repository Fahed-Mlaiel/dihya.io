...
import pytest
from backend.components.metiers.seo.fixtures.core.models.fixtures import (
    sample_seo_asset,
    advanced_seo_model,
    asset_texture,
    user_admin,
...
def test_sample_asset(sample_seo_asset):
    asset = sample_seo_asset
    assert asset["name"] == "Cube"

def test_advanced_model(advanced_seo_model):
    model = advanced_seo_model
