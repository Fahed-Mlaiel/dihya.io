...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatSeoDetails préfixe correctement', () => {
        expect(helpers.formatSeoDetails('Ultra')).toBe('[seo] Ultra');
    });
    ...
    it('formatSeoDetails gère les détails vides', () => {
        expect(helpers.formatSeoDetails('')).toBe('[seo] ');
    });
});
