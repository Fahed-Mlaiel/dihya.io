...
# from components.metiers.seo.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.seo.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Seo</h1>"
