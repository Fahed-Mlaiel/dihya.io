...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier seo.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.seo.integration.pipelines import integration_pipelines
