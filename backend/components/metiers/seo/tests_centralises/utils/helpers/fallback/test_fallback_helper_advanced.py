...
import pytest
from backend.components.metiers.seo.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.seo.utils.helpers.fallback.fallback import fallback_helper
