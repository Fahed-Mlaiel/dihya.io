# Config – Module Restauration Ultra Avancé

Ce dossier regroupe tous les fichiers, helpers et logiques config spécifiques au métier **Restauration**.
...
## 👩‍💻 Contact référent
- Product Owner : po-restauration@dihya.io
