"""
api_views.py – Helpers et vues API avancées pour le module restauration
...
class RestauratioNAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/restauration/render")
def render_restauration_api(data: RestauratioNAPIModel) -> Dict[str, Any]:
