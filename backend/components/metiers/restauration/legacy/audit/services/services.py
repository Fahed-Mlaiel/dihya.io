"""
services.py – Services d’audit avancés pour le legacy RestauratioN
...
from backend.components.metiers.restauration.legacy.audit.models.models import AuditLog
