// fixtures.js - Fixtures ultra avancés pour le module restauration

module.exports = {
  samplerestaurationModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle restauration est incomplet.' },
