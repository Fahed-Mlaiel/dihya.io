"""
services_controller.py - Contrôleur avancé pour les services RestauratioN (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_restauration import ServiceRestauratioN, get_restauration_model, list_restauration_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_restauration_model(model_id)
