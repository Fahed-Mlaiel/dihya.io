// service_restauration.js - Service principal restauration (JS)
...
module.exports = {
  ServiceRestauratioN,
  getrestaurationModel,
  listrestaurationModels,
  auditModel,
  secureAccess
};
