...
- Les fichiers `services_restauration.py` et `services_restauration.js` sont supprimés pour éviter toute confusion et redondance.
...
- Les fichiers principaux à utiliser sont :
  - `service_restauration.py` / `service_restauration.js` (logique métier principale)
