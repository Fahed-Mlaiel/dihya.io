/* global console */
# Services RestauratioN – Documentation Ultra Avancée
...
# Services RestauratioN – Documentation Ultra Avancée (complément)
...
### Python
```python
from .services_restauration import get_advanced_restauration_model, audit_advanced_model
print(get_advanced_restauration_model('model-003'))
...
# Services RestauratioN – Guide Avancé

## Exemples d'utilisation

```python
from .mon_service import traitement_restauration
```
