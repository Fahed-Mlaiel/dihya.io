# Restauration – Politique de sécurité et conformité (Dihya Coding)
- **RBAC** : Accès par rôle (admin, restaurateur, invité)
...
- Un restaurateur peut gérer ses propres réservations
