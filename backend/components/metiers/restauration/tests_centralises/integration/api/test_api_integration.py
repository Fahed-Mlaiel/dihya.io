...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier restauration.
...
from backend.components.metiers.restauration.integration.api import integration_api
