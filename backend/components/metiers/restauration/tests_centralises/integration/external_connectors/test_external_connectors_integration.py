...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier restauration.
...
from backend.components.metiers.restauration.integration.external_connectors import integration_external
