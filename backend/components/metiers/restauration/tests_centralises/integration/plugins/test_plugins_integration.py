...
"""
Tests d’intégration ultra avancés pour les plugins métier restauration.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.restauration.integration.plugins import integration_plugins
