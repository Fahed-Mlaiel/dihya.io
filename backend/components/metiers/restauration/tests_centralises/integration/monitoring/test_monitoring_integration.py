...
"""
Tests d’intégration ultra avancés pour le monitoring métier restauration.
...
from backend.components.metiers.restauration.integration.monitoring import integration_monitoring
