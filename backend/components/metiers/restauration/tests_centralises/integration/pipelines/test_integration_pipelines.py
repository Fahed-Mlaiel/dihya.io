...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier restauration.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.restauration.integration.pipelines import integration_pipelines
