...
"""
Exemple ultra avancé de test d’intégration pour le métier restauration.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.restauration.integration.samples import integration_sample_python
