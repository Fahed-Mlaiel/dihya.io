...
# from components.metiers.restauration.utils.views.public.public_utils import ...
from backend.components.metiers.restauration.utils.views.public import public_views
