...
# from components.metiers.restauration.utils.views.partials.partials_utils import ...
from backend.components.metiers.restauration.utils.views.partials import partials_views
