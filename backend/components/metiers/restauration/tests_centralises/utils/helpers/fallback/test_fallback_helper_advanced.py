...
import pytest
from backend.components.metiers.restauration.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.restauration.utils.helpers.fallback.fallback import fallback_helper
