...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatRestauratioNDetails préfixe correctement', () => {
        expect(helpers.formatRestauratioNDetails('Ultra')).toBe('[restauration] Ultra');
    });
    ...
    it('formatRestauratioNDetails gère les détails vides', () => {
        expect(helpers.formatRestauratioNDetails('')).toBe('[restauration] ');
    });
});
