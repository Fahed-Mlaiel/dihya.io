...
"""
Tests avancés pour les samples des plugins restauration.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.restauration.plugins.samples.plugins_samples import exemple_plugin_sample
