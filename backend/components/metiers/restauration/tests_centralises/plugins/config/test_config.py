...
"""
Tests avancés pour la configuration des plugins restauration.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.restauration.plugins.config.ultra_advanced_config import PluginConfigManager
