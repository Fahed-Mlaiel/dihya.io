...
"""
Tests avancés pour les exemples des plugins restauration.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.restauration.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
