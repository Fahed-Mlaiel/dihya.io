/* global console */
# Templates RestauratioN – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier restauration (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit restauration
...
- `templatesrestauration.templatesrestauration.js` : template JS avancé
