...
def test___init___content():
    assert "intégration" in "guide intégration avancé – Métier Automobile".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.automobile.guides.integration import guide_integration
