...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier automobile.
...
from backend.components.metiers.automobile.integration.external_connectors import integration_external
