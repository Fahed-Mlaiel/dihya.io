...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier automobile.
...
from backend.components.metiers.automobile.integration.api import integration_api
