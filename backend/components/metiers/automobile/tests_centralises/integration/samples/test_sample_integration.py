...
"""
Exemple ultra avancé de test d’intégration pour le métier automobile.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.automobile.integration.samples import integration_sample_python
