...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier automobile.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.automobile.integration.pipelines import integration_pipelines
