...
# from components.metiers.automobile.utils.views.partials.partials_utils import ...
from backend.components.metiers.automobile.utils.views.partials import partials_views
