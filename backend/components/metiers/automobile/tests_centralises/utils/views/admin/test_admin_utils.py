...
# from components.metiers.automobile.utils.views.admin.admin_utils import ...


import pytest
from fastapi import HTTPException
from backend.components.metiers.automobile.utils.views.admin import admin_views
