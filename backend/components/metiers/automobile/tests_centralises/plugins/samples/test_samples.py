...
"""
Tests avancés pour les samples des plugins automobile.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.automobile.plugins.samples.plugins_samples import exemple_plugin_sample
