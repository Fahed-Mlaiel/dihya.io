...
"""
Tests avancés pour la configuration des plugins automobile.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.automobile.plugins.config.ultra_advanced_config import PluginConfigManager
