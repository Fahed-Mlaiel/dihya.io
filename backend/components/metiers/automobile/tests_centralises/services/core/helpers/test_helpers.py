...
def test_services_helper_nominal():
    from backend.components.metiers.automobile.services.core.helpers.services_helper import ServicesHelper
...
def test_get_service_status():
    from backend.components.metiers.automobile.services.core.helpers.services_helper import get_service_status
