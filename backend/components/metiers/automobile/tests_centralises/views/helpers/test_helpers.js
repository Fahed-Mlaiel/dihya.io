...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatAutomobileDetails préfixe correctement', () => {
        expect(helpers.formatAutomobileDetails('Ultra')).toBe('[automobile] Ultra');
    });
    ...
    it('formatAutomobileDetails gère les détails vides', () => {
        expect(helpers.formatAutomobileDetails('')).toBe('[automobile] ');
    });
});
