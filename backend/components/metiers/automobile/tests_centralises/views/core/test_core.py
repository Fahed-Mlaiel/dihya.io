...
# from components.metiers.automobile.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.automobile.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Automobile</h1>"
