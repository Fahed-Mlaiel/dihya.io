/* global console */
# Templates Automobile – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier automobile (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit automobile
...
- `templatesautomobile.templatesautomobile.js` : template JS avancé
