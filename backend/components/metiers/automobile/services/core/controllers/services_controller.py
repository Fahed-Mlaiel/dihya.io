"""
services_controller.py - Contrôleur avancé pour les services Automobile (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_automobile import ServiceAutomobile, get_automobile_model, list_automobile_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_automobile_model(model_id)
