// fixtures.js - Fixtures ultra avancés pour le module automobile

module.exports = {
  sampleautomobileModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle automobile est incomplet.' },
