"""
services_controller.py - Contrôleur avancé pour les services Voyage (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_voyage import ServiceVoyage, get_voyage_model, list_voyage_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_voyage_model(model_id)
