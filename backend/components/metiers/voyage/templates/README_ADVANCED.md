/* global console */
# Templates Voyage – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier voyage (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit voyage
...
- `templatesvoyage.templatesvoyage.js` : template JS avancé
