// api_views.js – Helpers et endpoints API avancés pour le module voyage
 ...
 *     responses:
 *       200:
 *         description: Vue voyage rendue
 */
router.post('/voyage/render', (req, res) => {
