...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatVoyageDetails préfixe correctement', () => {
        expect(helpers.formatVoyageDetails('Ultra')).toBe('[voyage] Ultra');
    });
    ...
    it('formatVoyageDetails gère les détails vides', () => {
        expect(helpers.formatVoyageDetails('')).toBe('[voyage] ');
    });
});
