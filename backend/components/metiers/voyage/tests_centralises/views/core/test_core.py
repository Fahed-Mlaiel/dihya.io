...
# from components.metiers.voyage.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.voyage.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Voyage</h1>"
