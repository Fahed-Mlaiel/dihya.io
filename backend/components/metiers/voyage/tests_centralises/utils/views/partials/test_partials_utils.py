...
# from components.metiers.voyage.utils.views.partials.partials_utils import ...
from backend.components.metiers.voyage.utils.views.partials import partials_views
