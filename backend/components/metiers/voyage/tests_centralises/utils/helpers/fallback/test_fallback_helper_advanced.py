...
import pytest
from backend.components.metiers.voyage.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.voyage.utils.helpers.fallback.fallback import fallback_helper
