...
"""
Tests avancés pour la configuration des plugins voyage.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.voyage.plugins.config.ultra_advanced_config import PluginConfigManager
