...
"""
Tests avancés pour les exemples des plugins voyage.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.voyage.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
