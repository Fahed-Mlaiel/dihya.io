...
"""
Exemple ultra avancé de test d’intégration pour le métier voyage.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.voyage.integration.samples import integration_sample_python
