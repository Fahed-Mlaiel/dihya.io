...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier voyage.
...
from backend.components.metiers.voyage.integration.api import integration_api
