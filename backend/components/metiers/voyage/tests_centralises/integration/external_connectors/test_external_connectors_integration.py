...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier voyage.
...
from backend.components.metiers.voyage.integration.external_connectors import integration_external
