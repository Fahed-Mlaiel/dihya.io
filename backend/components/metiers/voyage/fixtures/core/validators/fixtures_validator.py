"""
fixtures_validator.py - Validation avancée des fixtures Voyage (Python)
"""


def is_valid_voyage_model(model):
    """Validate voyage model fixture.

    Args:
        model (dict): The voyage model fixture to validate.
