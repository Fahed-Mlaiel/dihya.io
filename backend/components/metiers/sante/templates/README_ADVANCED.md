/* global console */
# Templates Sante – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier sante (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit sante
...
- `templatessante.templatessante.js` : template JS avancé
