// api_views.js – Helpers et endpoints API avancés pour le module sante
 ...
 *     responses:
 *       200:
 *         description: Vue sante rendue
 */
router.post('/sante/render', (req, res) => {
