...
# from components.metiers.sante.utils.views.partials.partials_utils import ...
from backend.components.metiers.sante.utils.views.partials import partials_views
