...
import pytest
from backend.components.metiers.sante.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.sante.utils.helpers.fallback.fallback import fallback_helper
