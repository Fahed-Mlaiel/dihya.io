...
"""
Tests avancés pour la configuration des plugins sante.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.sante.plugins.config.ultra_advanced_config import PluginConfigManager
