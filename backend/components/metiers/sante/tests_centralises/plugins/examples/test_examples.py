...
"""
Tests avancés pour les exemples des plugins sante.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.sante.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
