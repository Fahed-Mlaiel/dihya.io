...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier sante.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.sante.integration.pipelines import integration_pipelines
