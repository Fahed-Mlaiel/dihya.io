...
"""
Tests d’intégration ultra avancés pour le monitoring métier sante.
...
from backend.components.metiers.sante.integration.monitoring import integration_monitoring
