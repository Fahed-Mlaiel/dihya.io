...
"""
Exemple ultra avancé de test d’intégration pour le métier sante.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.sante.integration.samples import integration_sample_python
