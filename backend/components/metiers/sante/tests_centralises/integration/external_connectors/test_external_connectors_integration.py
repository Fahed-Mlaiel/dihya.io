...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier sante.
...
from backend.components.metiers.sante.integration.external_connectors import integration_external
