...
# from components.metiers.sante.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.sante.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Sante</h1>"
