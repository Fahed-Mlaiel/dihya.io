...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatSanteDetails préfixe correctement', () => {
        expect(helpers.formatSanteDetails('Ultra')).toBe('[sante] Ultra');
    });
    ...
    it('formatSanteDetails gère les détails vides', () => {
        expect(helpers.formatSanteDetails('')).toBe('[sante] ');
    });
});
