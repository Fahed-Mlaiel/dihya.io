"""
fixtures_validator.py - Validation avancée des fixtures Sante (Python)
"""


def is_valid_sante_model(model):
    """Validate sante model fixture.

    Args:
        model (dict): The sante model fixture to validate.
