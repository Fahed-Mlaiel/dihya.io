/* global console */
# Services Sante – Documentation Ultra Avancée
...
# Services Sante – Documentation Ultra Avancée (complément)
...
### Python
```python
from .services_sante import get_advanced_sante_model, audit_advanced_model
print(get_advanced_sante_model('model-003'))
...
# Services Sante – Guide Avancé

## Exemples d'utilisation

```python
from .mon_service import traitement_sante
```
