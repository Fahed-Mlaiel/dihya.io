"""
services_controller.py - Contrôleur avancé pour les services Sante (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_sante import ServiceSante, get_sante_model, list_sante_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_sante_model(model_id)
