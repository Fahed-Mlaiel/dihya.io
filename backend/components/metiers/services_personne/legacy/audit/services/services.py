"""
services.py – Services d’audit avancés pour le legacy ServicesPersonne
...
from backend.components.metiers.services_personne.legacy.audit.models.models import AuditLog
