/* global console */
# Templates ServicesPersonne – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier services_personne (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit services_personne
...
- `templatesservices_personne.templatesservices_personne.js` : template JS avancé
