"""
templates_mock.py – Mocks pour tests unitaires et intégration des templates ServicesPersonne (Python)
...
def mock_email_notification():
    return {"details": "Nouvelle scène services_personne créée"}
