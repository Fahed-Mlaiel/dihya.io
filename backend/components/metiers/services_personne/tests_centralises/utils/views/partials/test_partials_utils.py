...
# from components.metiers.services_personne.utils.views.partials.partials_utils import ...
from backend.components.metiers.services_personne.utils.views.partials import partials_views
