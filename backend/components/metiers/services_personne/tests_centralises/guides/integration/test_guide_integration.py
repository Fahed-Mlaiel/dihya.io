...
def test___init___content():
    assert "intégration" in "guide intégration avancé – Métier ServicesPersonne".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.services_personne.guides.integration import guide_integration
