...
def test___init___content():
    ...
    assert "fonctionnel" in "guide fonctionnel avancé – Métier ServicesPersonne".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.services_personne.guides.functional import guide_fonctionnel
