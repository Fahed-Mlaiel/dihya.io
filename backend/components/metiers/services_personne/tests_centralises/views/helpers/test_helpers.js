...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatServicesPersonneDetails préfixe correctement', () => {
        expect(helpers.formatServicesPersonneDetails('Ultra')).toBe('[services_personne] Ultra');
    });
    ...
    it('formatServicesPersonneDetails gère les détails vides', () => {
        expect(helpers.formatServicesPersonneDetails('')).toBe('[services_personne] ');
    });
});
