...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier services_personne.
...
from backend.components.metiers.services_personne.integration.api import integration_api
