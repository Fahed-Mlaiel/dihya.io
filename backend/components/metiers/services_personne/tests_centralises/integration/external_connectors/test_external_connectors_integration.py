...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier services_personne.
...
from backend.components.metiers.services_personne.integration.external_connectors import integration_external
