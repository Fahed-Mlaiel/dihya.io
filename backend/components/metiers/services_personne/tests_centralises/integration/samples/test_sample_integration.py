...
"""
Exemple ultra avancé de test d’intégration pour le métier services_personne.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.services_personne.integration.samples import integration_sample_python
