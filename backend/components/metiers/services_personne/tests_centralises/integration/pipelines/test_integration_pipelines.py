...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier services_personne.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.services_personne.integration.pipelines import integration_pipelines
