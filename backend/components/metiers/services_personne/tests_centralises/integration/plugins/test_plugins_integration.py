...
"""
Tests d’intégration ultra avancés pour les plugins métier services_personne.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.services_personne.integration.plugins import integration_plugins
