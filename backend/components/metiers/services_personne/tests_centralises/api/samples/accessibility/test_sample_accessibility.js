// test_sample_accessibility.js – Test ultra avancé des samples accessibilité API ServicesPersonne (centralisé)

const { sampleAccessibilityCheck } = require('../../../api/samples/accessibility');

describe('Samples Accessibilité API ServicesPersonne', () => {
