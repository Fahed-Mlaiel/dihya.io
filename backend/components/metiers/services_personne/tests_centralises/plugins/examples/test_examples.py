...
"""
Tests avancés pour les exemples des plugins services_personne.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.services_personne.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
