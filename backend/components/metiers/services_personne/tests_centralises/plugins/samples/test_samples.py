...
"""
Tests avancés pour les samples des plugins services_personne.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.services_personne.plugins.samples.plugins_samples import exemple_plugin_sample
