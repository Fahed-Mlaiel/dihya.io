...
"""
Tests avancés pour la configuration des plugins services_personne.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.services_personne.plugins.config.ultra_advanced_config import PluginConfigManager
