...
"""
Tests avancés pour les helpers des plugins services_personne.
"""
...
def test_advanced_helper_function_exists():
    from backend.components.metiers.services_personne.plugins.helpers.ultra_advanced_helpers import advanced_helper_function
