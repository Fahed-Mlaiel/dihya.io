...
"""
Tests avancés pour la documentation des plugins services_personne.
"""
...
def test_generate_plugin_docs_exists():
    from backend.components.metiers.services_personne.plugins.docs.ultra_advanced_docs import generate_plugin_docs
