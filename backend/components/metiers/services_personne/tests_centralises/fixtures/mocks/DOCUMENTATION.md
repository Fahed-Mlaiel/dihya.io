# Documentation automatique – mocks fixtures services_personne

Ce dossier regroupe tous les mocks utilisés pour les tests centralisés du module ServicesPersonne.
