# permissions.py – Définition avancée des permissions métier ServicesPersonne
...
def is_valid_permission(permission):
    """Vérifie si la permission fournie est une permission métier ServicesPersonne valide."""
