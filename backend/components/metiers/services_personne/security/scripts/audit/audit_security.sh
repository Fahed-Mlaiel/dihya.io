...
find /workspaces/dihya.io/backend/components/metiers/services_personne/security/ -type f -exec stat -c "%n %a" {} \; >> "$LOGFILE"

# Vérification de l’intégrité (hash)
find /workspaces/dihya.io/backend/components/metiers/services_personne/security/ -type f -exec sha256sum {} \; >> "$LOGFILE"
