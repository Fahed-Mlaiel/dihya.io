"""
services_controller.py - Contrôleur avancé pour les services ServicesPersonne (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_services_personne import ServiceServicesPersonne, get_services_personne_model, list_services_personne_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_services_personne_model(model_id)
