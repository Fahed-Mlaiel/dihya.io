// service_services_personne.js - Service principal services_personne (JS)
...
function getservices_personneModel(id) {
  if (id === undefined) throw new Error('id requis');
  return { id, name: 'Model ' + id };
}
function listservices_personneModels() {
  return [
    { id: 1, name: 'Model 1' },
    { id: 2, name: 'Model 2' },
    { id: 3, name: 'Model 3' }
...
module.exports = {
  ...
  getservices_personneModel,
  listservices_personneModels,
  auditModel,
  secureAccess
};
