"""
Service Python d'exemple ultra avancé pour ServicesPersonne, endpoints, logique métier, validation, audit, etc.
"""
...
def hello_sample():
    ...
    return {"message": "Hello from ServicesPersonne sample service!"}
