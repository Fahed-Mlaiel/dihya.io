// fixtures.js - Fixtures ultra avancés pour le module services_personne

module.exports = {
  sampleservices_personneModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
    ...
    meta: {
      ...
      tags: ['cube', 'ultra', 'services_personne'],
      validated: true
    }
  },
  assets: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle services_personne est incomplet.' },
