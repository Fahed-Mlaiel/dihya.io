/* global console */
# Templates Agriculture – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier agriculture (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit agriculture
...
- `templatesagriculture.templatesagriculture.js` : template JS avancé
