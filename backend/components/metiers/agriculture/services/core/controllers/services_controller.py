"""
services_controller.py - Contrôleur avancé pour les services Agriculture (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_agriculture import ServiceAgriculture, get_agriculture_model, list_agriculture_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_agriculture_model(model_id)
