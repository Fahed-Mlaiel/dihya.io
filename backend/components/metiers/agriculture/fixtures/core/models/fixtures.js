// fixtures.js - Fixtures ultra avancés pour le module agriculture

module.exports = {
  sampleagricultureModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle agriculture est incomplet.' },
