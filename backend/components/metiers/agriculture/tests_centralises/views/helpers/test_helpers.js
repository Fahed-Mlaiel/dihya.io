...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatAgricultureDetails préfixe correctement', () => {
        expect(helpers.formatAgricultureDetails('Ultra')).toBe('[agriculture] Ultra');
    });
    ...
    it('formatAgricultureDetails gère les détails vides', () => {
        expect(helpers.formatAgricultureDetails('')).toBe('[agriculture] ');
    });
});
