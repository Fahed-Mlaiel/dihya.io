...
"""
Tests d’intégration ultra avancés pour les plugins métier agriculture.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.agriculture.integration.plugins import integration_plugins
