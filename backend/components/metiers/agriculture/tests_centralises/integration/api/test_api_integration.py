...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier agriculture.
...
from backend.components.metiers.agriculture.integration.api import integration_api
