...
"""
Tests d’intégration ultra avancés pour le monitoring métier agriculture.
...
from backend.components.metiers.agriculture.integration.monitoring import integration_monitoring
