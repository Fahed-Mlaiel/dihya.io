...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier agriculture.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.agriculture.integration.pipelines import integration_pipelines
