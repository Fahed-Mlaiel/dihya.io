...
"""
Tests avancés pour la configuration des plugins agriculture.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.agriculture.plugins.config.ultra_advanced_config import PluginConfigManager
