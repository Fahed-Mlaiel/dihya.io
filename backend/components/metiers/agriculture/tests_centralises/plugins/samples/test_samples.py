...
"""
Tests avancés pour les samples des plugins agriculture.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.agriculture.plugins.samples.plugins_samples import exemple_plugin_sample
