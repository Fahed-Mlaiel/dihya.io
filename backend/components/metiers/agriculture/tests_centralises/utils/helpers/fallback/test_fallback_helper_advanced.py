...
import pytest
from backend.components.metiers.agriculture.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.agriculture.utils.helpers.fallback.fallback import fallback_helper
