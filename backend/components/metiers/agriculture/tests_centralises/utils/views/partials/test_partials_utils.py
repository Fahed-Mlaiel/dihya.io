...
# from components.metiers.agriculture.utils.views.partials.partials_utils import ...
from backend.components.metiers.agriculture.utils.views.partials import partials_views
