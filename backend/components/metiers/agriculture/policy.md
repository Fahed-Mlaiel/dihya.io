# Agriculture – Politique de sécurité et conformité (Dihya Coding)
- **RBAC** : Accès par rôle (admin, agriculteur, invité)
...
## Exemples de règles
- Un invité ne peut pas créer/modifier/supprimer une exploitation
- Un agriculteur peut gérer ses propres exploitations
