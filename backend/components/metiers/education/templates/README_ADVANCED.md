/* global console */
# Templates Education – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier education (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit education
...
- `templateseducation.templateseducation.js` : template JS avancé
