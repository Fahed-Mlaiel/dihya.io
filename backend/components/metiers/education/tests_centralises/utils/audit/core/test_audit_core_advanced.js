const { auditEducation } = require('../../../../utils/audit/core/audit');
...
describe('Audit Core Utils', () => {
  ...
  it('retourne un score élevé pour status=active', () => {
    const res = auditEducation({ status: 'active' });
  ...
  it('retourne un score faible pour status inactif', () => {
    const res = auditEducation({ status: 'inactive' });
