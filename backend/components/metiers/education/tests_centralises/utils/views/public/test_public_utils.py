...
# from components.metiers.education.utils.views.public.public_utils import ...
from backend.components.metiers.education.utils.views.public import public_views
