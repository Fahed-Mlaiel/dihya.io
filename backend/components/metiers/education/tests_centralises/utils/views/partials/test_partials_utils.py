...
# from components.metiers.education.utils.views.partials.partials_utils import ...
from backend.components.metiers.education.utils.views.partials import partials_views
