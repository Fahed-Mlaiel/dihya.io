...
"""
Tests avancés pour les helpers des plugins education.
"""
...
def test_advanced_helper_function_exists():
    from backend.components.metiers.education.plugins.helpers.ultra_advanced_helpers import advanced_helper_function
