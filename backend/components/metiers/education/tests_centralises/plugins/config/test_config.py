...
"""
Tests avancés pour la configuration des plugins education.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.education.plugins.config.ultra_advanced_config import PluginConfigManager
