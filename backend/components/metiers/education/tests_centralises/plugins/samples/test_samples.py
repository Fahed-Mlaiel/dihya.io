...
"""
Tests avancés pour les samples des plugins education.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.education.plugins.samples.plugins_samples import exemple_plugin_sample
