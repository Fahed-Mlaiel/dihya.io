...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatEducationDetails préfixe correctement', () => {
        expect(helpers.formatEducationDetails('Ultra')).toBe('[education] Ultra');
    });
    ...
    it('formatEducationDetails gère les détails vides', () => {
        expect(helpers.formatEducationDetails('')).toBe('[education] ');
    });
});
