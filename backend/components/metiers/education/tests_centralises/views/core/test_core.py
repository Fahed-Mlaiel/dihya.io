...
# from components.metiers.education.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.education.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Education</h1>"
