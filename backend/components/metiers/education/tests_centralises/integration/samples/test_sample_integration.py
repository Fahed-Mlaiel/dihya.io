...
"""
Exemple ultra avancé de test d’intégration pour le métier education.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.education.integration.samples import integration_sample_python
