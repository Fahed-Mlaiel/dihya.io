...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier education.
...
from backend.components.metiers.education.integration.external_connectors import integration_external
