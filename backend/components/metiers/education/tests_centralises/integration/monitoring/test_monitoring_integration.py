...
"""
Tests d’intégration ultra avancés pour le monitoring métier education.
...
from backend.components.metiers.education.integration.monitoring import integration_monitoring
