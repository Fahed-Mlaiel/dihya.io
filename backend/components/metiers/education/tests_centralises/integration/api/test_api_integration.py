...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier education.
...
from backend.components.metiers.education.integration.api import integration_api
