...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier education.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.education.integration.pipelines import integration_pipelines
