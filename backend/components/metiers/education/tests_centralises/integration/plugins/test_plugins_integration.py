...
"""
Tests d’intégration ultra avancés pour les plugins métier education.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.education.integration.plugins import integration_plugins
