"""
services_controller.py - Contrôleur avancé pour les services Education (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_education import ServiceEducation, get_education_model, list_education_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_education_model(model_id)
