"""
api_views.py – Helpers et vues API avancées pour le module education
...
class EducationAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/education/render")
def render_education_api(data: EducationAPIModel) -> Dict[str, Any]:
