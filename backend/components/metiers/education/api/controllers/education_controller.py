"""
education_controller.py – Contrôleur ultra avancé API Education (Python)
...
from ..validators.validators import validate_education_entity
...
def get_education(id: int):
    before_action("read", {"id": id})
    entity = db_find_by_id("education", id)
    if not entity:
        return None
...
def create_education(data: dict):
    before_action("create", data)
    validate_education_entity(data)
    created = db_insert("education", data)
...
def update_education(id: int, data: dict):
    before_action("update", {"id": id, **data})
    validate_education_entity(data)
    updated = db_update("education", id, data)
...
def delete_education(id: int):
    ...
    deleted = db_delete("education", id)
    audit_entity({"id": id}, "delete")
    after_action("delete", {"id": id})
    return deleted


# Es gibt keine Klasse EducationController, sondern nur Funktions-Exporte.
...
class EducationController:
    ...
    @staticmethod
    def create(data):
        return create_education(data)

    @staticmethod
    def update(id, data):
        return update_education(id, data)

    @staticmethod
    def delete(id):
        return delete_education(id)
