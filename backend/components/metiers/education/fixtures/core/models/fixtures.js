// fixtures.js - Fixtures ultra avancés pour le module education

module.exports = {
  sampleeducationModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle education est incomplet.' },
