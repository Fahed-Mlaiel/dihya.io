"""
fixtures_validator.py - Validation avancée des fixtures Education (Python)
"""


def is_valid_education_model(model):
    """Validate education model fixture.

    Args:
        model (dict): The education model fixture to validate.
