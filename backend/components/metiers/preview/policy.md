# Preview – Politique de sécurité et conformité (Dihya Coding)
...
## Exemples de règles
- Un invité ne peut pas créer/modifier/supprimer un preview
- Un user peut gérer ses propres previews
