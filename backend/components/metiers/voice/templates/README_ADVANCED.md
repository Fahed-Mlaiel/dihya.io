/* global console */
# Templates voice – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier voice (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit voice
...
- `templatesvoice.templatesvoice.js` : template JS avancé
