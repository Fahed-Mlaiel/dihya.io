...
"""
Tests d’intégration ultra avancés pour le monitoring métier voice.
...
from backend.components.metiers.voice.integration.monitoring import integration_monitoring
