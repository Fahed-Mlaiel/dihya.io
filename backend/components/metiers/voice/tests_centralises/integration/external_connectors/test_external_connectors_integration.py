...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier voice.
...
from backend.components.metiers.voice.integration.external_connectors import integration_external
