...
"""
Exemple ultra avancé de test d’intégration pour le métier voice.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.voice.integration.samples import integration_sample_python
