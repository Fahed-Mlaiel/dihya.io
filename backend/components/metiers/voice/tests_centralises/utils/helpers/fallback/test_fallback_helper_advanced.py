...
import pytest
from backend.components.metiers.voice.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.voice.utils.helpers.fallback.fallback import fallback_helper
