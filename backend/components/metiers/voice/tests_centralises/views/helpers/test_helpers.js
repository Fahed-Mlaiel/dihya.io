...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatvoiceDetails préfixe correctement', () => {
        expect(helpers.formatvoiceDetails('Ultra')).toBe('[voice] Ultra');
    });
    ...
    it('formatvoiceDetails gère les détails vides', () => {
        expect(helpers.formatvoiceDetails('')).toBe('[voice] ');
    });
});
