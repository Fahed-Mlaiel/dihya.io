...
# from components.metiers.voice.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.voice.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur voice</h1>"
