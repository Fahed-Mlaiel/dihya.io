...
"""
Tests avancés pour la documentation des plugins voice.
"""
...
def test_generate_plugin_docs_exists():
    from backend.components.metiers.voice.plugins.docs.ultra_advanced_docs import generate_plugin_docs
