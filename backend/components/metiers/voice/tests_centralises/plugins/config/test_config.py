...
"""
Tests avancés pour la configuration des plugins voice.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.voice.plugins.config.ultra_advanced_config import PluginConfigManager
