...
- Les fichiers `services_voice.py` et `services_voice.js` sont supprimés pour éviter toute confusion et redondance.
...
- Les fichiers principaux à utiliser sont :
  - `service_voice.py` / `service_voice.js` (logique métier principale)
