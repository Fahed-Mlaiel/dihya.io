"""
services_controller.py - Contrôleur avancé pour les services voice (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_voice import Servicevoice, get_voice_model, list_voice_models, audit_model
