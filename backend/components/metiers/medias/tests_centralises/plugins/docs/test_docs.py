...
"""
Tests avancés pour la documentation des plugins medias.
"""
...
def test_generate_plugin_docs_exists():
    from backend.components.metiers.medias.plugins.docs.ultra_advanced_docs import generate_plugin_docs
