...
"""
Tests avancés pour la configuration des plugins medias.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.medias.plugins.config.ultra_advanced_config import PluginConfigManager
