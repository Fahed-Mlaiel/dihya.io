...
# from components.metiers.medias.utils.views.partials.partials_utils import ...
from backend.components.metiers.medias.utils.views.partials import partials_views
