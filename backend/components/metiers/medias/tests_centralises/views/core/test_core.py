...
# from components.metiers.medias.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.medias.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Medias</h1>"
