...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatMediasDetails préfixe correctement', () => {
        expect(helpers.formatMediasDetails('Ultra')).toBe('[medias] Ultra');
    });
    ...
    it('formatMediasDetails gère les détails vides', () => {
        expect(helpers.formatMediasDetails('')).toBe('[medias] ');
    });
});
