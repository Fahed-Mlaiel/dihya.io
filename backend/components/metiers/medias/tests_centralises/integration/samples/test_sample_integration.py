...
"""
Exemple ultra avancé de test d’intégration pour le métier medias.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.medias.integration.samples import integration_sample_python
