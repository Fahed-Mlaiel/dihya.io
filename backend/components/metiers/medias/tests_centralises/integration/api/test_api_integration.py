...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier medias.
...
from backend.components.metiers.medias.integration.api import integration_api
