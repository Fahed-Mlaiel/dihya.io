/* global console */
# Templates Medias – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier medias (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit medias
...
- `templatesmedias.templatesmedias.js` : template JS avancé
