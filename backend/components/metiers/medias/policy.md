# Medias – Politique de sécurité et conformité (Dihya Coding)
- **RBAC** : Accès par rôle (admin, éditeur, invité)
...
## Exemples de règles
- Un invité ne peut pas créer/modifier/supprimer un média
- Un éditeur peut gérer ses propres médias
