"""
fixtures_validator.py - Validation avancée des fixtures Medias (Python)
"""


def is_valid_medias_model(model):
    """Validate medias model fixture.

    Args:
        model (dict): The medias model fixture to validate.
