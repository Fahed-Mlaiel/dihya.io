"""
api_views.py – Helpers et vues API avancées pour le module medias
...
class MediasAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/medias/render")
def render_medias_api(data: MediasAPIModel) -> Dict[str, Any]:
