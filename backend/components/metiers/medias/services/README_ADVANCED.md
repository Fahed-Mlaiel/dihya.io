/* global console */
# Services Medias – Documentation Ultra Avancée
...
# Services Medias – Documentation Ultra Avancée (complément)
...
### Python
```python
from .services_medias import get_advanced_medias_model, audit_advanced_model
print(get_advanced_medias_model('model-003'))
...
# Services Medias – Guide Avancé

## Exemples d'utilisation

```python
from .mon_service import traitement_medias
```
