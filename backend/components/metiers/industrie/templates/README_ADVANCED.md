/* global console */
# Templates Industrie – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier industrie (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit industrie
...
- `templatesindustrie.templatesindustrie.js` : template JS avancé
