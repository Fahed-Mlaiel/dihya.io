"""
Initialisation simple des tests pour le module Environnement (Dihya Coding)
...
Simple initialization for Environnement tests (Dihya Coding)
...
# Initialisation simple des tests Industrie (aucun import dynamique)
