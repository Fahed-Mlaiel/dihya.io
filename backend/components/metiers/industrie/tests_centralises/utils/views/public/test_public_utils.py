...
# from components.metiers.industrie.utils.views.public.public_utils import ...
from backend.components.metiers.industrie.utils.views.public import public_views
