...
# from components.metiers.industrie.utils.views.partials.partials_utils import ...
from backend.components.metiers.industrie.utils.views.partials import partials_views
