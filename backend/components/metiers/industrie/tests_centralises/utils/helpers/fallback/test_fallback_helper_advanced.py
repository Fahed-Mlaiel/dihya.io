...
import pytest
from backend.components.metiers.industrie.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.industrie.utils.helpers.fallback.fallback import fallback_helper
