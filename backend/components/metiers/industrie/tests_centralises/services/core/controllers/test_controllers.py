...
# from components.metiers.industrie.services.core.controllers
# import ...
...
def test_services_controller_nominal():
    from backend.components.metiers.industrie.services.core.controllers.services_controller import ServicesController
...
def test_services_controller_get_model_access():
    ...
    ctrl = ServicesController()
    ctrl.audit_log = []
    # Mock check_access et get_industrie_model
