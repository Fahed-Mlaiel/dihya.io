...
"""
Tests avancés pour la configuration des plugins industrie.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.industrie.plugins.config.ultra_advanced_config import PluginConfigManager
