...
"""
Tests avancés pour les samples des plugins industrie.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.industrie.plugins.samples.plugins_samples import exemple_plugin_sample
