...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier industrie.
...
from backend.components.metiers.industrie.integration.api import integration_api
