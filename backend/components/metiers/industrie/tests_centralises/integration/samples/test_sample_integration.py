...
"""
Exemple ultra avancé de test d’intégration pour le métier industrie.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.industrie.integration.samples import integration_sample_python
