...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatIndustrieDetails préfixe correctement', () => {
        expect(helpers.formatIndustrieDetails('Ultra')).toBe('[industrie] Ultra');
    });
    ...
    it('formatIndustrieDetails gère les détails vides', () => {
        expect(helpers.formatIndustrieDetails('')).toBe('[industrie] ');
    });
});
