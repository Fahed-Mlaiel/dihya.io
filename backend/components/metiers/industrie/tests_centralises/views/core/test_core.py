...
# from components.metiers.industrie.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.industrie.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Industrie</h1>"
