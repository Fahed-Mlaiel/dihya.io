// fixtures.js - Fixtures ultra avancés pour le module industrie

module.exports = {
  sampleindustrieModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle industrie est incomplet.' },
