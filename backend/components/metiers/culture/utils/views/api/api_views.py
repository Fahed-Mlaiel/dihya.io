"""
api_views.py – Helpers et vues API avancées pour le module culture
...
class CultureAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/culture/render")
def render_culture_api(data: CultureAPIModel) -> Dict[str, Any]:
