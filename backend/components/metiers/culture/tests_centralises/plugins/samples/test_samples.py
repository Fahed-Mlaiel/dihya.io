...
"""
Tests avancés pour les samples des plugins culture.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.culture.plugins.samples.plugins_samples import exemple_plugin_sample
