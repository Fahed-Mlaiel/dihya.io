...
"""
Tests avancés pour les helpers des plugins culture.
"""
...
def test_advanced_helper_function_exists():
    from backend.components.metiers.culture.plugins.helpers.ultra_advanced_helpers import advanced_helper_function
