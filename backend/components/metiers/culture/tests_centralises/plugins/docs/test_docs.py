...
"""
Tests avancés pour la documentation des plugins culture.
"""
...
def test_generate_plugin_docs_exists():
    from backend.components.metiers.culture.plugins.docs.ultra_advanced_docs import generate_plugin_docs
