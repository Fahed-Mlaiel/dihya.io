...
"""
Tests avancés pour la configuration des plugins culture.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.culture.plugins.config.ultra_advanced_config import PluginConfigManager
