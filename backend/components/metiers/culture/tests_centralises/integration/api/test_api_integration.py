...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier culture.
...
from backend.components.metiers.culture.integration.api import integration_api
