...
"""
Tests d’intégration ultra avancés pour le monitoring métier culture.
...
from backend.components.metiers.culture.integration.monitoring import integration_monitoring
