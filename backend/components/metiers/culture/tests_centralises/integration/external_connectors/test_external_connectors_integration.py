...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier culture.
...
from backend.components.metiers.culture.integration.external_connectors import integration_external
