...
"""
Tests d’intégration ultra avancés pour les plugins métier culture.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.culture.integration.plugins import integration_plugins
