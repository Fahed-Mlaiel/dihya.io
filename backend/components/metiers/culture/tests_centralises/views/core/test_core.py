...
# from components.metiers.culture.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.culture.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Culture</h1>"
