...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatCultureDetails préfixe correctement', () => {
        expect(helpers.formatCultureDetails('Ultra')).toBe('[culture] Ultra');
    });
    ...
    it('formatCultureDetails gère les détails vides', () => {
        expect(helpers.formatCultureDetails('')).toBe('[culture] ');
    });
});
