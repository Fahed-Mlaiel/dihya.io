/* global console */
# Templates Culture – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier culture (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit culture
...
- `templatesculture.templatesculture.js` : template JS avancé
