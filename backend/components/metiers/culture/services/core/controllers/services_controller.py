"""
services_controller.py - Contrôleur avancé pour les services Culture (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_culture import ServiceCulture, get_culture_model, list_culture_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_culture_model(model_id)
