/* global console */
# Templates Hotellerie – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier hotellerie (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit hotellerie
...
- `templateshotellerie.templateshotellerie.js` : template JS avancé
