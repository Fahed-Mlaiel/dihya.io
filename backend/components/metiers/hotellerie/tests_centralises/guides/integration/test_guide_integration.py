...
def test___init___content():
    assert "intégration" in "guide intégration avancé – Métier Hotellerie".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.hotellerie.guides.integration import guide_integration
