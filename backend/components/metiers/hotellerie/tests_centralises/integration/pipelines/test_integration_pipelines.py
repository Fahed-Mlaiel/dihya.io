...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier hotellerie.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.hotellerie.integration.pipelines import integration_pipelines
