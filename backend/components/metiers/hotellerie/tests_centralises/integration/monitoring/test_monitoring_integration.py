...
"""
Tests d’intégration ultra avancés pour le monitoring métier hotellerie.
...
from backend.components.metiers.hotellerie.integration.monitoring import integration_monitoring
