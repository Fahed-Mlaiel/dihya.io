...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier hotellerie.
...
from backend.components.metiers.hotellerie.integration.external_connectors import integration_external
