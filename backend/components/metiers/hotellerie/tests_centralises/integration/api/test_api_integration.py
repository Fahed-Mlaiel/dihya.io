...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier hotellerie.
...
from backend.components.metiers.hotellerie.integration.api import integration_api
