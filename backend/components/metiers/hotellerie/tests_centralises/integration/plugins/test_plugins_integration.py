...
"""
Tests d’intégration ultra avancés pour les plugins métier hotellerie.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.hotellerie.integration.plugins import integration_plugins
