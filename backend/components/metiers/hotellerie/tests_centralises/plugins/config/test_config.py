...
"""
Tests avancés pour la configuration des plugins hotellerie.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.hotellerie.plugins.config.ultra_advanced_config import PluginConfigManager
