...
"""
Tests avancés pour les samples des plugins hotellerie.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.hotellerie.plugins.samples.plugins_samples import exemple_plugin_sample
