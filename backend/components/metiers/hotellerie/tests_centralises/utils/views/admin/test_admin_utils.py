...
# from components.metiers.hotellerie.utils.views.admin.admin_utils import ...


import pytest
from fastapi import HTTPException
from backend.components.metiers.hotellerie.utils.views.admin import admin_views
