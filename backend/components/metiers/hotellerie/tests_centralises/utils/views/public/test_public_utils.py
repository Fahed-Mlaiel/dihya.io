...
# from components.metiers.hotellerie.utils.views.public.public_utils import ...
from backend.components.metiers.hotellerie.utils.views.public import public_views
