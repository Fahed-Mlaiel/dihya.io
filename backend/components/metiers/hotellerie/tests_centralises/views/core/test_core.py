...
# from components.metiers.hotellerie.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.hotellerie.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Hotellerie</h1>"
