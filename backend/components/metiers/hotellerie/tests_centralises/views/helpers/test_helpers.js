...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatHotellerieDetails préfixe correctement', () => {
        expect(helpers.formatHotellerieDetails('Ultra')).toBe('[hotellerie] Ultra');
    });
    ...
    it('formatHotellerieDetails gère les détails vides', () => {
        expect(helpers.formatHotellerieDetails('')).toBe('[hotellerie] ');
    });
});
