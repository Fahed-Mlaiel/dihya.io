// fixtures.js - Fixtures ultra avancés pour le module hotellerie

module.exports = {
  samplehotellerieModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle hotellerie est incomplet.' },
