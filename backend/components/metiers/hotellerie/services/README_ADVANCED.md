/* global console */
# Services Hotellerie – Documentation Ultra Avancée
...
# Services Hotellerie – Documentation Ultra Avancée (complément)
...
### Python
```python
from .services_hotellerie import get_advanced_hotellerie_model, audit_advanced_model
print(get_advanced_hotellerie_model('model-003'))
...
# Services Hotellerie – Guide Avancé

## Exemples d'utilisation

```python
from .mon_service import traitement_hotellerie
```
