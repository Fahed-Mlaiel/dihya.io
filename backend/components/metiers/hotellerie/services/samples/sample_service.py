"""
Service Python d'exemple ultra avancé pour Hotellerie, endpoints, logique métier, validation, audit, etc.
"""
...
def hello_sample():
    ...
    return {"message": "Hello from Hotellerie sample service!"}
