"""
services_controller.py - Contrôleur avancé pour les services Hotellerie (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_hotellerie import ServiceHotellerie, get_hotellerie_model, list_hotellerie_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_hotellerie_model(model_id)
