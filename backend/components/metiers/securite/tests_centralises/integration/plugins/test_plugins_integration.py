...
"""
Tests d’intégration ultra avancés pour les plugins métier securite.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.securite.integration.plugins import integration_plugins
