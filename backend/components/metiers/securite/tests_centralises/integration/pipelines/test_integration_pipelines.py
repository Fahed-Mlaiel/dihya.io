...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier securite.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.securite.integration.pipelines import integration_pipelines
