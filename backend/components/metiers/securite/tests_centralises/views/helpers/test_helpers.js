...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatSecuriteDetails préfixe correctement', () => {
        expect(helpers.formatSecuriteDetails('Ultra')).toBe('[securite] Ultra');
    });
    ...
    it('formatSecuriteDetails gère les détails vides', () => {
        expect(helpers.formatSecuriteDetails('')).toBe('[securite] ');
    });
});
