...
# from components.metiers.securite.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.securite.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Securite</h1>"
