...
"""
Tests avancés pour les samples des plugins securite.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.securite.plugins.samples.plugins_samples import exemple_plugin_sample
