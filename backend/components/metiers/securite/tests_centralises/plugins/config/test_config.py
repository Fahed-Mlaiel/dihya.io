...
"""
Tests avancés pour la configuration des plugins securite.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.securite.plugins.config.ultra_advanced_config import PluginConfigManager
