"""
api_views.py – Helpers et vues API avancées pour le module securite
...
class SecuriteAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/securite/render")
def render_securite_api(data: SecuriteAPIModel) -> Dict[str, Any]:
