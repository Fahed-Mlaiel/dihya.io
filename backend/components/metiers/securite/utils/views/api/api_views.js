// api_views.js – Helpers et endpoints API avancés pour le module securite
 ...
 * /api/securite/render:
 *   post:
 *     summary: Rendu securite via API
 *     tags: [Securite]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *     responses:
 *       200:
 *         description: Vue securite rendue
 */
router.post('/securite/render', (req, res) => {
