...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatScienceDetails préfixe correctement', () => {
        expect(helpers.formatScienceDetails('Ultra')).toBe('[science] Ultra');
    });
    ...
    it('formatScienceDetails gère les détails vides', () => {
        expect(helpers.formatScienceDetails('')).toBe('[science] ');
    });
});
