...
# from components.metiers.science.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.science.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Science</h1>"
