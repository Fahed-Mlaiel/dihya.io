...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier science.
...
from backend.components.metiers.science.integration.api import integration_api
