...
"""
Tests d’intégration ultra avancés pour les plugins métier science.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.science.integration.plugins import integration_plugins
