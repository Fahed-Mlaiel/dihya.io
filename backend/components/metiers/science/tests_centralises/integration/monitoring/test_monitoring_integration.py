...
"""
Tests d’intégration ultra avancés pour le monitoring métier science.
...
from backend.components.metiers.science.integration.monitoring import integration_monitoring
