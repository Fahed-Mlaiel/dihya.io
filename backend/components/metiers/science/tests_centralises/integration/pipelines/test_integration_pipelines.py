...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier science.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.science.integration.pipelines import integration_pipelines
