...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier science.
...
from backend.components.metiers.science.integration.external_connectors import integration_external
