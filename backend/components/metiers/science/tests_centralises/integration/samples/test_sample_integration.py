...
"""
Exemple ultra avancé de test d’intégration pour le métier science.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.science.integration.samples import integration_sample_python
