...
"""
Tests avancés pour la configuration des plugins science.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.science.plugins.config.ultra_advanced_config import PluginConfigManager
