...
"""
Tests avancés pour la documentation des plugins science.
"""
...
def test_generate_plugin_docs_exists():
    from backend.components.metiers.science.plugins.docs.ultra_advanced_docs import generate_plugin_docs
