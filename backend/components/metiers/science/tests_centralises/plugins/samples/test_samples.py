...
"""
Tests avancés pour les samples des plugins science.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.science.plugins.samples.plugins_samples import exemple_plugin_sample
