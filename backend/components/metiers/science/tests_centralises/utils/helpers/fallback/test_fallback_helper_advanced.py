...
import pytest
from backend.components.metiers.science.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.science.utils.helpers.fallback.fallback import fallback_helper
