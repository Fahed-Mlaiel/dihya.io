...
# from components.metiers.science.utils.views.partials.partials_utils import ...
from backend.components.metiers.science.utils.views.partials import partials_views
