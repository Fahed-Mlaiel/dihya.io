/* global console */
# Services Science – Documentation Ultra Avancée
...
# Services Science – Documentation Ultra Avancée (complément)
...
### Python
```python
from .services_science import get_advanced_science_model, audit_advanced_model
print(get_advanced_science_model('model-003'))
...
# Services Science – Guide Avancé

## Exemples d'utilisation

```python
from .mon_service import traitement_science
```
