"""
services_controller.py - Contrôleur avancé pour les services Science (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_science import ServiceScience, get_science_model, list_science_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_science_model(model_id)
