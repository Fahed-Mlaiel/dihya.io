...
- Les fichiers `services_science.py` et `services_science.js` sont supprimés pour éviter toute confusion et redondance.
...
- Les fichiers principaux à utiliser sont :
  - `service_science.py` / `service_science.js` (logique métier principale)
