# Science – Politique de sécurité et conformité (Dihya Coding)
- **RBAC** : Accès par rôle (admin, chercheur, invité)
...
## Exemples de règles
- Un invité ne peut pas créer/modifier/supprimer une expérience
- Un chercheur peut gérer ses propres expériences
