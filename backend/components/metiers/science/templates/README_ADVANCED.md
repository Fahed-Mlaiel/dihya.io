/* global console */
# Templates Science – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier science (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit science
...
- `templatesscience.templatesscience.js` : template JS avancé
