// api_views.js – Helpers et endpoints API avancés pour le module science
 ...
 *     responses:
 *       200:
 *         description: Vue science rendue
 */
router.post('/science/render', (req, res) => {
