"""
api_views.py – Helpers et vues API avancées pour le module science
...
class ScienceAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/science/render")
def render_science_api(data: ScienceAPIModel) -> Dict[str, Any]:
