"""
services.py – Services d’audit avancés pour le legacy Construction
...
from backend.components.metiers.construction.legacy.audit.models.models import AuditLog
