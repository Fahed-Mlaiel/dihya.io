// templates_mock.js – Mocks pour tests unitaires et intégration des templates Construction (JS)
// Inclut : scénarios spécifiques, edge cases, CI/CD, audit, accessibilité

module.exports = {
  mockRapportAudit: { date: '2025-06-03', result: 'OK' },
  mockEmailNotification: { details: 'Nouvelle scène construction créée' },
