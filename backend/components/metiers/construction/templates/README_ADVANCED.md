/* global console */
# Templates Construction – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier construction (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit construction
...
- `templatesconstruction.templatesconstruction.js` : template JS avancé
