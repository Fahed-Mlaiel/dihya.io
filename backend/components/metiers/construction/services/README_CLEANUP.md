...
- Les fichiers `services_construction.py` et `services_construction.js` sont supprimés pour éviter toute confusion et redondance.
...
- Les fichiers principaux à utiliser sont :
  - `service_construction.py` / `service_construction.js` (logique métier principale)
