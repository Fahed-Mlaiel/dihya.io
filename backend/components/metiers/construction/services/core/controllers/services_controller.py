"""
services_controller.py - Contrôleur avancé pour les services Construction (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_construction import ServiceConstruction, get_construction_model, list_construction_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_construction_model(model_id)
