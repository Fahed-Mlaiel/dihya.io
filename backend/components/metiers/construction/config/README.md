# Config – Module Construction Ultra Avancé

Ce dossier regroupe tous les fichiers, helpers et logiques config spécifiques au métier **Construction**.
...
## 👩‍💻 Contact référent
- Product Owner : po-construction@dihya.io
