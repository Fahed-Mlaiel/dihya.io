# Guide Accessibilité – Construction (Dihya Coding)

Ce guide détaille l’accessibilité du module construction : conformité WCAG 2.2, ARIA, navigation clavier, multilingue, endpoints API accessibles, tests automatisés, logs, audit, CI/CD.
