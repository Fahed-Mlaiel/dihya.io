...
"""
Tests avancés pour la configuration des plugins construction.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.construction.plugins.config.ultra_advanced_config import PluginConfigManager
