...
"""
Tests avancés pour les exemples des plugins construction.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.construction.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
