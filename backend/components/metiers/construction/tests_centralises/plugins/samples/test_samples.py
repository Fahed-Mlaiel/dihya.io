...
"""
Tests avancés pour les samples des plugins construction.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.construction.plugins.samples.plugins_samples import exemple_plugin_sample
