...
from backend.components.metiers.construction.utils.helpers.mocks.mock_helper import mock_validation_data
from backend.components.metiers.construction.utils.helpers.helpers.generic_helper import capitalize_first
