...
import pytest
from backend.components.metiers.construction.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.construction.utils.helpers.fallback.fallback import fallback_helper
