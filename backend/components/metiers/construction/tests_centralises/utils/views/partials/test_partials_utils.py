...
# from components.metiers.construction.utils.views.partials.partials_utils import ...
from backend.components.metiers.construction.utils.views.partials import partials_views
