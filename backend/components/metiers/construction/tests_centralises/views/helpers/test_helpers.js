...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatConstructionDetails préfixe correctement', () => {
        expect(helpers.formatConstructionDetails('Ultra')).toBe('[construction] Ultra');
    });
    ...
    it('formatConstructionDetails gère les détails vides', () => {
        expect(helpers.formatConstructionDetails('')).toBe('[construction] ');
    });
});
