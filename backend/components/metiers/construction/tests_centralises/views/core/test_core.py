...
# from components.metiers.construction.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.construction.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Construction</h1>"
