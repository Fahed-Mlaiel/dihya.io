...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier construction.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.construction.integration.pipelines import integration_pipelines
