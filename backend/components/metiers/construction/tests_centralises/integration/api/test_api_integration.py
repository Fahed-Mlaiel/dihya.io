...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier construction.
...
from backend.components.metiers.construction.integration.api import integration_api
