...
"""
Exemple ultra avancé de test d’intégration pour le métier construction.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.construction.integration.samples import integration_sample_python
