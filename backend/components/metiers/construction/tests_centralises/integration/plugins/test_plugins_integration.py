...
"""
Tests d’intégration ultra avancés pour les plugins métier construction.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.construction.integration.plugins import integration_plugins
