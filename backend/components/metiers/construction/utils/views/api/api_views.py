"""
api_views.py – Helpers et vues API avancées pour le module construction
...
class ConstructionAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/construction/render")
def render_construction_api(data: ConstructionAPIModel) -> Dict[str, Any]:
