"""
services_controller.py - Contrôleur avancé pour les services Publicite (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_publicite import ServicePublicite, get_publicite_model, list_publicite_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_publicite_model(model_id)
