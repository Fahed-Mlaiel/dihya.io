// fixtures.js - Fixtures ultra avancés pour le module publicite

module.exports = {
  samplepubliciteModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle publicite est incomplet.' },
