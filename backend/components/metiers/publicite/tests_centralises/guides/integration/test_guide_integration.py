...
def test___init___content():
    assert "intégration" in "guide intégration avancé – Métier Publicite".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.publicite.guides.integration import guide_integration
