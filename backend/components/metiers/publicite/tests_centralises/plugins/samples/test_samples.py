...
"""
Tests avancés pour les samples des plugins publicite.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.publicite.plugins.samples.plugins_samples import exemple_plugin_sample
