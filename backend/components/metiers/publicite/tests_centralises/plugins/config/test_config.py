...
"""
Tests avancés pour la configuration des plugins publicite.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.publicite.plugins.config.ultra_advanced_config import PluginConfigManager
