...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier publicite.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.publicite.integration.pipelines import integration_pipelines
