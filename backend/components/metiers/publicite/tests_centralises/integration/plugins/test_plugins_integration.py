...
"""
Tests d’intégration ultra avancés pour les plugins métier publicite.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.publicite.integration.plugins import integration_plugins
