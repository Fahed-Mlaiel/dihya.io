...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier publicite.
...
from backend.components.metiers.publicite.integration.external_connectors import integration_external
