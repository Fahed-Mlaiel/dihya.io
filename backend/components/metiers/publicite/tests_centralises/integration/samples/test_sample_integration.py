...
"""
Exemple ultra avancé de test d’intégration pour le métier publicite.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.publicite.integration.samples import integration_sample_python
