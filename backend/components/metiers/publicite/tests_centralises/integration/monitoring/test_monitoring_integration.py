...
"""
Tests d’intégration ultra avancés pour le monitoring métier publicite.
...
from backend.components.metiers.publicite.integration.monitoring import integration_monitoring
