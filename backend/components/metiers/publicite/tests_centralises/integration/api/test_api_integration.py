...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier publicite.
...
from backend.components.metiers.publicite.integration.api import integration_api
