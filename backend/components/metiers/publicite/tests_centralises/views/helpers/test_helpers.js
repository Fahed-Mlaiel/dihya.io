...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatPubliciteDetails préfixe correctement', () => {
        expect(helpers.formatPubliciteDetails('Ultra')).toBe('[publicite] Ultra');
    });
    ...
    it('formatPubliciteDetails gère les détails vides', () => {
        expect(helpers.formatPubliciteDetails('')).toBe('[publicite] ');
    });
});
