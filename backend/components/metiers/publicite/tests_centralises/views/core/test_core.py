...
# from components.metiers.publicite.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.publicite.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Publicite</h1>"
