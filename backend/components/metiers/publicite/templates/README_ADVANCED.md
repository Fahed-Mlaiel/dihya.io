/* global console */
# Templates Publicite – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier publicite (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit publicite
...
- `templatespublicite.templatespublicite.js` : template JS avancé
