# Publicité – Politique de sécurité et conformité (Dihya Coding)

- **RBAC** : Accès par rôle (admin, marketeur, invité)
...
## Exemples de règles
- Un invité ne peut pas créer/modifier/supprimer une campagne
- Un marketeur peut gérer ses propres campagnes
