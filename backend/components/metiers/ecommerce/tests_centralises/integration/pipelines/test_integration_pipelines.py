...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier ecommerce.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.ecommerce.integration.pipelines import integration_pipelines
