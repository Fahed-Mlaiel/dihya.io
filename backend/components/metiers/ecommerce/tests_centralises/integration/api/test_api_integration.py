...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier ecommerce.
...
from backend.components.metiers.ecommerce.integration.api import integration_api
