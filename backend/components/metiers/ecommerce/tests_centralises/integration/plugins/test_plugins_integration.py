...
"""
Tests d’intégration ultra avancés pour les plugins métier ecommerce.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.ecommerce.integration.plugins import integration_plugins
