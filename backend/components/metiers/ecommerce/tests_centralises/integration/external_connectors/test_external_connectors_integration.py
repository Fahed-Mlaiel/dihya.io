...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier ecommerce.
...
from backend.components.metiers.ecommerce.integration.external_connectors import integration_external
