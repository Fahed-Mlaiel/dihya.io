...
def test___init___content():
    assert "intégration" in "guide intégration avancé – Métier Ecommerce".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.ecommerce.guides.integration import guide_integration
