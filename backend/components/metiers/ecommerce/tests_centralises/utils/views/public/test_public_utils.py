...
# from components.metiers.ecommerce.utils.views.public.public_utils import ...
from backend.components.metiers.ecommerce.utils.views.public import public_views
