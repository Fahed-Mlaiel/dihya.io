...
# from components.metiers.ecommerce.utils.views.partials.partials_utils import ...
from backend.components.metiers.ecommerce.utils.views.partials import partials_views
