...
"""
Tests avancés pour les helpers des plugins ecommerce.
"""
...
def test_advanced_helper_function_exists():
    from backend.components.metiers.ecommerce.plugins.helpers.ultra_advanced_helpers import advanced_helper_function
