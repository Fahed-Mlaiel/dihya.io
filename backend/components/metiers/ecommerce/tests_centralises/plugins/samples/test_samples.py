...
"""
Tests avancés pour les samples des plugins ecommerce.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.ecommerce.plugins.samples.plugins_samples import exemple_plugin_sample
