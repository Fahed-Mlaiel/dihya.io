...
"""
Tests avancés pour la configuration des plugins ecommerce.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.ecommerce.plugins.config.ultra_advanced_config import PluginConfigManager
