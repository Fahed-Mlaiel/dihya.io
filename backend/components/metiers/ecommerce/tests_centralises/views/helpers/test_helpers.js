...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatEcommerceDetails préfixe correctement', () => {
        expect(helpers.formatEcommerceDetails('Ultra')).toBe('[ecommerce] Ultra');
    });
    ...
    it('formatEcommerceDetails gère les détails vides', () => {
        expect(helpers.formatEcommerceDetails('')).toBe('[ecommerce] ');
    });
});
