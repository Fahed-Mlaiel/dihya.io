...
# from components.metiers.ecommerce.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.ecommerce.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Ecommerce</h1>"
