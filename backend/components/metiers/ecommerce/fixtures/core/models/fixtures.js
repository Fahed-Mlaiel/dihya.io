// fixtures.js - Fixtures ultra avancés pour le module ecommerce

module.exports = {
  sampleecommerceModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle ecommerce est incomplet.' },
