"""
services_controller.py - Contrôleur avancé pour les services Ecommerce (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_ecommerce import ServiceEcommerce, get_ecommerce_model, list_ecommerce_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_ecommerce_model(model_id)
