"""
api_views.py – Helpers et vues API avancées pour le module energie
...
class EnergieAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/energie/render")
def render_energie_api(data: EnergieAPIModel) -> Dict[str, Any]:
