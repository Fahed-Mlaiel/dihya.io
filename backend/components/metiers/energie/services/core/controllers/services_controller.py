"""
services_controller.py - Contrôleur avancé pour les services Energie (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_energie import ServiceEnergie, get_energie_model, list_energie_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_energie_model(model_id)
