...
"""
Tests d’intégration ultra avancés pour les plugins métier energie.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.energie.integration.plugins import integration_plugins
