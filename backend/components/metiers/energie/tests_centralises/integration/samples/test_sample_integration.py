...
"""
Exemple ultra avancé de test d’intégration pour le métier energie.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.energie.integration.samples import integration_sample_python
