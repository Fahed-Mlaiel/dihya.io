...
"""
Tests d’intégration ultra avancés pour le monitoring métier energie.
...
from backend.components.metiers.energie.integration.monitoring import integration_monitoring
