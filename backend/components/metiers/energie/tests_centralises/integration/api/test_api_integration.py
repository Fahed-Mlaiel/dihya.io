...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier energie.
...
from backend.components.metiers.energie.integration.api import integration_api
