...
# from components.metiers.energie.utils.views.partials.partials_utils import ...
from backend.components.metiers.energie.utils.views.partials import partials_views
