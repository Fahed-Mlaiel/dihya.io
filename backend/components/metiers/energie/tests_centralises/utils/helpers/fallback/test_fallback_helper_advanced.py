...
import pytest
from backend.components.metiers.energie.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.energie.utils.helpers.fallback.fallback import fallback_helper
