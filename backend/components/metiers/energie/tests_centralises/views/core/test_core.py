...
# from components.metiers.energie.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.energie.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Energie</h1>"
