...
"""
Tests avancés pour les helpers des plugins energie.
"""
...
def test_advanced_helper_function_exists():
    from backend.components.metiers.energie.plugins.helpers.ultra_advanced_helpers import advanced_helper_function
