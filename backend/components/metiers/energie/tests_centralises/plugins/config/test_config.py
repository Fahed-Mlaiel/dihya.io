...
"""
Tests avancés pour la configuration des plugins energie.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.energie.plugins.config.ultra_advanced_config import PluginConfigManager
