...
"""
Tests avancés pour les samples des plugins energie.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.energie.plugins.samples.plugins_samples import exemple_plugin_sample
