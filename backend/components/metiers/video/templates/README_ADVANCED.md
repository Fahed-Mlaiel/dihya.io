/* global console */
# Templates Video – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier video (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit video
...
- `templatesvideo.templatesvideo.js` : template JS avancé
