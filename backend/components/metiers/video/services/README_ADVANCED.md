/* global console */
# Services Video – Documentation Ultra Avancée
...
# Services Video – Documentation Ultra Avancée (complément)
...
### Python
```python
from .services_video import get_advanced_video_model, audit_advanced_model
print(get_advanced_video_model('model-003'))
...
# Services Video – Guide Avancé

## Exemples d'utilisation

```python
from .mon_service import traitement_video
```
