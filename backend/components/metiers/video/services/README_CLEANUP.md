...
- Les fichiers `services_video.py` et `services_video.js` sont supprimés pour éviter toute confusion et redondance.
...
- Les fichiers principaux à utiliser sont :
  - `service_video.py` / `service_video.js` (logique métier principale)
