"""
services_controller.py - Contrôleur avancé pour les services Video (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_video import ServiceVideo, get_video_model, list_video_models, audit_model
