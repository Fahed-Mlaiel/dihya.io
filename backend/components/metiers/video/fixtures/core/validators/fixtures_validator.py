"""
fixtures_validator.py - Validation avancée des fixtures Video (Python)
"""


def is_valid_video_model(model):
    """Validate video model fixture.

    Args:
        model (dict): The video model fixture to validate.
