...
"""
Tests d’intégration ultra avancés pour le monitoring métier video.
...
from backend.components.metiers.video.integration.monitoring import integration_monitoring
