...
"""
Exemple ultra avancé de test d’intégration pour le métier video.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.video.integration.samples import integration_sample_python
