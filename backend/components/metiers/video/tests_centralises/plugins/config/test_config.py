...
"""
Tests avancés pour la configuration des plugins video.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.video.plugins.config.ultra_advanced_config import PluginConfigManager
