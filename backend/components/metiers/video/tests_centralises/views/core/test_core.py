...
# from components.metiers.video.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.video.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Video</h1>"
