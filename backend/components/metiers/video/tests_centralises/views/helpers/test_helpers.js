...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatVideoDetails préfixe correctement', () => {
        expect(helpers.formatVideoDetails('Ultra')).toBe('[video] Ultra');
    });
    ...
    it('formatVideoDetails gère les détails vides', () => {
        expect(helpers.formatVideoDetails('')).toBe('[video] ');
    });
});
