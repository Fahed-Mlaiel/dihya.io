// fixtures.js - Fixtures ultra avancés pour le module banque_finance

module.exports = {
  samplebanque_financeModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
    ...
    meta: {
      ...
      tags: ['cube', 'ultra', 'banque_finance'],
      validated: true
    }
  },
  assets: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle banque_finance est incomplet.' },
