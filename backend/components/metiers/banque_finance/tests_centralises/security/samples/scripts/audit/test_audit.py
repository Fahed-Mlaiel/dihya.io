...
Module testé : /workspaces/dihya.io/backend/components/metiers/banque_finance/security
Date : 2025-06-08
...
sys.path.append(
    "/workspaces/dihya.io/backend/components/metiers/banque_finance/security"
)
