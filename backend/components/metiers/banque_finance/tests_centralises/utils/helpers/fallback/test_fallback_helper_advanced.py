...
import pytest
from backend.components.metiers.banque_finance.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.banque_finance.utils.helpers.fallback.fallback import fallback_helper
