...
# from components.metiers.banque_finance.utils.views.partials.partials_utils import ...
from backend.components.metiers.banque_finance.utils.views.partials import partials_views
