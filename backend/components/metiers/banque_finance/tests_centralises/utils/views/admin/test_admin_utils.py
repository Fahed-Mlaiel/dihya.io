...
# from components.metiers.banque_finance.utils.views.admin.admin_utils import ...


import pytest
from fastapi import HTTPException
from backend.components.metiers.banque_finance.utils.views.admin import admin_views
