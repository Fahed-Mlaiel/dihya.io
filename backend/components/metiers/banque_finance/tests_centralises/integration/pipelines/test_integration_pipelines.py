...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier banque_finance.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.banque_finance.integration.pipelines import integration_pipelines
