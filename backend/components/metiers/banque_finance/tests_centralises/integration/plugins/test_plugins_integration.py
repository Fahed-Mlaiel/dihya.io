...
"""
Tests d’intégration ultra avancés pour les plugins métier banque_finance.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.banque_finance.integration.plugins import integration_plugins
