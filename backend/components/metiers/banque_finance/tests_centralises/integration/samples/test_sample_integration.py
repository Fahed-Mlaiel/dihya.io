...
"""
Exemple ultra avancé de test d’intégration pour le métier banque_finance.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.banque_finance.integration.samples import integration_sample_python
