...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier banque_finance.
...
from backend.components.metiers.banque_finance.integration.api import integration_api
