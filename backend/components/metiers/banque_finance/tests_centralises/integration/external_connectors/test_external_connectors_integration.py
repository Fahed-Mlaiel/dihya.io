...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier banque_finance.
...
from backend.components.metiers.banque_finance.integration.external_connectors import integration_external
