...
def test___init___content():
    ...
    assert "fonctionnel" in "guide fonctionnel avancé – Métier Banque_Finance".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.banque_finance.guides.functional import guide_fonctionnel
