...
def test___init___content():
    assert "intégration" in "guide intégration avancé – Métier Banque_Finance".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.banque_finance.guides.integration import guide_integration
