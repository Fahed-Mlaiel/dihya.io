...
"""
Tests avancés pour les exemples des plugins banque_finance.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.banque_finance.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
