...
"""
Tests avancés pour la documentation des plugins banque_finance.
"""
...
def test_generate_plugin_docs_exists():
    from backend.components.metiers.banque_finance.plugins.docs.ultra_advanced_docs import generate_plugin_docs
