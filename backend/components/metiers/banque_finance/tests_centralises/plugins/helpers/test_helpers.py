...
"""
Tests avancés pour les helpers des plugins banque_finance.
"""
...
def test_advanced_helper_function_exists():
    from backend.components.metiers.banque_finance.plugins.helpers.ultra_advanced_helpers import advanced_helper_function
