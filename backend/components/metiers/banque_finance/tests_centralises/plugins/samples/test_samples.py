...
"""
Tests avancés pour les samples des plugins banque_finance.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.banque_finance.plugins.samples.plugins_samples import exemple_plugin_sample
