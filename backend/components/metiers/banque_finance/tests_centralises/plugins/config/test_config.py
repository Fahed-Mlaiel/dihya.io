...
"""
Tests avancés pour la configuration des plugins banque_finance.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.banque_finance.plugins.config.ultra_advanced_config import PluginConfigManager
