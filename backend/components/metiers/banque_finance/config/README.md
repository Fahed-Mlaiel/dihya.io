# Config – Module Banque_finance Ultra Avancé

Ce dossier regroupe tous les fichiers, helpers et logiques config spécifiques au métier **Banque_finance**.
...
## 👩‍💻 Contact référent
- Product Owner : po-banque_finance@dihya.io
