"""
services_controller.py - Contrôleur avancé pour les services Banque_Finance (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_banque_finance import ServiceBanque_Finance, get_banque_finance_model, list_banque_finance_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_banque_finance_model(model_id)
