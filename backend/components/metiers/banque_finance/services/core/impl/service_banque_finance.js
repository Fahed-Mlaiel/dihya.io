// service_banque_finance.js - Service principal banque_finance (JS)
...
function getbanque_financeModel(id) {
  if (id === undefined) throw new Error('id requis');
  return { id, name: 'Model ' + id };
}
function listbanque_financeModels() {
  return [
    { id: 1, name: 'Model 1' },
    { id: 2, name: 'Model 2' },
    { id: 3, name: 'Model 3' }
...
module.exports = {
  ...
  getbanque_financeModel,
  listbanque_financeModels,
  auditModel,
  secureAccess
};
