/* global console */
# Templates Banque_Finance – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier banque_finance (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit banque_finance
...
- `templatesbanque_finance.templatesbanque_finance.js` : template JS avancé
