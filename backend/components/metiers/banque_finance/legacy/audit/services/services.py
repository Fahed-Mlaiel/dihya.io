"""
services.py – Services d’audit avancés pour le legacy Banque_Finance
...
from backend.components.metiers.banque_finance.legacy.audit.models.models import AuditLog
