# permissions.py – Définition avancée des permissions métier Banque_Finance
...
def is_valid_permission(permission):
    """Vérifie si la permission fournie est une permission métier Banque_Finance valide."""
