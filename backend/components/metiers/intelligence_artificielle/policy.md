# Intelligence Artificielle – Politique de sécurité et conformité (Dihya Coding)
- **RBAC** : Accès par rôle (admin, data scientist, user, invité)
...
## Exemples de règles
- Un invité ne peut pas créer/modifier/supprimer un modèle
- Un user peut gérer ses propres modèles
- Un data scientist peut gérer tous les modèles
