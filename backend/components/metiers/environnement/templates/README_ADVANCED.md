/* global console */
# Templates Environnement – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier environnement (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit environnement
...
- `templatesenvironnement.templatesenvironnement.js` : template JS avancé
