"""
services_controller.py - Contrôleur avancé pour les services Environnement (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_environnement import ServiceEnvironnement, get_environnement_model, list_environnement_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_environnement_model(model_id)
