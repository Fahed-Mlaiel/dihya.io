...
"""
Tests avancés pour les samples des plugins environnement.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.environnement.plugins.samples.plugins_samples import exemple_plugin_sample
