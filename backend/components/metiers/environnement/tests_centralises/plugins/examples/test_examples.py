...
"""
Tests avancés pour les exemples des plugins environnement.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.environnement.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
