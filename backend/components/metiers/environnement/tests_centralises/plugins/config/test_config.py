...
"""
Tests avancés pour la configuration des plugins environnement.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.environnement.plugins.config.ultra_advanced_config import PluginConfigManager
