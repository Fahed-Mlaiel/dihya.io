...
# from components.metiers.environnement.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.environnement.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Environnement</h1>"
