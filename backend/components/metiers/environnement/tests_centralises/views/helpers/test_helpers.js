...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatEnvironnementDetails préfixe correctement', () => {
        expect(helpers.formatEnvironnementDetails('Ultra')).toBe('[environnement] Ultra');
    });
    ...
    it('formatEnvironnementDetails gère les détails vides', () => {
        expect(helpers.formatEnvironnementDetails('')).toBe('[environnement] ');
    });
});
