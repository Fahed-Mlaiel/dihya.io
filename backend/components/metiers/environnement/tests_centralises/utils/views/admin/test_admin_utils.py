...
# from components.metiers.environnement.utils.views.admin.admin_utils import ...


import pytest
from fastapi import HTTPException
from backend.components.metiers.environnement.utils.views.admin import admin_views
