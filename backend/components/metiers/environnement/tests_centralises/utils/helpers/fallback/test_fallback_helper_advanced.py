...
import pytest
from backend.components.metiers.environnement.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.environnement.utils.helpers.fallback.fallback import fallback_helper
