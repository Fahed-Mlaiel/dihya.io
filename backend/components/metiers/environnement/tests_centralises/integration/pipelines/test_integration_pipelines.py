...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier environnement.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.environnement.integration.pipelines import integration_pipelines
