...
"""
Exemple ultra avancé de test d’intégration pour le métier environnement.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.environnement.integration.samples import integration_sample_python
