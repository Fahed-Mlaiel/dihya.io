...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier environnement.
...
from backend.components.metiers.environnement.integration.api import integration_api
