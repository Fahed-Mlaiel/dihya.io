...
def test_guide_fonctionnel_exemple_output(capsys):
    from backend.components.metiers.environnement.legacy.documentation.guides.fonctionnelle import (
        guide_fonctionnel_exemple,
    )

    guide_fonctionnel_exemple.guide_fonctionnel_exemple()
    captured = capsys.readouterr()
    assert "Guide fonctionnel legacy Environnement" in captured.out
