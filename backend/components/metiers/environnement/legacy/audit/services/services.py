"""
services.py – Services d’audit avancés pour le legacy Environnement
...
from backend.components.metiers.environnement.legacy.audit.models.models import AuditLog
