// fixtures.js - Fixtures ultra avancés pour le module environnement

module.exports = {
  sampleenvironnementModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle environnement est incomplet.' },
