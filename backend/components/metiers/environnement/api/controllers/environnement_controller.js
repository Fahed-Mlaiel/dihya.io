// environnement_controller.js – Contrôleur ultra avancé API Environnement (JS)
const db = require('../db/db');
const { validateenvironnementEntity } = require('../validators/validators');
...
const EnvironnementController = {
  async getById(id) {
    beforeAction('read', { id });
    let entity = db.findById('environnement', id);
  ...
  async create(data) {
    ...
    validateenvironnementEntity(data);
    const created = db.insert('environnement', data);
  ...
  async update(id, data) {
    ...
    validateenvironnementEntity(data);
    const updated = db.update('environnement', id, data);
  ...
  async delete(id) {
    ...
    const deleted = db.delete('environnement', id);
...
module.exports = EnvironnementController;
