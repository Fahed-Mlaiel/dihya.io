"""
api_views.py – Helpers et vues API avancées pour le module arts
...
class ArtsAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/arts/render")
def render_arts_api(data: ArtsAPIModel) -> Dict[str, Any]:
