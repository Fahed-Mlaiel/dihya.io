...
"""
Tests avancés pour les exemples des plugins arts.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.arts.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
