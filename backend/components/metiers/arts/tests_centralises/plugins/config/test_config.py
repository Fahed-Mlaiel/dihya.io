...
"""
Tests avancés pour la configuration des plugins arts.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.arts.plugins.config.ultra_advanced_config import PluginConfigManager
