...
"""
Exemple ultra avancé de test d’intégration pour le métier arts.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.arts.integration.samples import integration_sample_python
