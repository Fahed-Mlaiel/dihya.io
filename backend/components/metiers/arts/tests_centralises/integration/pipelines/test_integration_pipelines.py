...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier arts.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.arts.integration.pipelines import integration_pipelines
