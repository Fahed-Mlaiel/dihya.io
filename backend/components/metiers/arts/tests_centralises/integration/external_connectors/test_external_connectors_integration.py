...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier arts.
...
from backend.components.metiers.arts.integration.external_connectors import integration_external
