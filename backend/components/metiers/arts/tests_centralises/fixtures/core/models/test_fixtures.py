...
import pytest
from backend.components.metiers.arts.fixtures.core.models.fixtures import (
    sample_arts_asset,
    advanced_arts_model,
    asset_texture,
    user_admin,
...
def test_sample_asset(sample_arts_asset):
    asset = sample_arts_asset
    assert asset["name"] == "Cube"

def test_advanced_model(advanced_arts_model):
    model = advanced_arts_model
