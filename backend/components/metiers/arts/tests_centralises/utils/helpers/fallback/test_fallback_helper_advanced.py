...
import pytest
from backend.components.metiers.arts.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.arts.utils.helpers.fallback.fallback import fallback_helper
