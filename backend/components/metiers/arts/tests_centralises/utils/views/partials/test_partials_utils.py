...
# from components.metiers.arts.utils.views.partials.partials_utils import ...
from backend.components.metiers.arts.utils.views.partials import partials_views
