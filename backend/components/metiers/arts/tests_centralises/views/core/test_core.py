...
# from components.metiers.arts.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.arts.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Arts</h1>"
