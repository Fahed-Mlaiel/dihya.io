...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatArtsDetails préfixe correctement', () => {
        expect(helpers.formatArtsDetails('Ultra')).toBe('[arts] Ultra');
    });
    ...
    it('formatArtsDetails gère les détails vides', () => {
        expect(helpers.formatArtsDetails('')).toBe('[arts] ');
    });
});
