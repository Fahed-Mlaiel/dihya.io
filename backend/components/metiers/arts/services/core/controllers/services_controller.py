"""
services_controller.py - Contrôleur avancé pour les services Arts (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_arts import ServiceArts, get_arts_model, list_arts_models, audit_model
