/* global console */
# Services Arts – Documentation Ultra Avancée
...
# Services Arts – Documentation Ultra Avancée (complément)
...
### Python
```python
from .services_arts import get_advanced_arts_model, audit_advanced_model
print(get_advanced_arts_model('model-003'))
...
# Services Arts – Guide Avancé

## Exemples d'utilisation

```python
from .mon_service import traitement_arts
```
