/* global console */
# Templates Arts – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier arts (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit arts
...
- `templatesarts.templatesarts.js` : template JS avancé
