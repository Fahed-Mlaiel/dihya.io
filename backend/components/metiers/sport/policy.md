# Sport – Politique de sécurité et conformité (Dihya Coding)
- **RBAC** : Accès par rôle (admin, coach, invité)
...
## Exemples de règles
- Un invité ne peut pas créer/modifier/supprimer un événement
- Un coach peut gérer ses propres événements
