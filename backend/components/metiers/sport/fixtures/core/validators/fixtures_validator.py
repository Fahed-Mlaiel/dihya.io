"""
fixtures_validator.py - Validation avancée des fixtures Sport (Python)
"""


def is_valid_sport_model(model):
    """Validate sport model fixture.

    Args:
        model (dict): The sport model fixture to validate.
