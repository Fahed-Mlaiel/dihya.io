"""
api_views.py – Helpers et vues API avancées pour le module sport
...
class SportAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/sport/render")
def render_sport_api(data: SportAPIModel) -> Dict[str, Any]:
