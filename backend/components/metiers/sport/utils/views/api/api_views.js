// api_views.js – Helpers et endpoints API avancés pour le module sport
 ...
 *     responses:
 *       200:
 *         description: Vue sport rendue
 */
router.post('/sport/render', (req, res) => {
