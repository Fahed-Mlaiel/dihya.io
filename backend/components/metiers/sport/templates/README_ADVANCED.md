/* global console */
# Templates Sport – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier sport (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit sport
...
- `templatessport.templatessport.js` : template JS avancé
