...
# from components.metiers.sport.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.sport.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Sport</h1>"
