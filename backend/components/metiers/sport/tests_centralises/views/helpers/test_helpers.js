...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatSportDetails préfixe correctement', () => {
        expect(helpers.formatSportDetails('Ultra')).toBe('[sport] Ultra');
    });
    ...
    it('formatSportDetails gère les détails vides', () => {
        expect(helpers.formatSportDetails('')).toBe('[sport] ');
    });
});
