...
"""
Tests d’intégration ultra avancés pour le monitoring métier sport.
...
from backend.components.metiers.sport.integration.monitoring import integration_monitoring
