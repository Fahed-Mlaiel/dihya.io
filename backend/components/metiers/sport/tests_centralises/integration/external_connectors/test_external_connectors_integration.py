...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier sport.
...
from backend.components.metiers.sport.integration.external_connectors import integration_external
