...
"""
Exemple ultra avancé de test d’intégration pour le métier sport.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.sport.integration.samples import integration_sample_python
