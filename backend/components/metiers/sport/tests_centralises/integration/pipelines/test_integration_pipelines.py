...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier sport.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.sport.integration.pipelines import integration_pipelines
