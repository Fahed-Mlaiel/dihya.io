...
"""
Tests avancés pour la configuration des plugins sport.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.sport.plugins.config.ultra_advanced_config import PluginConfigManager
