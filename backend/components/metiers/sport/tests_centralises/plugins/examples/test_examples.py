...
"""
Tests avancés pour les exemples des plugins sport.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.sport.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
