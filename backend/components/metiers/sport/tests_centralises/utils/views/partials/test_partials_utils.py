...
# from components.metiers.sport.utils.views.partials.partials_utils import ...
from backend.components.metiers.sport.utils.views.partials import partials_views
