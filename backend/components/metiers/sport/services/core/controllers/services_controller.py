"""
services_controller.py - Contrôleur avancé pour les services Sport (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_sport import ServiceSport, get_sport_model, list_sport_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_sport_model(model_id)
