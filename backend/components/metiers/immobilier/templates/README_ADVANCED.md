/* global console */
# Templates Immobilier – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier immobilier (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit immobilier
...
- `templatesimmobilier.templatesimmobilier.js` : template JS avancé
