"""
api_views.py – Helpers et vues API avancées pour le module immobilier
...
class ImmobilierAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/immobilier/render")
def render_immobilier_api(data: ImmobilierAPIModel) -> Dict[str, Any]:
