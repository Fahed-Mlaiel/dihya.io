// fixtures.js - Fixtures ultra avancés pour le module immobilier

module.exports = {
  sampleimmobilierModel: {
    id: 'model-001',
    name: 'Bien Ultra',
    vertices: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle immobilier est incomplet.' },
