...
"""
Tests avancés pour la configuration des plugins immobilier.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.immobilier.plugins.config.ultra_advanced_config import PluginConfigManager
