...
"""
Tests avancés pour les samples des plugins immobilier.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.immobilier.plugins.samples.plugins_samples import exemple_plugin_sample
