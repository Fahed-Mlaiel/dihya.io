...
"""
Exemple ultra avancé de test d’intégration pour le métier immobilier.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.immobilier.integration.samples import integration_sample_python
