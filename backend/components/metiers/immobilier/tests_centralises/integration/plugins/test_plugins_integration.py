...
"""
Tests d’intégration ultra avancés pour les plugins métier immobilier.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.immobilier.integration.plugins import integration_plugins
