...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier immobilier.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.immobilier.integration.pipelines import integration_pipelines
