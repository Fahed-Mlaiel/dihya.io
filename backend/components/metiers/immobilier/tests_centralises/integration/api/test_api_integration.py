...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier immobilier.
...
from backend.components.metiers.immobilier.integration.api import integration_api
