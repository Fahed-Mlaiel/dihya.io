...
# from components.metiers.immobilier.views.helpers.helpers import ...
...
def test_render_title():
    from backend.components.metiers.immobilier.views.helpers import views_helper
...
def test_render_model():
    ...
    assert views_helper.render_model({"name": "Bien"}) == "<div>Modèle: Bien</div>"
