...
spec = importlib.util.spec_from_file_location("sample_controllers", "/workspaces/dihya.io/backend/components/metiers/immobilier/api/samples/controllers/sample_controllers.py")
...
class TestSampleControllers(unittest.TestCase):
    def test_controller_logic(self):
        ...
        self.assertEqual(result["created"]["name"], "UltraBien")
