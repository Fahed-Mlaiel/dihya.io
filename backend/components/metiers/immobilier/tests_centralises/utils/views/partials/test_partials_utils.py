...
# from components.metiers.immobilier.utils.views.partials.partials_utils import ...
from backend.components.metiers.immobilier.utils.views.partials import partials_views
