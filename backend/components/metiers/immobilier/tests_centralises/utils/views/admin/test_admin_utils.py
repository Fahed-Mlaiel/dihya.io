...
# from components.metiers.immobilier.utils.views.admin.admin_utils import ...


import pytest
from fastapi import HTTPException
from backend.components.metiers.immobilier.utils.views.admin import admin_views
