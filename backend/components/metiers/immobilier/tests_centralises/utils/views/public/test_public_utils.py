...
# from components.metiers.immobilier.utils.views.public.public_utils import ...
from backend.components.metiers.immobilier.utils.views.public import public_views
