...
import pytest
from backend.components.metiers.immobilier.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.immobilier.utils.helpers.fallback.fallback import fallback_helper
