"""
services_controller.py - Contrôleur avancé pour les services Immobilier (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_immobilier import ServiceImmobilier, get_immobilier_model, list_immobilier_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_immobilier_model(model_id)
