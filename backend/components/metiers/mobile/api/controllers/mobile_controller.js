// mobile_controller.js – Contrôleur ultra avancé API Mobile (JS)
const db = require('../db/db');
const { validatemobileEntity } = require('../validators/validators');
...
const MobileController = {
  async getById(id) {
    ...
    let entity = db.findById('mobile', id);
  ...
  async create(data) {
    ...
    validatemobileEntity(data);
    const created = db.insert('mobile', data);
  ...
  async update(id, data) {
    ...
    validatemobileEntity(data);
    const updated = db.update('mobile', id, data);
  ...
  async delete(id) {
    ...
    const deleted = db.delete('mobile', id);
