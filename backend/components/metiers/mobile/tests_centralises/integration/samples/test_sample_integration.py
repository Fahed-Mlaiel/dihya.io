...
"""
Exemple ultra avancé de test d’intégration pour le métier mobile.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.mobile.integration.samples import integration_sample_python
