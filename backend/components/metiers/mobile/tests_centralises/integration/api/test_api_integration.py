...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier mobile.
...
from backend.components.metiers.mobile.integration.api import integration_api
