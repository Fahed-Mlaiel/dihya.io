...
"""
Tests avancés pour la configuration des plugins mobile.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.mobile.plugins.config.ultra_advanced_config import PluginConfigManager
