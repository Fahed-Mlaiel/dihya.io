...
"""
Tests avancés pour les exemples des plugins mobile.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.mobile.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
