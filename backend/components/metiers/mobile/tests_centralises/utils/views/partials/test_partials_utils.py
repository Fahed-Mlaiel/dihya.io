...
# from components.metiers.mobile.utils.views.partials.partials_utils import ...
from backend.components.metiers.mobile.utils.views.partials import partials_views
