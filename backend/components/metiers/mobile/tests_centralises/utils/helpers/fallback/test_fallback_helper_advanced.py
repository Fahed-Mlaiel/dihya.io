...
import pytest
from backend.components.metiers.mobile.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.mobile.utils.helpers.fallback.fallback import fallback_helper
