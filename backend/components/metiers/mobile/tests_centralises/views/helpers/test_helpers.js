...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatMobileDetails préfixe correctement', () => {
        expect(helpers.formatMobileDetails('Ultra')).toBe('[mobile] Ultra');
    });
    ...
    it('formatMobileDetails gère les détails vides', () => {
        expect(helpers.formatMobileDetails('')).toBe('[mobile] ');
    });
});
