...
# from components.metiers.mobile.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.mobile.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Mobile</h1>"
