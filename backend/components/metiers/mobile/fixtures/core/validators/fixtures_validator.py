"""
fixtures_validator.py - Validation avancée des fixtures Mobile (Python)
"""


def is_valid_mobile_model(model):
    """Validate mobile model fixture.

    Args:
        model (dict): The mobile model fixture to validate.
