# Mobile – Politique de sécurité et conformité (Dihya Coding)
- **RBAC** : Accès par rôle (admin, mobile, invité)
...
## Exemples de règles
- Un invité ne peut pas créer/modifier/supprimer un item mobile
- Un mobile peut gérer ses propres items
