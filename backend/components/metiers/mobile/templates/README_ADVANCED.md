/* global console */
# Templates Mobile – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier mobile (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit mobile
...
- `templatesmobile.templatesmobile.js` : template JS avancé
