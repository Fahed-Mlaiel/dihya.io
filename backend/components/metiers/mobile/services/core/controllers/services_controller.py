"""
services_controller.py - Contrôleur avancé pour les services Mobile (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_mobile import ServiceMobile, get_mobile_model, list_mobile_models, audit_model
