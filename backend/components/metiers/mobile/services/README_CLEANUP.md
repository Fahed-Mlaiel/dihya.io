...
- Les fichiers `services_mobile.py` et `services_mobile.js` sont supprimés pour éviter toute confusion et redondance.
...
- Les fichiers principaux à utiliser sont :
  - `service_mobile.py` / `service_mobile.js` (logique métier principale)
