// api_views.js – Helpers et endpoints API avancés pour le module mobile
 ...
 *     responses:
 *       200:
 *         description: Vue mobile rendue
 */
router.post('/mobile/render', (req, res) => {
