// fixtures.js - Fixtures ultra avancés pour le module juridique

module.exports = {
  samplejuridiqueModel: {
    id: 'model-001',
    name: 'Dossier Ultra',
    vertices: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle juridique est incomplet.' },
