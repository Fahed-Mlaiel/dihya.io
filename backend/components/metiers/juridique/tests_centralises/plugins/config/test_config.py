...
"""
Tests avancés pour la configuration des plugins juridique.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.juridique.plugins.config.ultra_advanced_config import PluginConfigManager
