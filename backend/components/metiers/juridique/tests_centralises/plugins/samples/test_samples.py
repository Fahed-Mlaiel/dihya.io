...
"""
Tests avancés pour les samples des plugins juridique.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.juridique.plugins.samples.plugins_samples import exemple_plugin_sample
