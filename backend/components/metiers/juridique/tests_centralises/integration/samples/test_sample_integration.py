...
"""
Exemple ultra avancé de test d’intégration pour le métier juridique.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.juridique.integration.samples import integration_sample_python
