...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier juridique.
...
from backend.components.metiers.juridique.integration.api import integration_api
