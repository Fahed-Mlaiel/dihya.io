...
def test___init___content():
    ...
    assert "fonctionnel" in "guide fonctionnel avancé – Métier Juridique".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.juridique.guides.functional import guide_fonctionnel
