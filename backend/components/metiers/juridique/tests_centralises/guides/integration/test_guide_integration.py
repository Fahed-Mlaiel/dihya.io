...
def test___init___content():
    assert "intégration" in "guide intégration avancé – Métier Juridique".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.juridique.guides.integration import guide_integration
