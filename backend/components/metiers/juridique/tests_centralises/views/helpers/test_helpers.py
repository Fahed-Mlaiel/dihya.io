...
# from components.metiers.juridique.views.helpers.helpers import ...
...
def test_render_title():
    from backend.components.metiers.juridique.views.helpers import views_helper
...
def test_render_model():
    ...
    assert views_helper.render_model({"name": "Dossier"}) == "<div>Modèle: Dossier</div>"
