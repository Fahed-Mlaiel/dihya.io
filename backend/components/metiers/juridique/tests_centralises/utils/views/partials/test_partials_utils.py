...
# from components.metiers.juridique.utils.views.partials.partials_utils import ...
from backend.components.metiers.juridique.utils.views.partials import partials_views
