...
# from components.metiers.juridique.utils.views.public.public_utils import ...
from backend.components.metiers.juridique.utils.views.public import public_views
