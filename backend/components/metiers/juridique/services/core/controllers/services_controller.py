"""
services_controller.py - Contrôleur avancé pour les services Juridique (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_juridique import ServiceJuridique, get_juridique_model, list_juridique_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_juridique_model(model_id)
