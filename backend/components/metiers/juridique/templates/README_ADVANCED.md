/* global console */
# Templates Juridique – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier juridique (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit juridique
...
- `templatesjuridique.templatesjuridique.js` : template JS avancé
