...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier tourisme.
...
from backend.components.metiers.tourisme.integration.api import integration_api
