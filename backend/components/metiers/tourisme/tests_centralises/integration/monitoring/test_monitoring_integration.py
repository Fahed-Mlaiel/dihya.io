...
"""
Tests d’intégration ultra avancés pour le monitoring métier tourisme.
...
from backend.components.metiers.tourisme.integration.monitoring import integration_monitoring
