...
"""
Tests d’intégration ultra avancés pour les plugins métier tourisme.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.tourisme.integration.plugins import integration_plugins
