...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier tourisme.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.tourisme.integration.pipelines import integration_pipelines
