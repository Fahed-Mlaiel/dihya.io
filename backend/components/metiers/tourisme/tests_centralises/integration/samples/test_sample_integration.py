...
"""
Exemple ultra avancé de test d’intégration pour le métier tourisme.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.tourisme.integration.samples import integration_sample_python
