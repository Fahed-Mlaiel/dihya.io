...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier tourisme.
...
from backend.components.metiers.tourisme.integration.external_connectors import integration_external
