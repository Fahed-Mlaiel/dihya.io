...
# from components.metiers.tourisme.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.tourisme.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Tourisme</h1>"
