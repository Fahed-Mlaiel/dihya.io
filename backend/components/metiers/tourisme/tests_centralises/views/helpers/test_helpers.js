...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatTourismeDetails préfixe correctement', () => {
        expect(helpers.formatTourismeDetails('Ultra')).toBe('[tourisme] Ultra');
    });
    ...
    it('formatTourismeDetails gère les détails vides', () => {
        expect(helpers.formatTourismeDetails('')).toBe('[tourisme] ');
    });
});
