...
def test___init___content():
    assert "intégration" in "guide intégration avancé – Métier Tourisme".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.tourisme.guides.integration import guide_integration
