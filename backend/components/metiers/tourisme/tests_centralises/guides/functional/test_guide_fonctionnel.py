...
def test___init___content():
    ...
    assert "fonctionnel" in "guide fonctionnel avancé – Métier Tourisme".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.tourisme.guides.functional import guide_fonctionnel
