...
"""
Tests avancés pour les samples des plugins tourisme.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.tourisme.plugins.samples.plugins_samples import exemple_plugin_sample
