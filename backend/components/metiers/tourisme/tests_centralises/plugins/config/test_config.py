...
"""
Tests avancés pour la configuration des plugins tourisme.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.tourisme.plugins.config.ultra_advanced_config import PluginConfigManager
