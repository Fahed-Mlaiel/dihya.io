...
import pytest
from backend.components.metiers.tourisme.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.tourisme.utils.helpers.fallback.fallback import fallback_helper
