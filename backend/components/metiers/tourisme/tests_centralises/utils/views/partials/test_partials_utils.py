...
# from components.metiers.tourisme.utils.views.partials.partials_utils import ...
from backend.components.metiers.tourisme.utils.views.partials import partials_views
