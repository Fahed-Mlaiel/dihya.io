...
# from components.metiers.tourisme.utils.views.public.public_utils import ...
from backend.components.metiers.tourisme.utils.views.public import public_views
