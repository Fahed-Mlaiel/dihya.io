# Tourisme – Politique de sécurité et conformité (Dihya Coding)
...
## Exemples de règles
- Un invité ne peut pas créer/modifier/supprimer une attraction
- Un opérateur peut gérer ses propres attractions
