// api_views.js – Helpers et endpoints API avancés pour le module tourisme
 ...
 * /api/tourisme/render:
 *   post:
 *     summary: Rendu tourisme via API
 *     tags: [Tourisme]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *     responses:
 *       200:
 *         description: Vue tourisme rendue
 */
router.post('/tourisme/render', (req, res) => {
