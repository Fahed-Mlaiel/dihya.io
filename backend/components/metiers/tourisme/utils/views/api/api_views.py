"""
api_views.py – Helpers et vues API avancées pour le module tourisme
...
class TourismeAPIModel(BaseModel):
    nom: str
    statut: str
    details: str = ""


@router.post("/tourisme/render")
def render_tourisme_api(data: TourismeAPIModel) -> Dict[str, Any]:
