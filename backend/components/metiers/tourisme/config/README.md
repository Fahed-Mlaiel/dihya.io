# Config – Module Tourisme Ultra Avancé

Ce dossier regroupe tous les fichiers, helpers et logiques config spécifiques au métier **Tourisme**.
...
## 👩‍💻 Contact référent
- Product Owner : po-tourisme@dihya.io
