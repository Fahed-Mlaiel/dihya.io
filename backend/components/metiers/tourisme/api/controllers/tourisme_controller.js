// tourisme_controller.js – Contrôleur ultra avancé API Tourisme (JS)
const db = require('../db/db');
const { validatetourismeEntity } = require('../validators/validators');
...
const TourismeController = {
  async getById(id) {
    beforeAction('read', { id });
    let entity = db.findById('tourisme', id);
  ...
  async create(data) {
    ...
    validatetourismeEntity(data);
    const created = db.insert('tourisme', data);
  ...
  async update(id, data) {
    ...
    validatetourismeEntity(data);
    const updated = db.update('tourisme', id, data);
  ...
  async delete(id) {
    ...
    const deleted = db.delete('tourisme', id);
...
module.exports = TourismeController;
