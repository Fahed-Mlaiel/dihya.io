"""
services_controller.py - Contrôleur avancé pour les services Tourisme (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_tourisme import ServiceTourisme, get_tourisme_model, list_tourisme_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_tourisme_model(model_id)
