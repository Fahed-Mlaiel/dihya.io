/* global console */
# Services administration_publique – Documentation Ultra Avancée
...
# Services administration_publique – Documentation Ultra Avancée (complément)
...
### Python
```python
from .services_administration_publique import get_advanced_administration_publique_model, audit_advanced_model
print(get_advanced_administration_publique_model('model-003'))
...
# Services administration_publique – Guide Avancé

## Exemples d'utilisation

```python
from .mon_service import traitement_administration_publique
```
