// service_administration_publique.js - Service principal administration_publique (JS)
...
function getadministration_publiqueModel(id) {
  if (id === undefined) throw new Error('id requis');
  return { id, name: 'Model ' + id };
}
function listadministration_publiqueModels() {
  return [
    { id: 1, name: 'Model 1' },
    { id: 2, name: 'Model 2' },
    { id: 3, name: 'Model 3' }
...
module.exports = {
  ...
  getadministration_publiqueModel,
  listadministration_publiqueModels,
  auditModel,
  secureAccess
};
