"""
Tests ultra avancés pour rbac_utils.py (RBAC administration_publique)
Couvre : cas nominaux, edge cases, conformité RGPD, audit, accessibilité, robustesse, multitenancy.
"""
import pytest
from backend.components.metiers.administration_publique.utils.rbac.core import rbac_utils
