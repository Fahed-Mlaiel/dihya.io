...
# from components.metiers.administration_publique.utils.views.partials.partials_utils import ...
from backend.components.metiers.administration_publique.utils.views.partials import partials_views
