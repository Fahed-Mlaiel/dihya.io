...
# from components.metiers.administration_publique.utils.views.admin.admin_utils import ...


import pytest
from fastapi import HTTPException
from backend.components.metiers.administration_publique.utils.views.admin import admin_views
