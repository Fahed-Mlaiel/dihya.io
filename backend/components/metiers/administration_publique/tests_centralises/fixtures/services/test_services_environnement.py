...
from backend.components.metiers.administration_publique.fixtures.services.services_environnement import services
...
def test_services_fixture_nominal(services):
    val = services
    assert val["service"] == "administration_publique_env"
