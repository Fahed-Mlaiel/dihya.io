...
# from components.metiers.administration_publique.views.helpers.helpers import ...
...
def test_render_title():
    from backend.components.metiers.administration_publique.views.helpers import views_helper
