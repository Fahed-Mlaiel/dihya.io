...
def test_guide_fonctionnel_exemple_output(capsys):
    from backend.components.metiers.administration_publique.legacy.documentation.guides.fonctionnelle import (
        guide_fonctionnel_exemple,
    )

    guide_fonctionnel_exemple.guide_fonctionnel_exemple()
    captured = capsys.readouterr()
    assert "Guide fonctionnel legacy administration_publique" in captured.out
