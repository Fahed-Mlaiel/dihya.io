...
"""
Tests avancés pour les exemples des plugins administration_publique.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.administration_publique.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
