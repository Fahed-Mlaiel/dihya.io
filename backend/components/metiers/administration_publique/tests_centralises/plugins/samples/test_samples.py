...
"""
Tests avancés pour les samples des plugins administration_publique.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.administration_publique.plugins.samples.plugins_samples import exemple_plugin_sample
