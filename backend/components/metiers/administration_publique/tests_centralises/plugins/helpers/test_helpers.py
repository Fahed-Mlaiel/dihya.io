...
"""
Tests avancés pour les helpers des plugins administration_publique.
"""
...
def test_advanced_helper_function_exists():
    from backend.components.metiers.administration_publique.plugins.helpers.ultra_advanced_helpers import advanced_helper_function
