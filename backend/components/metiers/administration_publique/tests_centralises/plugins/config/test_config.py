...
"""
Tests avancés pour la configuration des plugins administration_publique.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.administration_publique.plugins.config.ultra_advanced_config import PluginConfigManager
