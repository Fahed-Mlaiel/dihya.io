...
"""
Tests avancés pour la documentation des plugins administration_publique.
"""
...
def test_generate_plugin_docs_exists():
    from backend.components.metiers.administration_publique.plugins.docs.ultra_advanced_docs import generate_plugin_docs
