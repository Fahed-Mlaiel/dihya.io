// test_sample_accessibility.js – Test ultra avancé des samples accessibilité API administration_publique (centralisé)

const { sampleAccessibilityCheck } = require('../../../api/samples/accessibility');

describe('Samples Accessibilité API administration_publique', () => {
