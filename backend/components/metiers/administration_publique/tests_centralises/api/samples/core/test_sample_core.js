// test_sample_core.js – Test ultra avancé des samples cœur métier API administration_publique (centralisé)

const { sampleCoreLogic } = require('../../../api/samples/core');

describe('Samples Cœur métier API administration_publique', () => {
