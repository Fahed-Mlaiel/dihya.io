...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier administration_publique.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.administration_publique.integration.pipelines import integration_pipelines
