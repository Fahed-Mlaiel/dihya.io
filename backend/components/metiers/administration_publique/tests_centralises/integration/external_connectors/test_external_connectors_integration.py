...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier administration_publique.
...
from backend.components.metiers.administration_publique.integration.external_connectors import integration_external
