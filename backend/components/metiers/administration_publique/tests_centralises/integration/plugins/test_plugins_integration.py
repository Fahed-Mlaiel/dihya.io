...
"""
Tests d’intégration ultra avancés pour les plugins métier administration_publique.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.administration_publique.integration.plugins import integration_plugins
