...
"""
Tests d’intégration ultra avancés pour le monitoring métier administration_publique.
...
from backend.components.metiers.administration_publique.integration.monitoring import integration_monitoring
