...
"""
Exemple ultra avancé de test d’intégration pour le métier administration_publique.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.administration_publique.integration.samples import integration_sample_python
