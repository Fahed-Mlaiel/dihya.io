...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier administration_publique.
...
from backend.components.metiers.administration_publique.integration.api import integration_api
