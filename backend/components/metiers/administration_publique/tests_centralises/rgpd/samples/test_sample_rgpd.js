 ...
 * @description Tests ultra avancés clé en main pour la conformité RGPD (échantillons/metier administration_publique)
...
function createRgpdApp() {
  ...
  app.get('/api/rgpd/export', (req, res) => {
    ...
    res.status(200).json({
      success: true,
      data: { id: 1, anonymized: true, name: 'Sampleadministration_publique' }
    });
  });
