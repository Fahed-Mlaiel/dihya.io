...
def test___init___content():
    ...
    assert "fonctionnel" in "guide fonctionnel avancé – Métier administration_publique".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.administration_publique.guides.functional import guide_fonctionnel
