"""
Module __init__ administration_publique :
...
from .sample_middlewares import sample_middleware_ultra
...
def check_access(user: str, permission: str) -> bool:
    """Vérifie les droits d’accès selon la logique métier administration_publique (edge cases inclus)."""
