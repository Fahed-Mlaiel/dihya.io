// fixtures.js - Fixtures ultra avancés pour le module administration_publique

module.exports = {
  sampleadministration_publiqueModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
    ...
    meta: {
      ...
      tags: ['cube', 'ultra', 'administration_publique'],
      validated: true
    }
  },
  assets: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle administration_publique est incomplet.' },
