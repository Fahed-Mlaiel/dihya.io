// Guide de migration automatisé legacy administration_publique (JS)
// Ultra avancé, clé en main, conforme au cahier des charges
function guideMigration() {
  console.log('# Guide de migration legacy administration_publique\n');
