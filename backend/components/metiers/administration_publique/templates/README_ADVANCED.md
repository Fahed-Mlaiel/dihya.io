/* global console */
# Templates administration_publique – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier administration_publique (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit administration_publique
...
- `templatesadministration_publique.templatesadministration_publique.js` : template JS avancé
