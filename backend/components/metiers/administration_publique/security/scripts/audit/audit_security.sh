...
find /workspaces/dihya.io/backend/components/metiers/administration_publique/security/ -type f -exec stat -c "%n %a" {} \; >> "$LOGFILE"

# Vérification de l’intégrité (hash)
find /workspaces/dihya.io/backend/components/metiers/administration_publique/security/ -type f -exec sha256sum {} \; >> "$LOGFILE"
