/* global console */
# Templates Health – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier health (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit health
...
- `templateshealth.templateshealth.js` : template JS avancé
