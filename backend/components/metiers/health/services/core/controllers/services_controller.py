"""
services_controller.py - Contrôleur avancé pour les services Health (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_health import ServiceHealth, get_health_model, list_health_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_health_model(model_id)
