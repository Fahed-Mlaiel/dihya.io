"""
fixtures_validator.py - Validation avancée des fixtures Health (Python)
"""


def is_valid_health_model(model):
    """Validate health model fixture.

    Args:
        model (dict): The health model fixture to validate.
