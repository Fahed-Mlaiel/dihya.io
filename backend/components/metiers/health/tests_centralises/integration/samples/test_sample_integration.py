...
"""
Exemple ultra avancé de test d’intégration pour le métier health.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.health.integration.samples import integration_sample_python
