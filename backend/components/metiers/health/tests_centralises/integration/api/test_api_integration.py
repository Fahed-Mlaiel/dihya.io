...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier health.
...
from backend.components.metiers.health.integration.api import integration_api
