...
# from components.metiers.health.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.health.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Health</h1>"
