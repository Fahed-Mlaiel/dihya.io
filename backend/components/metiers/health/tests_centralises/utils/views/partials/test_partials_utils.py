...
# from components.metiers.health.utils.views.partials.partials_utils import ...
from backend.components.metiers.health.utils.views.partials import partials_views
