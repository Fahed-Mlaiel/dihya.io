...
import pytest
from backend.components.metiers.health.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.health.utils.helpers.fallback.fallback import fallback_helper
