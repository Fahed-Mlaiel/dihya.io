...
"""
Tests avancés pour la configuration des plugins health.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.health.plugins.config.ultra_advanced_config import PluginConfigManager
