"""
api_views.py – Helpers et vues API avancées pour le module assurance
...
@router.post("/assurance/render")
def render_assurance_api(data: AssuranceAPIModel) -> Dict[str, Any]:
