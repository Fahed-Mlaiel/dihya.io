...
"""
Tests avancés pour les samples des plugins assurance.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.assurance.plugins.samples.plugins_samples import exemple_plugin_sample
