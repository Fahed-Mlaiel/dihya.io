...
"""
Tests avancés pour la configuration des plugins assurance.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.assurance.plugins.config.ultra_advanced_config import PluginConfigManager
