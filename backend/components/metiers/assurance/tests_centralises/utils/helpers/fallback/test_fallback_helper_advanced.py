...
import pytest
from backend.components.metiers.assurance.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.assurance.utils.helpers.fallback.fallback import fallback_helper
