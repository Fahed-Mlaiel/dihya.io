...
# from components.metiers.assurance.utils.views.partials.partials_utils import ...
from backend.components.metiers.assurance.utils.views.partials import partials_views
