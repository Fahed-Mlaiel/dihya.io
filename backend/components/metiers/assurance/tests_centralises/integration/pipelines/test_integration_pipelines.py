...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier assurance.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.assurance.integration.pipelines import integration_pipelines
