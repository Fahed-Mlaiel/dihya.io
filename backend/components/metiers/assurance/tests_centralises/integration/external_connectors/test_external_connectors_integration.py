...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier assurance.
...
from backend.components.metiers.assurance.integration.external_connectors import integration_external
