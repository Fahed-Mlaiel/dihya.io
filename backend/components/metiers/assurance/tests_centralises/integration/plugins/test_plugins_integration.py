...
"""
Tests d’intégration ultra avancés pour les plugins métier assurance.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.assurance.integration.plugins import integration_plugins
