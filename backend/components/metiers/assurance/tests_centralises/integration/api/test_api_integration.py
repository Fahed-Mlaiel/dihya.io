...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier assurance.
...
from backend.components.metiers.assurance.integration.api import integration_api
