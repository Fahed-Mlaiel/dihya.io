...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatAssuranceDetails préfixe correctement', () => {
        expect(helpers.formatAssuranceDetails('Ultra')).toBe('[assurance] Ultra');
    });
    ...
    it('formatAssuranceDetails gère les détails vides', () => {
        expect(helpers.formatAssuranceDetails('')).toBe('[assurance] ');
    });
});
