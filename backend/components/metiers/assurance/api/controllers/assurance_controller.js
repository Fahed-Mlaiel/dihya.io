// assurance_controller.js – Contrôleur ultra avancé API Assurance (JS)
const db = require('../db/db');
const { validateassuranceEntity } = require('../validators/validators');
...
const AssuranceController = {
  async getById(id) {
    ...
    let entity = db.findById('assurance', id);
  ...
  async create(data) {
    ...
    validateassuranceEntity(data);
    const created = db.insert('assurance', data);
  ...
  async update(id, data) {
    ...
    validateassuranceEntity(data);
    const updated = db.update('assurance', id, data);
  ...
  async delete(id) {
    ...
    const deleted = db.delete('assurance', id);
