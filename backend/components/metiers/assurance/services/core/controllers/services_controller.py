"""
services_controller.py - Contrôleur avancé pour les services Assurance (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_assurance import ServiceAssurance, get_assurance_model, list_assurance_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_assurance_model(model_id)
