/* global console */
# Templates Assurance – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier assurance (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit assurance
...
- `templatesassurance.templatesassurance.js` : template JS avancé
