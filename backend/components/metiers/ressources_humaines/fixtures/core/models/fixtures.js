// fixtures.js - Fixtures ultra avancés pour le module ressources_humaines

module.exports = {
  sampleressources_humainesModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
    ...
    meta: {
      ...
      tags: ['cube', 'ultra', 'ressources_humaines'],
      validated: true
    }
  },
  assets: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle ressources_humaines est incomplet.' },
