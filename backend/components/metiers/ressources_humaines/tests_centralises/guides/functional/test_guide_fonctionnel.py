...
def test___init___content():
    ...
    assert "fonctionnel" in "guide fonctionnel avancé – Métier Ressources_humaines".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.ressources_humaines.guides.functional import guide_fonctionnel
