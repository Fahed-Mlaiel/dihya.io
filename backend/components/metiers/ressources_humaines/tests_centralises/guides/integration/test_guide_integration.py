...
def test___init___content():
    assert "intégration" in "guide intégration avancé – Métier Ressources_humaines".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.ressources_humaines.guides.integration import guide_integration
