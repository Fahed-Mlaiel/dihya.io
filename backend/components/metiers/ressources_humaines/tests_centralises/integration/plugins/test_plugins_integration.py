...
"""
Tests d’intégration ultra avancés pour les plugins métier ressources_humaines.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.ressources_humaines.integration.plugins import integration_plugins
