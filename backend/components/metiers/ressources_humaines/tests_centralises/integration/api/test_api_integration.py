...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier ressources_humaines.
...
from backend.components.metiers.ressources_humaines.integration.api import integration_api
