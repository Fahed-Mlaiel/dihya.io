...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier ressources_humaines.
...
from backend.components.metiers.ressources_humaines.integration.external_connectors import integration_external
