...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier ressources_humaines.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.ressources_humaines.integration.pipelines import integration_pipelines
