...
def test_guide_fonctionnel_exemple_output(capsys):
    from backend.components.metiers.ressources_humaines.legacy.documentation.guides.fonctionnelle import (
        guide_fonctionnel_exemple,
    )

    guide_fonctionnel_exemple.guide_fonctionnel_exemple()
    captured = capsys.readouterr()
    assert "Guide fonctionnel legacy Ressources_humaines" in captured.out
