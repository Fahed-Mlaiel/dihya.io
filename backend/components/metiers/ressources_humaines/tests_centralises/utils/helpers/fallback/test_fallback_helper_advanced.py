...
import pytest
from backend.components.metiers.ressources_humaines.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.ressources_humaines.utils.helpers.fallback.fallback import fallback_helper
