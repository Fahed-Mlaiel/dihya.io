...
# from components.metiers.ressources_humaines.utils.views.admin.admin_utils import ...


import pytest
from fastapi import HTTPException
from backend.components.metiers.ressources_humaines.utils.views.admin import admin_views
