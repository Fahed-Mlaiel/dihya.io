...
# from components.metiers.ressources_humaines.utils.views.partials.partials_utils import ...
from backend.components.metiers.ressources_humaines.utils.views.partials import partials_views
