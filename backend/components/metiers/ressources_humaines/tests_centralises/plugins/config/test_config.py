...
"""
Tests avancés pour la configuration des plugins ressources_humaines.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.ressources_humaines.plugins.config.ultra_advanced_config import PluginConfigManager
