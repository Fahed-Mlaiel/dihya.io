...
"""
Tests avancés pour les samples des plugins ressources_humaines.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.ressources_humaines.plugins.samples.plugins_samples import exemple_plugin_sample
