...
"""
Tests avancés pour la documentation des plugins ressources_humaines.
"""
...
def test_generate_plugin_docs_exists():
    from backend.components.metiers.ressources_humaines.plugins.docs.ultra_advanced_docs import generate_plugin_docs
