...
"""
Tests avancés pour les exemples des plugins ressources_humaines.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.ressources_humaines.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
