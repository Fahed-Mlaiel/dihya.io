...
"""
Tests avancés pour les helpers des plugins ressources_humaines.
"""
...
def test_advanced_helper_function_exists():
    from backend.components.metiers.ressources_humaines.plugins.helpers.ultra_advanced_helpers import advanced_helper_function
