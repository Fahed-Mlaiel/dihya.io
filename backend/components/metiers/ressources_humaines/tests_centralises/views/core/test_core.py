...
# from components.metiers.ressources_humaines.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.ressources_humaines.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Ressources_humaines</h1>"
