...
# from components.metiers.ressources_humaines.views.helpers.helpers import ...
...
def test_render_title():
    from backend.components.metiers.ressources_humaines.views.helpers import views_helper
