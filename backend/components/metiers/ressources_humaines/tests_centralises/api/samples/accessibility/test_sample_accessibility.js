// test_sample_accessibility.js – Test ultra avancé des samples accessibilité API Ressources_humaines (centralisé)

const { sampleAccessibilityCheck } = require('../../../api/samples/accessibility');

describe('Samples Accessibilité API Ressources_humaines', () => {
