"""
services.py – Services d’audit avancés pour le legacy Ressources_humaines
...
from backend.components.metiers.ressources_humaines.legacy.audit.models.models import AuditLog
