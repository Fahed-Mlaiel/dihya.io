/* global console */
# README – Tests unitaires des templates Ressources_humaines
...
def test_rapport_audit_template():
    env = Environment(loader=FileSystemLoader('backend/components/metiers/ressources_humaines/templates'))
