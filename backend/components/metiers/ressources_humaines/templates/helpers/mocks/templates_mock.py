"""
templates_mock.py – Mocks pour tests unitaires et intégration des templates Ressources_humaines (Python)
...
def mock_email_notification():
    return {"details": "Nouvelle scène ressources_humaines créée"}
