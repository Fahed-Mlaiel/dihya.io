/* global console */
# Templates Ressources_humaines – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier ressources_humaines (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit ressources_humaines
...
- `templatesressources_humaines.templatesressources_humaines.js` : template JS avancé
