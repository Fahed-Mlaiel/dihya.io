/* global console */
# Templates Mode – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier mode (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit mode
...
- `templatesmode.templatesmode.js` : template JS avancé
