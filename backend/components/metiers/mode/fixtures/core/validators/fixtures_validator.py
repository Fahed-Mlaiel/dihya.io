"""
fixtures_validator.py - Validation avancée des fixtures Mode (Python)
"""


def is_valid_mode_model(model):
    """Validate mode model fixture.

    Args:
        model (dict): The mode model fixture to validate.
