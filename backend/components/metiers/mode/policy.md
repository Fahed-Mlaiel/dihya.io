# Mode – Politique de sécurité et conformité (Dihya Coding)
...
## Exemples de règles
- Un invité ne peut pas créer/modifier/supprimer une collection
- Un user peut gérer ses propres collections
