...
"""
Tests avancés pour la configuration des plugins mode.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.mode.plugins.config.ultra_advanced_config import PluginConfigManager
