...
# from components.metiers.mode.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.mode.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Mode</h1>"
