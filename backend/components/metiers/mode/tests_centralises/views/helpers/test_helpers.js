...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatModeDetails préfixe correctement', () => {
        expect(helpers.formatModeDetails('Ultra')).toBe('[mode] Ultra');
    });
    ...
    it('formatModeDetails gère les détails vides', () => {
        expect(helpers.formatModeDetails('')).toBe('[mode] ');
    });
});
