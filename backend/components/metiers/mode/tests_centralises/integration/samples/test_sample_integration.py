...
"""
Exemple ultra avancé de test d’intégration pour le métier mode.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.mode.integration.samples import integration_sample_python
