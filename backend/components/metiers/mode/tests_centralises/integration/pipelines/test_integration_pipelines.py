...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier mode.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.mode.integration.pipelines import integration_pipelines
