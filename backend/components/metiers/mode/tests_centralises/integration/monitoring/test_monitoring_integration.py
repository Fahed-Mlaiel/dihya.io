...
"""
Tests d’intégration ultra avancés pour le monitoring métier mode.
...
from backend.components.metiers.mode.integration.monitoring import integration_monitoring
