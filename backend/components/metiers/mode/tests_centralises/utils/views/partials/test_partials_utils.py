...
# from components.metiers.mode.utils.views.partials.partials_utils import ...
from backend.components.metiers.mode.utils.views.partials import partials_views
