"""
services_controller.py - Contrôleur avancé pour les services Mode (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_mode import ServiceMode, get_mode_model, list_mode_models, audit_model
