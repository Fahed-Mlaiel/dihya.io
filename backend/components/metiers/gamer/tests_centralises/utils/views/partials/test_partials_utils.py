...
# from components.metiers.gamer.utils.views.partials.partials_utils import ...
from backend.components.metiers.gamer.utils.views.partials import partials_views
