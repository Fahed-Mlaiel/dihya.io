...
"""
Tests avancés pour la configuration des plugins gamer.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.gamer.plugins.config.ultra_advanced_config import PluginConfigManager
