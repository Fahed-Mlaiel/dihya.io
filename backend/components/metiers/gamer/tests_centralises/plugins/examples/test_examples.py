...
"""
Tests avancés pour les exemples des plugins gamer.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.gamer.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
