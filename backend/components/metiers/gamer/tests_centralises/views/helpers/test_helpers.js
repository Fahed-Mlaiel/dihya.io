...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatGamerDetails préfixe correctement', () => {
        expect(helpers.formatGamerDetails('Ultra')).toBe('[gamer] Ultra');
    });
    ...
    it('formatGamerDetails gère les détails vides', () => {
        expect(helpers.formatGamerDetails('')).toBe('[gamer] ');
    });
});
