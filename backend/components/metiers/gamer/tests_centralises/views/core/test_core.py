...
# from components.metiers.gamer.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.gamer.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Gamer</h1>"
