...
"""
Exemple ultra avancé de test d’intégration pour le métier gamer.
Inclut : structure, checklist, conformité, bonnes pratiques.
"""

import pytest
from backend.components.metiers.gamer.integration.samples import integration_sample_python
