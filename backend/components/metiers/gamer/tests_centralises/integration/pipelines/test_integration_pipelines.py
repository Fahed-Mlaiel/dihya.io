...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier gamer.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.gamer.integration.pipelines import integration_pipelines
