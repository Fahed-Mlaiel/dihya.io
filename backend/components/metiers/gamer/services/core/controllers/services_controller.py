"""
services_controller.py - Contrôleur avancé pour les services Gamer (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_gamer import ServiceGamer, get_gamer_model, list_gamer_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_gamer_model(model_id)
