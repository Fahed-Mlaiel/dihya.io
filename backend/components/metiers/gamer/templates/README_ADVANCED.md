/* global console */
# Templates Gamer – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier gamer (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit gamer
...
- `templatesgamer.templatesgamer.js` : template JS avancé
