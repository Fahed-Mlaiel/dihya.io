"""
fixtures_validator.py - Validation avancée des fixtures Gamer (Python)
"""


def is_valid_gamer_model(model):
    """Validate gamer model fixture.

    Args:
        model (dict): The gamer model fixture to validate.
