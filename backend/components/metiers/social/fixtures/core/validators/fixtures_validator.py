"""
fixtures_validator.py - Validation avancée des fixtures Social (Python)
"""


def is_valid_social_model(model):
    """Validate social model fixture.

    Args:
        model (dict): The social model fixture to validate.
