"""
services_controller.py - Contrôleur avancé pour les services Social (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_social import ServiceSocial, get_social_model, list_social_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_social_model(model_id)
