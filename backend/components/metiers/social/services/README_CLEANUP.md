...
- Les fichiers `services_social.py` et `services_social.js` sont supprimés pour éviter toute confusion et redondance.
...
- Les fichiers principaux à utiliser sont :
  - `service_social.py` / `service_social.js` (logique métier principale)
