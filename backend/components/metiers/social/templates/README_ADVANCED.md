/* global console */
# Templates Social – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier social (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit social
...
- `templatessocial.templatessocial.js` : template JS avancé
