// api_views.js – Helpers et endpoints API avancés pour le module social
 ...
 *     responses:
 *       200:
 *         description: Vue social rendue
 */
router.post('/social/render', (req, res) => {
