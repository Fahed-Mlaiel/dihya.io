...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier social.
...
from backend.components.metiers.social.integration.api import integration_api
