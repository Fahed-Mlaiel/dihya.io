...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier social.
...
from backend.components.metiers.social.integration.external_connectors import integration_external
