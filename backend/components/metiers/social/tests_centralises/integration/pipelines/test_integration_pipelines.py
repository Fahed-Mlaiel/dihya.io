...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier social.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.social.integration.pipelines import integration_pipelines
