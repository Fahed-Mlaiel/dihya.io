...
"""
Tests d’intégration ultra avancés pour le monitoring métier social.
...
from backend.components.metiers.social.integration.monitoring import integration_monitoring
