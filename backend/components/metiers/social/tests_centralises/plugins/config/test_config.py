...
"""
Tests avancés pour la configuration des plugins social.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.social.plugins.config.ultra_advanced_config import PluginConfigManager
