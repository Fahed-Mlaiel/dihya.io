...
"""
Tests avancés pour la documentation des plugins social.
"""
...
def test_generate_plugin_docs_exists():
    from backend.components.metiers.social.plugins.docs.ultra_advanced_docs import generate_plugin_docs
