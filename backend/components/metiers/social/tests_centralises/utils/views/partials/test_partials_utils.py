...
# from components.metiers.social.utils.views.partials.partials_utils import ...
from backend.components.metiers.social.utils.views.partials import partials_views
