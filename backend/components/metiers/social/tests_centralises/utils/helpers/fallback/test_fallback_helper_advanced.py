...
import pytest
from backend.components.metiers.social.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.social.utils.helpers.fallback.fallback import fallback_helper
