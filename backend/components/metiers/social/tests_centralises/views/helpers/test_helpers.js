...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatSocialDetails préfixe correctement', () => {
        expect(helpers.formatSocialDetails('Ultra')).toBe('[social] Ultra');
    });
    ...
    it('formatSocialDetails gère les détails vides', () => {
        expect(helpers.formatSocialDetails('')).toBe('[social] ');
    });
});
