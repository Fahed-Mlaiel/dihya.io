// social_controller.js – Contrôleur ultra avancé API Social (JS)
const db = require('../db/db');
const { validatesocialEntity } = require('../validators/validators');
...
const SocialController = {
  async getById(id) {
    ...
    let entity = db.findById('social', id);
  ...
  async create(data) {
    ...
    validatesocialEntity(data);
    const created = db.insert('social', data);
  ...
  async update(id, data) {
    ...
    validatesocialEntity(data);
    const updated = db.update('social', id, data);
  ...
  async delete(id) {
    ...
    const deleted = db.delete('social', id);
