...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier blockchain.
...
from backend.components.metiers.blockchain.integration.api import integration_api
