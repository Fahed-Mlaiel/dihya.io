...
"""
Tests d’intégration ultra avancés pour les plugins métier blockchain.
Inclut : interopérabilité, sécurité, conformité, auditabilité.
"""

import pytest
from backend.components.metiers.blockchain.integration.plugins import integration_plugins
