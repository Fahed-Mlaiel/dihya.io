...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier blockchain.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.blockchain.integration.pipelines import integration_pipelines
