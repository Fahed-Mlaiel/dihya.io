...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatBlockchainDetails préfixe correctement', () => {
        expect(helpers.formatBlockchainDetails('Ultra')).toBe('[blockchain] Ultra');
    });
    ...
    it('formatBlockchainDetails gère les détails vides', () => {
        expect(helpers.formatBlockchainDetails('')).toBe('[blockchain] ');
    });
});
