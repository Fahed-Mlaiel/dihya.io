...
# from components.metiers.blockchain.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.blockchain.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Blockchain</h1>"
