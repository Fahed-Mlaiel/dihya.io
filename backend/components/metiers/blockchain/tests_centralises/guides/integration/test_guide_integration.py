...
def test___init___content():
    assert "intégration" in "guide intégration avancé – Métier Blockchain".lower()

def test_print_guide_output(capsys):
    from backend.components.metiers.blockchain.guides.integration import guide_integration
