...
import pytest
from backend.components.metiers.blockchain.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.blockchain.utils.helpers.fallback.fallback import fallback_helper
