...
# from components.metiers.blockchain.utils.views.partials.partials_utils import ...
from backend.components.metiers.blockchain.utils.views.partials import partials_views
