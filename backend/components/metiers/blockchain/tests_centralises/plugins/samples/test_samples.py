...
"""
Tests avancés pour les samples des plugins blockchain.
"""
...
def test_exemple_plugin_sample_exists():
    ...
    from backend.components.metiers.blockchain.plugins.samples.plugins_samples import exemple_plugin_sample
