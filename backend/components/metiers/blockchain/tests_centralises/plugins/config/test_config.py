...
"""
Tests avancés pour la configuration des plugins blockchain.
"""
...
def test_plugin_config_manager_nominal():
    from backend.components.metiers.blockchain.plugins.config.ultra_advanced_config import PluginConfigManager
