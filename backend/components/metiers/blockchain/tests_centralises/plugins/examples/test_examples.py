...
"""
Tests avancés pour les exemples des plugins blockchain.
"""
...
def test_exemple_utilisation_plugin_exists():
    from backend.components.metiers.blockchain.plugins.examples.example_usage_professionnel import exemple_utilisation_plugin
