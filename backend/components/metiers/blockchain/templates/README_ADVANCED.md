/* global console */
# Templates Blockchain – Documentation Ultra Avancée

Ce dossier contient :
- Templates Jinja2, HTML, JSON, XML, JS pour tous les usages métier blockchain (audit, notification, accessibilité, export, SEO, etc.)
...
- `rapport_audit.html.j2` : audit blockchain
...
- `templatesblockchain.templatesblockchain.js` : template JS avancé
