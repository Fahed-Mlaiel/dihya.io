# Config – Module Blockchain Ultra Avancé

Ce dossier regroupe tous les fichiers, helpers et logiques config spécifiques au métier **Blockchain**.
...
## 👩‍💻 Contact référent
- Product Owner : po-blockchain@dihya.io
