...
- Les fichiers `services_blockchain.py` et `services_blockchain.js` sont supprimés pour éviter toute confusion et redondance.
...
- Les fichiers principaux à utiliser sont :
  - `service_blockchain.py` / `service_blockchain.js` (logique métier principale)
