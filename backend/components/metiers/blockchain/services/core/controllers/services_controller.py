"""
services_controller.py - Contrôleur avancé pour les services Blockchain (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_blockchain import ServiceBlockchain, get_blockchain_model, list_blockchain_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_blockchain_model(model_id)
