// fixtures.js - Fixtures ultra avancés pour le module blockchain

module.exports = {
  sampleblockchainModel: {
    id: 'model-001',
    name: 'Cube Ultra',
    vertices: [
  ...
  errors: [
    { code: 'ERR_MISSING_VERTEX', message: 'Le modèle blockchain est incomplet.' },
