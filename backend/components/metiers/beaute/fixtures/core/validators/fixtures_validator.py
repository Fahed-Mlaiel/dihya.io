"""
fixtures_validator.py - Validation avancée des fixtures Beaute (Python)
"""


def is_valid_beaute_model(model):
    """Validate beaute model fixture.

    Args:
        model (dict): The beaute model fixture to validate.
