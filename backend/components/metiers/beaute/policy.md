# Beauté – Politique de sécurité et conformité
...
## Exemples de règles
- Un invité ne peut pas créer/modifier/supprimer un profil beauté
- Un user peut gérer ses propres profils beauté
