"""
services_controller.py - Contrôleur avancé pour les services Beaute (Python)
Inclut : endpoints, hooks, audit, sécurité, CI/CD, doc intégrée.
"""

from ..impl.service_beaute import ServiceBeaute, get_beaute_model, list_beaute_models, audit_model
...
class ServicesController:
    ...
    def get_model(self, model_id, user):
        ...
        model = get_beaute_model(model_id)
