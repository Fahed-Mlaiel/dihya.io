...
import pytest
from backend.components.metiers.beaute.utils.logger.fallback.fallback import logger_fallback
from backend.components.metiers.beaute.utils.helpers.fallback.fallback import fallback_helper
