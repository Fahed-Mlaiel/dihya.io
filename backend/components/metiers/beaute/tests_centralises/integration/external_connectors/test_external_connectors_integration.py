...
"""
Tests d’intégration ultra avancés pour les connecteurs externes (ERP, CRM, SSO) métier beaute.
...
from backend.components.metiers.beaute.integration.external_connectors import integration_external
