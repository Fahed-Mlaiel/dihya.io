...
"""
Tests d’intégration ultra avancés pour les endpoints API du métier beaute.
...
from backend.components.metiers.beaute.integration.api import integration_api
