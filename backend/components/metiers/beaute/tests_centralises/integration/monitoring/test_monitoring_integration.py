...
"""
Tests d’intégration ultra avancés pour le monitoring métier beaute.
...
from backend.components.metiers.beaute.integration.monitoring import integration_monitoring
