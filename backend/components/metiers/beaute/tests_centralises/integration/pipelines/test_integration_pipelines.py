...
"""
Tests d’intégration ultra avancés pour les pipelines CI/CD du métier beaute.
Inclut : automatisation, conformité, auditabilité, scénarios métier.
"""

import pytest
from backend.components.metiers.beaute.integration.pipelines import integration_pipelines
