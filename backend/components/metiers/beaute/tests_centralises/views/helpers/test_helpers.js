...
describe('Views Helpers Central Tests', () => {
    ...
    it('formatBeauteDetails préfixe correctement', () => {
        expect(helpers.formatBeauteDetails('Ultra')).toBe('[beaute] Ultra');
    });
    ...
    it('formatBeauteDetails gère les détails vides', () => {
        expect(helpers.formatBeauteDetails('')).toBe('[beaute] ');
    });
});
