...
# from components.metiers.beaute.views.core.core import ...
...
def test_render_home():
    from backend.components.metiers.beaute.views.core import views

    assert views.render_home() == "<h1>Bienvenue sur Beaute</h1>"
