...
const validateMediasInput = (req, res, next) => next();
const getMediasData = async () => ([]);
const createMediasEntry = async () => ({});
const updateMediasEntry = async () => ({});
const deleteMediasEntry = async () => ({});
...
router.use(pluginMiddleware('medias'));
