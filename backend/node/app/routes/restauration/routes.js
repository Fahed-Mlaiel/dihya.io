...
const validateRestaurationInput = (req, res, next) => next();
const getRestaurationData = async () => ([]);
const createRestaurationEntry = async () => ({});
const updateRestaurationEntry = async () => ({});
const deleteRestaurationEntry = async () => ({});
...
router.use(pluginMiddleware('restauration'));
