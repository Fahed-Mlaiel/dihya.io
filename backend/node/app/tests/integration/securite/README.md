# README – Tests d'intégration Sécurité

Tests automatisés pour le métier Sécurité : sécurité, RGPD, accessibilité, multilingue (13+ langues), CI/CD-ready, plugins, audit, monitoring, documentation intégrée.
