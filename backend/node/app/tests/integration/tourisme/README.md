# README – Tests d'intégration Tourisme

Tests automatisés pour le métier Tourisme : sécurité, RGPD, accessibilité, multilingue (13+ langues), CI/CD-ready, plugins, audit, monitoring, documentation intégrée.
