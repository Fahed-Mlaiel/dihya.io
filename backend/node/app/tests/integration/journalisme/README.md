# README – Tests d'intégration Journalisme

Tests automatisés pour le métier Journalisme : sécurité, RGPD, accessibilité, multilingue (13+ langues), CI/CD-ready, plugins, audit, monitoring, documentation intégrée.
