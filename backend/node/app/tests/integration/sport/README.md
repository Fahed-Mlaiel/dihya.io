# README – Tests d'intégration Sport

Tests automatisés pour le métier Sport : sécurité, RGPD, accessibilité, multilingue (13+ langues), CI/CD-ready, plugins, audit, monitoring, documentation intégrée.
