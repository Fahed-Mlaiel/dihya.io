# README – Tests d'intégration Transport

Tests automatisés pour le métier Transport : sécurité, RGPD, accessibilité, multilingue (13+ langues), CI/CD-ready, plugins, audit, monitoring, documentation intégrée.
