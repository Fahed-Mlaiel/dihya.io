# README – Tests d'intégration Marketing

Tests automatisés pour le métier Marketing : sécurité, RGPD, accessibilité, multilingue (13+ langues), CI/CD-ready, plugins, audit, monitoring, documentation intégrée.
