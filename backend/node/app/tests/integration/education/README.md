# README – Tests d'intégration Education

Tests automatisés pour le métier Education : sécurité, RGPD, accessibilité, multilingue (13+ langues), CI/CD-ready, plugins, audit, monitoring, documentation intégrée.
