# README – Tests d’intégration Médias (IA/VR/AR)

Ce dossier contient les tests d’intégration avancés pour la gestion de projets IA, VR, AR dans le secteur des médias.
...
## Structure
- `test_medias.js` : tests d’intégration complets (sécurité, RGPD, accessibilité, i18n, plugins, audit, fallback IA, RBAC, multitenancy, SEO backend, CI/CD)
...
## Guides
- Lancer les tests : `npm run test:integration -- medias`
