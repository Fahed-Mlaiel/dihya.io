# README – Tests d'intégration Science

Tests automatisés pour le métier Science : sécurité, RGPD, accessibilité, multilingue (13+ langues), CI/CD-ready, plugins, audit, monitoring, documentation intégrée.
