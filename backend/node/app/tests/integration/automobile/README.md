# README – Tests d'intégration Automobile

Tests automatisés pour le métier Automobile : sécurité, RGPD, accessibilité, multilingue (13+ langues), CI/CD-ready, plugins, audit, monitoring, documentation intégrée.
