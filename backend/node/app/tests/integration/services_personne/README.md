# README – Tests d'intégration Services à la personne

Tests automatisés pour le métier Services à la personne : sécurité, RGPD, accessibilité, multilingue (13+ langues), CI/CD-ready, plugins, audit, monitoring, documentation intégrée.
