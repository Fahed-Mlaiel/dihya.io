# README – Tests d'intégration Arts

Tests automatisés pour le métier Arts : sécurité, RGPD, accessibilité, multilingue (13+ langues), CI/CD-ready, plugins, audit, monitoring, documentation intégrée.
