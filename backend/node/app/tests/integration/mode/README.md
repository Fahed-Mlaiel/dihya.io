# README – Tests d'intégration Mode

Tests automatisés pour le métier Mode : sécurité, RGPD, accessibilité, multilingue (13+ langues), CI/CD-ready, plugins, audit, monitoring, documentation intégrée.
