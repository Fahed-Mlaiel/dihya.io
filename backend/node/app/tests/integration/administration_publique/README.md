# README – Tests d’intégration Administration Publique (IA/VR/AR)

Ce dossier contient les tests d’intégration avancés pour la gestion de projets IA, VR, AR dans le secteur de l’administration publique.
...
## Structure
- `test_administration_publique.js` : tests d’intégration complets (sécurité, RGPD, accessibilité, i18n, plugins, audit, fallback IA, RBAC, multitenancy, SEO backend, CI/CD)
...
## Guides
- Lancer les tests : `npm run test:integration -- administration_publique`
