# Marketing – Tests d'intégration

## Objectif
Ce dossier contient des tests d'intégration avancés pour toutes les routes, plugins et modules liés à la gestion de projets marketing (campagnes, analytics, CRM, etc.) sur Dihya.
...
## Structure
- `test_marketing_api.integration.test.js` : tests API REST/GraphQL
