# Juridique – Tests d'intégration

## Objectif
Ce dossier contient des tests d'intégration avancés pour toutes les routes, plugins et modules liés à la gestion de projets juridiques (cabinets, conformité, contrats, etc.) sur Dihya.
...
## Structure
- `test_juridique_api.integration.test.js` : tests API REST/GraphQL
