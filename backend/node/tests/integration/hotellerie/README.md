# Hôtellerie – Tests d'intégration

## Objectif
Ce dossier contient des tests d'intégration avancés pour toutes les routes, plugins et modules liés à la gestion de projets hôteliers (hôtels, resorts, hébergement, etc.) sur Dihya.
...
## Structure
- `test_hotellerie_api.integration.test.js` : tests API REST/GraphQL
