# Immobilier – Tests d'intégration

## Objectif
Ce dossier contient des tests d'intégration avancés pour toutes les routes, plugins et modules liés à la gestion de projets immobiliers (agences, gestion locative, smart buildings, etc.) sur Dihya.
...
## Structure
- `test_immobilier_api.integration.test.js` : tests API REST/GraphQL
