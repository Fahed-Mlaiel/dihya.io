/**
 * @file test_social.js
 * @description Tests d'intégration avancés pour l'API social (REST/GraphQL, sécurité, i18n, plugins, RGPD, etc.)
 * @author Dihya
 * @date 2025-05-25
 */
...
describe('Social API - Sécurité, i18n, RGPD, Plugins, SEO', () => {
  it('GET /api/social retourne la liste (auth, i18n)', async () => {
  ...
  it('POST /api/social (admin)', async () => {
    const res = await request(app)
      .post('/api/social')
      .set('Authorization', `Bearer ${adminToken}`)
      .send({ nom: 'Réseau IA', description: 'Social automatisé' })
      .expect(201);
