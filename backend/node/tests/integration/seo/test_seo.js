/**
 * @file test_seo.js
 * @description Tests d'intégration avancés pour l'API SEO (REST/GraphQL, sécurité, i18n, plugins, RGPD, etc.)
 * @author Dihya
 * @date 2025-05-25
 */
...
describe('SEO API - Sécurité, i18n, RGPD, Plugins, SEO', () => {
  it('GET /api/seo retourne la liste (auth, i18n)', async () => {
  ...
  it('POST /api/seo (admin)', async () => {
    const res = await request(app)
      .post('/api/seo')
      .set('Authorization', `Bearer ${adminToken}`)
      .send({ nom: 'SEO IA', description: 'SEO automatisé' })
      .expect(201);
