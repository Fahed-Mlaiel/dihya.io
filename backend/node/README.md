# Node.js – Dihya Integration Test Suite
...
## Présentation
Ce module fournit des tests d'intégration avancés pour les services Node.js de Dihya (API, scripts, microservices, plugins). Il couvre la sécurité (CORS, JWT, WAF, anti-DDOS), l'audit, la conformité RGPD, la génération de routes REST/GraphQL, la gestion multitenant, l'intégration IA (LLaMA, Mixtral, Mistral), et la documentation multilingue.

## Fonctionnalités principales
- Génération automatique de routes RESTful & GraphQL pour Node.js
...
- `/api/node/services` (CRUD, multilingue, RBAC, audit)
- `/api/node/plugins` (ajout dynamique, sécurité)
