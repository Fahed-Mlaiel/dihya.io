"use strict";
/**
 * @fileoverview Routes pour la gestion des projets Hôtellerie.
 * @module routes/hotellerie
 * @description API REST & GraphQL Hôtellerie, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
...
const { hotellerieSchema } = require("../../../../graphql/schemas/hotellerie");
router.use("/graphql", [checkJwt, i18nMiddleware, wafMiddleware, ddosMiddleware], graphqlHTTP({
  schema: hotellerieSchema,
  graphiql: true,
}));

router.use("/plugins", pluginManager("hotellerie"));
