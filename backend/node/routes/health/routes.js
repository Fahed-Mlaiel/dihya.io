"use strict";
/**
 * @fileoverview Routes pour la gestion des projets Santé.
 * @module routes/health
 * @description API REST & GraphQL Santé, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
...
const { healthSchema } = require("../../../../graphql/schemas/health");
router.use("/graphql", [checkJwt, i18nMiddleware, wafMiddleware, ddosMiddleware], graphqlHTTP({
  schema: healthSchema,
  graphiql: true,
}));

router.use("/plugins", pluginManager("health"));
