"use strict";
/**
 * @fileoverview Routes pour la gestion des projets Juridique.
 * @module routes/juridique
 * @description API REST & GraphQL Juridique, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
...
const { juridiqueSchema } = require("../../../../graphql/schemas/juridique");
router.use("/graphql", [checkJwt, i18nMiddleware, wafMiddleware, ddosMiddleware], graphqlHTTP({
  schema: juridiqueSchema,
  graphiql: true,
}));

router.use("/plugins", pluginManager("juridique"));
