"use strict";
/**
 * @fileoverview Routes pour la gestion des projets IT & DevOps.
 * @module routes/it_devops
 * @description API REST & GraphQL IT & DevOps, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
...
const { itDevopsSchema } = require("../../../../graphql/schemas/it_devops");
router.use("/graphql", [checkJwt, i18nMiddleware, wafMiddleware, ddosMiddleware], graphqlHTTP({
  schema: itDevopsSchema,
  graphiql: true,
}));

router.use("/plugins", pluginManager("it_devops"));
