"use strict";
/**
 * @fileoverview Routes pour la gestion des projets Beauté.
 * @module routes/beaute
 * @description API REST & GraphQL Beauté, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
...
const { beauteSchema } = require("../../../../graphql/schemas/beaute");
