"use strict";
/**
 * @fileoverview Routes pour la gestion des projets Construction.
 * @module routes/construction
 * @description API REST & GraphQL Construction, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
...
const { constructionSchema } = require("../../../../graphql/schemas/construction");
router.use("/graphql", [checkJwt, i18nMiddleware, wafMiddleware, ddosMiddleware], graphqlHTTP({
  schema: constructionSchema,
  graphiql: true,
}));

router.use("/plugins", pluginManager("construction"));
