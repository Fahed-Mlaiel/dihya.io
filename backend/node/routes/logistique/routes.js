"use strict";
/**
 * @fileoverview Routes pour la gestion des projets Logistique.
 * @module routes/logistique
 * @description API REST & GraphQL Logistique, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
...
const { logistiqueSchema } = require("../../../../graphql/schemas/logistique");
router.use("/graphql", [checkJwt, i18nMiddleware, wafMiddleware, ddosMiddleware], graphqlHTTP({
  schema: logistiqueSchema,
  graphiql: true,
}));

router.use("/plugins", pluginManager("logistique"));
