"use strict";
/**
 * @fileoverview Routes pour la gestion des projets Education.
 * @module routes/education
 * @description API REST & GraphQL Education, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
...
const { educationSchema } = require("../../../../graphql/schemas/education");
router.use("/graphql", [checkJwt, i18nMiddleware, wafMiddleware, ddosMiddleware], graphqlHTTP({
  schema: educationSchema,
  graphiql: true,
}));

router.use("/plugins", pluginManager("education"));
