"use strict";
/**
 * @fileoverview Routes pour la gestion des projets Gamer.
 * @module routes/gamer
 * @description API REST & GraphQL Gamer, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
...
const { gamerSchema } = require("../../../../graphql/schemas/gamer");
router.use("/graphql", [checkJwt, i18nMiddleware, wafMiddleware, ddosMiddleware], graphqlHTTP({
  schema: gamerSchema,
  graphiql: true,
}));

router.use("/plugins", pluginManager("gamer"));
