"use strict";
/**
 * @fileoverview Routes pour la gestion des projets Crypto.
 * @module routes/crypto
 * @description API REST & GraphQL Crypto, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
...
const { cryptoSchema } = require("../../../../graphql/schemas/crypto");
router.use("/graphql", [checkJwt, i18nMiddleware, wafMiddleware, ddosMiddleware], graphqlHTTP({
  schema: cryptoSchema,
  graphiql: true,
}));

router.use("/plugins", pluginManager("crypto"));
