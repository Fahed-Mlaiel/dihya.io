"use strict";
/**
 * @fileoverview Routes pour la gestion des projets Energie.
 * @module routes/energie
 * @description API REST & GraphQL Energie, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
