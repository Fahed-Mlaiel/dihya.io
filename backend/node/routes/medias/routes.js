"use strict";
/**
 * @fileoverview Routes pour la gestion des projets Médias.
 * @module routes/medias
 * @description API REST & GraphQL Médias, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
...
const { mediasSchema } = require("../../../../graphql/schemas/medias");
router.use("/graphql", [checkJwt, i18nMiddleware, wafMiddleware, ddosMiddleware], graphqlHTTP({
  schema: mediasSchema,
  graphiql: true,
}));

router.use("/plugins", pluginManager("medias"));
