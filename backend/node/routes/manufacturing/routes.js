"use strict";
/**
 * @fileoverview Routes pour la gestion des projets Manufacturing.
 * @module routes/manufacturing
 * @description API REST & GraphQL Manufacturing, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
...
const { manufacturingSchema } = require("../../../../graphql/schemas/manufacturing");
router.use("/graphql", [checkJwt, i18nMiddleware, wafMiddleware, ddosMiddleware], graphqlHTTP({
  schema: manufacturingSchema,
  graphiql: true,
}));

router.use("/plugins", pluginManager("manufacturing"));
