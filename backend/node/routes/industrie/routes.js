"use strict";
/**
 * @fileoverview Routes pour la gestion des projets Industrie.
 * @module routes/industrie
 * @description API REST & GraphQL Industrie, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
...
const { industrieSchema } = require("../../../../graphql/schemas/industrie");
router.use("/graphql", [checkJwt, i18nMiddleware, wafMiddleware, ddosMiddleware], graphqlHTTP({
  schema: industrieSchema,
  graphiql: true,
}));

router.use("/plugins", pluginManager("industrie"));
