"use strict";
/**
 * @fileoverview Routes pour la gestion des projets E-commerce.
 * @module routes/ecommerce
 * @description API REST & GraphQL E-commerce, sécurité, i18n, multitenancy, plugins, audit, RGPD, SEO, IA fallback, etc.
 * @author Dihya Team
 * @version 1.0.0
 * @license MIT
 */
