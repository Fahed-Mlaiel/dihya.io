...
# Tests d'intégration secteur Intelligence Artificielle

Ce dossier contient les tests d'intégration avancés pour les APIs du secteur Intelligence Artificielle dans Dihya.
...
## Exemples de tests
- Création de projet IA (admin, user, invité)
