...
# Tests d'intégration secteur Journalisme

Ce dossier contient les tests d'intégration avancés pour les APIs du secteur Journalisme dans Dihya.
...
## Exemples de tests
- Création de projet journalisme (admin, user, invité)
