# Tests d'intégration secteur Médias

Ce dossier contient les tests d'intégration avancés pour les APIs du secteur Médias dans Dihya.
...
## Exemples de tests
- Création de projet médias (admin, user, invité)
