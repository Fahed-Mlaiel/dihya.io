...
# Tests d'intégration secteur Immobilier

Ce dossier contient les tests d'intégration avancés pour les APIs du secteur Immobilier dans Dihya.
...
## Exemples de tests
- Création de projet immobilier (admin, user, invité)
