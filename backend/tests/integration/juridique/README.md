# Tests d'intégration secteur Juridique

Ce dossier contient les tests d'intégration avancés pour les APIs du secteur Juridique dans Dihya.
...
## Exemples de tests
- Création de projet juridique (admin, user, invité)
