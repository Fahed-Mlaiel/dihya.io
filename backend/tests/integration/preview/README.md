# Tests d'intégration secteur Preview

Ce dossier contient les tests d'intégration avancés pour les APIs du secteur Preview dans Dihya.
...
## Exemples de tests
- Création de projet preview (admin, user, invité)
