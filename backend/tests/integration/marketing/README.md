...
# Tests d'intégration secteur Marketing

Ce dossier contient les tests d'intégration avancés pour les APIs du secteur Marketing dans Dihya.
...
## Exemples de tests
- Création de projet marketing (admin, user, invité)
