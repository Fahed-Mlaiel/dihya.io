...
# Tests d'intégration secteur Publicité

Ce dossier contient les tests d'intégration avancés pour les APIs du secteur Publicité dans Dihya.
...
## Exemples de tests
- Création de projet publicité (admin, user, invité)
- Vérification des logs structurées
