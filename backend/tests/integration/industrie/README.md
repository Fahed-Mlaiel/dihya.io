# Tests d'intégration secteur Industrie

Ce dossier contient les tests d'intégration avancés pour les APIs du secteur Industrie dans Dihya.
...
## Exemples de tests
- Création de projet industriel (admin, user, invité)
