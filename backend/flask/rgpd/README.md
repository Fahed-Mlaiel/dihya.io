# RGPD Backend - Dihya Coding

Ce dossier contient la logique RGPD : anonymisation, export, audit, logs, conformité, accessibilité, plugins, etc.

- `anonymize.py` : anonymisation utilisateur
- `export.py` : export données utilisateur
- Logs structurés, auditabilité, accès exportable
- Conforme RGPD, multilingue, plugins

Voir `DATA_PRIVACY_IMPACT_ASSESSMENT.md` et exemples dans ce dossier.
