# Dihya Transport – API Métier

Ce module expose des routes RESTful et GraphQL pour la gestion de projets transport (logistique, mobilité, flotte, etc.).
...
- Génération automatique de projets transport (web, mobile, scripts)
