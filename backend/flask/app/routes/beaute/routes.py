"""
Routes RESTful & GraphQL pour la beauté (IA, VR, AR, etc.)
...
bp = Blueprint('beaute', __name__, url_prefix='/api/beaute')

@bp.route('/projects', methods=['GET'])
@jwt_required()
# ...@require_role(['admin', 'user'])...
def list_projects():
    """Liste les projets beauté (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet beauté (validation, RGPD, fallback IA, audit)."""
    data = request.json
