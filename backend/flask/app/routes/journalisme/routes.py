"""
Routes RESTful & GraphQL pour le journalisme (IA, VR, AR, etc.)
...
def list_projects():
    """Liste les projets journalisme (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet journalisme (validation, RGPD, fallback IA, audit)."""
    data = request.json
