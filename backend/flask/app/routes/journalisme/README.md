# Journalisme – API Dihya

Ce module gère les routes RESTful et GraphQL pour les projets journalisme (IA, VR, AR, etc.).
...
```bash
curl -H "Authorization: Bearer <token>" https://.../api/journalisme/projects
```
