"""
Routes RESTful & GraphQL pour l’agriculture (IA, VR, AR, etc.)
...
bp = Blueprint('agriculture', __name__, url_prefix='/api/agriculture')

@bp.route('/projects', methods=['GET'])
@jwt_required()
# ...@require_role(['admin', 'user'])...
def list_projects():
    """Liste les projets agricoles (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet agricole (validation, RGPD, fallback IA, audit)."""
    data = request.json
