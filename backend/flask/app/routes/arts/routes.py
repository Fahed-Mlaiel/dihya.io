"""
Routes RESTful & GraphQL pour les arts (IA, VR, AR, etc.)
...
bp = Blueprint('arts', __name__, url_prefix='/api/arts')

@bp.route('/projects', methods=['GET'])
@jwt_required()
# ...@require_role(['admin', 'user'])...
def list_projects():
    """Liste les projets artistiques (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet artistique (validation, RGPD, fallback IA, audit)."""
    data = request.json
