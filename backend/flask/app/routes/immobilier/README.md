# Immobilier – API Dihya

Ce module gère les routes RESTful et GraphQL pour la gestion de projets immobilier (biens, locations, IA, etc.) avec sécurité maximale, multilingue, multitenant, audit, et intégration IA.

## Fonctionnalités principales
- CRUD biens, locations, propriétaires, locataires
