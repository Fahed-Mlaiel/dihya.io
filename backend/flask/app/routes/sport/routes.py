"""
Routes RESTful & GraphQL pour le sport (IA, VR, AR, etc.)
...
def list_projects():
    """Liste les projets sport (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet sport (validation, RGPD, fallback IA, audit)."""
    data = request.json
