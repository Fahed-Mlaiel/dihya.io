# Banque & Finance – API Dihya

Ce module gère les routes RESTful et GraphQL pour les projets bancaires et financiers (IA, VR, AR, etc.).
...
```bash
curl -H "Authorization: Bearer <token>" https://.../api/banque_finance/projects
```
