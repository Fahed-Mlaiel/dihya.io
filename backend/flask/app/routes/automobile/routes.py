"""
Routes RESTful & GraphQL pour l’automobile (IA, VR, AR, etc.)
...
bp = Blueprint('automobile', __name__, url_prefix='/api/automobile')

@bp.route('/projects', methods=['GET'])
@jwt_required()
# ...@require_role(['admin', 'user'])...
def list_projects():
    """Liste les projets automobiles (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet automobile (validation, RGPD, fallback IA, audit)."""
    data = request.json
