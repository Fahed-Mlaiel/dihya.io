"""
Routes RESTful & GraphQL pour la santé (IA, VR, AR, etc.)
...
def list_projects():
    """Liste les projets santé (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet santé (validation, RGPD, fallback IA, audit)."""
    data = request.json
