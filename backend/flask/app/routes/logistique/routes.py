"""
Routes RESTful & GraphQL pour la logistique (IA, VR, AR, etc.)
...
def list_projects():
    """Liste les projets logistique (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet logistique (validation, RGPD, fallback IA, audit)."""
    data = request.json
