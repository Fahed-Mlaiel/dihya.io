"""
Routes RESTful & GraphQL pour l’assurance (IA, VR, AR, etc.)
...
bp = Blueprint('assurance', __name__, url_prefix='/api/assurance')

@bp.route('/projects', methods=['GET'])
@jwt_required()
# ...@require_role(['admin', 'user'])...
def list_projects():
    """Liste les projets d’assurance (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet d’assurance (validation, RGPD, fallback IA, audit)."""
    data = request.json
