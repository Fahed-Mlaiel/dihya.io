"""
Routes RESTful & GraphQL pour la sécurité (IA, VR, AR, etc.)
...
def list_projects():
    """Liste les projets sécurité (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet sécurité (validation, RGPD, fallback IA, audit)."""
    data = request.json
