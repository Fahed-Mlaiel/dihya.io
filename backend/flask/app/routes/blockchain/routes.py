"""
Routes RESTful & GraphQL pour la blockchain (IA, VR, AR, etc.)
...
def list_projects():
    """Liste les projets blockchain (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet blockchain (validation, RGPD, fallback IA, audit)."""
    data = request.json
