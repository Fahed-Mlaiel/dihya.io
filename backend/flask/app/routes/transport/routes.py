"""
Routes RESTful & GraphQL pour le transport (IA, VR, AR, etc.)
...
def list_projects():
    """Liste les projets transport (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet transport (validation, RGPD, fallback IA, audit)."""
    data = request.json
