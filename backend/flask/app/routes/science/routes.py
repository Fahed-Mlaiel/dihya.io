"""
Routes RESTful & GraphQL pour la science (IA, VR, AR, etc.)
...
def list_projects():
    """Liste les projets science (multilingue, sécurisé, audité)."""
...
# ...@require_role(['admin'])...
def create_project():
    """Crée un projet science (validation, RGPD, fallback IA, audit)."""
    data = request.json
