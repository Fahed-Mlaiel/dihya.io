"""
Internationalisation dynamique Marketing – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Campagne ajoutée': 'Campagne ajoutée'},
    'en': {'Accès refusé': 'Access denied', 'Campagne ajoutée': 'Campaign added'},
    # ... autres langues ...
}
