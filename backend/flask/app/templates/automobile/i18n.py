"""
Internationalisation dynamique Automobile – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Véhicule ajouté': 'Véhicule ajouté'},
    'en': {'Accès refusé': 'Access denied', 'Véhicule ajouté': 'Vehicle added'},
    # ... autres langues ...
}
