"""
Internationalisation dynamique Science – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Expérience ajoutée': 'Expérience ajoutée'},
    'en': {'Accès refusé': 'Access denied', 'Expérience ajoutée': 'Experiment added'},
    # ... autres langues ...
}
