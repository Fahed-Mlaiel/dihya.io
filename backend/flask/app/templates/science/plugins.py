"""
Gestion des plugins métier Science – Dihya Coding
...
# def after_add_experiment_plugin(data):
#     ...
# register_plugin_hook('after_add_experiment', after_add_experiment_plugin)
