"""
Internationalisation dynamique Arts – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Œuvre ajoutée': 'Œuvre ajoutée'},
    'en': {'Accès refusé': 'Access denied', 'Œuvre ajoutée': 'Artwork added'},
    # ... autres langues ...
}
