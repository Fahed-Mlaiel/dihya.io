"""
Internationalisation dynamique Loisirs – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Loisir ajouté': 'Loisir ajouté'},
    'en': {'Accès refusé': 'Access denied', 'Loisir ajouté': 'Leisure added'},
    # ... autres langues ...
}
