"""
Utilitaires métier Loisirs – Dihya Coding
...
def validate_loisir_payload(data: Dict[str, Any]) -> None:
    """Valide le payload loisir (type hints, docstring, RGPD)."""
    if 'nom' not in data or 'type' not in data:
        raise ValueError(translate('Données loisir invalides', get_locale()))
