"""
Internationalisation dynamique Voyage – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Voyage ajouté': 'Voyage ajouté'},
    'en': {'Accès refusé': 'Access denied', 'Voyage ajouté': 'Trip added'},
    # ... autres langues ...
}
