"""
Internationalisation dynamique Services à la Personne – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Service ajouté': 'Service ajouté'},
    'en': {'Accès refusé': 'Access denied', 'Service ajouté': 'Service added'},
    # ... autres langues ...
}
