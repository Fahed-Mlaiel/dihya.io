"""
Gestion des plugins métier Services à la Personne – Dihya Coding
...
# def after_add_service_plugin(data):
#     ...
# register_plugin_hook('after_add_service', after_add_service_plugin)
