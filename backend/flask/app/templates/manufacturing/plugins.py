"""
Gestion des plugins métier Manufacturing – Dihya Coding
...
# def after_create_production_plugin(data):
#     ...
# register_plugin_hook('after_create_production', after_create_production_plugin)
