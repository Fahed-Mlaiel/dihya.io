"""
Internationalisation dynamique Manufacturing – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Production créée': 'Production créée'},
    'en': {'Accès refusé': 'Access denied', 'Production créée': 'Production created'},
    # ... autres langues ...
}
