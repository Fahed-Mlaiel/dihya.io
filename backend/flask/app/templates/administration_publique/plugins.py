"""
Gestion des plugins métier Administration Publique – Dihya Coding
...
# def after_add_demande_plugin(data):
#     ...
# register_plugin_hook('after_add_demande', after_add_demande_plugin)
