"""
Internationalisation dynamique Administration Publique – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Demande ajoutée': 'Demande ajoutée'},
    'en': {'Accès refusé': 'Access denied', 'Demande ajoutée': 'Request added'},
    # ... autres langues ...
}
