"""
Internationalisation dynamique Sport – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Sport ajouté': 'Sport ajouté'},
    'en': {'Accès refusé': 'Access denied', 'Sport ajouté': 'Sport added'},
    # ... autres langues ...
}
