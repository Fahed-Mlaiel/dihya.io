"""
Internationalisation dynamique BTP – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Chantier ajouté': 'Chantier ajouté'},
    'en': {'Accès refusé': 'Access denied', 'Chantier ajouté': 'Site added'},
    # ... autres langues ...
}
