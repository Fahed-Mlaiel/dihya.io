"""
Internationalisation dynamique Tourisme – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Tour ajouté': 'Tour ajouté'},
    'en': {'Accès refusé': 'Access denied', 'Tour ajouté': 'Tour added'},
    # ... autres langues ...
}
