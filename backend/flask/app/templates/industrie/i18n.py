"""
Internationalisation dynamique Industrie – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Machine ajoutée': 'Machine ajoutée'},
    'en': {'Accès refusé': 'Access denied', 'Machine ajoutée': 'Machine added'},
    # ... autres langues ...
}
