"""
Gestion des plugins métier Santé – Dihya Coding
...
# def after_create_patient_plugin(data):
#     ...
# register_plugin_hook('after_create_patient', after_create_patient_plugin)
