"""
Internationalisation dynamique Santé – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Patient créé': 'Patient créé'},
    'en': {'Accès refusé': 'Access denied', 'Patient créé': 'Patient created'},
    # ... autres langues ...
}
