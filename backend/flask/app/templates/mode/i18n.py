"""
Internationalisation dynamique Mode – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Collection ajoutée': 'Collection ajoutée'},
    'en': {'Accès refusé': 'Access denied', 'Collection ajoutée': 'Collection added'},
    # ... autres langues ...
}
