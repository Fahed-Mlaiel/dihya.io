"""
Internationalisation dynamique Logistique – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Expédition créée': 'Expédition créée'},
    'en': {'Accès refusé': 'Access denied', 'Expédition créée': 'Shipment created'},
    # ... autres langues ...
}
