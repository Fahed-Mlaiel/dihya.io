"""
Gestion des plugins métier Logistique – Dihya Coding
...
# def after_create_logistique_plugin(data):
#     ...
# register_plugin_hook('after_create_logistique', after_create_logistique_plugin)
