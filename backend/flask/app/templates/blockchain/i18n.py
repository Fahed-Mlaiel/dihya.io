"""
Internationalisation dynamique Blockchain – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Bloc ajouté': 'Bloc ajouté'},
    'en': {'Accès refusé': 'Access denied', 'Bloc ajouté': 'Block added'},
    # ... autres langues ...
}
