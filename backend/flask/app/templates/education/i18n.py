"""
Internationalisation dynamique Éducation – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Cours ajouté': 'Cours ajouté'},
    'en': {'Accès refusé': 'Access denied', 'Cours ajouté': 'Course added'},
    # ... autres langues ...
}
