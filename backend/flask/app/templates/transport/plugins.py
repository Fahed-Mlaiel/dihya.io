"""
Gestion des plugins métier Transport – Dihya Coding
...
# def after_add_transport_plugin(data):
#     ...
# register_plugin_hook('after_add_transport', after_add_transport_plugin)
