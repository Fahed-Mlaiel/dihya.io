"""
Internationalisation dynamique Transport – Dihya Coding
...
LOCALES: Dict[str, Dict[str, str]] = {
    'fr': {'Accès refusé': 'Accès refusé', 'Transport ajouté': 'Transport ajouté'},
    'en': {'Accès refusé': 'Access denied', 'Transport ajouté': 'Transport added'},
    # ... autres langues ...
}
