# Realtime Backend – Dihya Coding

Ce dossier regroupe les scripts et outils de gestion du temps réel : sécurité, RGPD, accessibilité, audit, CI/CD, multilingue, documentation, plugins.
