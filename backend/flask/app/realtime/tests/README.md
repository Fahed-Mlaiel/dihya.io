# Tests Realtime Backend – Dihya Coding

Ce dossier regroupe les tests de gestion du temps réel : sécurité, RGPD, accessibilité, audit, CI/CD, multilingue, documentation, plugins.
