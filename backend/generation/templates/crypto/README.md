...
## Extension DWeb/IPFS
- Export des logs critiques et rapports de génération crypto sur IPFS ou stockage décentralisé
...
```yaml
- name: Tests template crypto
  run: npm run test --workspace=backend/generation/templates/crypto
```
