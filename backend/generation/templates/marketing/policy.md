# Politique de sécurité et conformité – Marketing

## Accès & Rôles
- **admin** : accès total, audit, gestion des utilisateurs, export RGPD
- **user** : création/édition de campagnes, accès restreint, audit
...
- **user**: create/edit campaigns, restricted access, audit
