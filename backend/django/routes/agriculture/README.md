...
Ce module gère les routes, modèles, vues, permissions, audit et tests pour les projets agricoles dans Dihya.

## Fonctionnalités principales
- API REST & GraphQL pour projets agricoles
- Sécurité maximale (CORS, JWT, RBAC, audit, WAF, anti-DDOS)
- Multitenancy, gestion des rôles (admin, user, invité)
- Internationalisation dynamique (fr, en, ar, amazigh, de, zh, ja, ko, nl, he, fa, hi, es)
- Intégration plugins agricoles souverains
...
## Extensibilité
Ajoutez vos plugins agricoles dans `plugins/` ou via l’API.
