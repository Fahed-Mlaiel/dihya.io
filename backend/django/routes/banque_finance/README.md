...
Ce module gère les routes, modèles, vues, permissions, audit et tests pour les projets banque/finance dans Dihya.

## Fonctionnalités principales
- API REST & GraphQL pour projets banque/finance
- Sécurité maximale (CORS, JWT, RBAC, audit, WAF, anti-DDOS)
- Multitenancy, gestion des rôles (admin, user, invité)
- Internationalisation dynamique (fr, en, ar, amazigh, de, zh, ja, ko, nl, he, fa, hi, es)
- Intégration plugins banque/finance souverains
...
## Extensibilité
Ajoutez vos plugins banque/finance dans `plugins/` ou via l’API.
