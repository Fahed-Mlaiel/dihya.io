...
Ce module gère les routes, modèles, vues, permissions, audit et tests pour les projets d’intelligence artificielle dans Dihya.

## Fonctionnalités principales
- API REST & GraphQL pour projets IA
