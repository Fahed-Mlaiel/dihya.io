...
Ce module gère les routes, modèles, vues, permissions, audit et tests pour les projets artistiques dans Dihya.

## Fonctionnalités principales
- API REST & GraphQL pour projets artistiques
- Sécurité maximale (CORS, JWT, RBAC, audit, WAF, anti-DDOS)
- Multitenancy, gestion des rôles (admin, user, invité)
- Internationalisation dynamique (fr, en, ar, amazigh, de, zh, ja, ko, nl, he, fa, hi, es)
- Intégration plugins artistiques souverains
...
## Extensibilité
Ajoutez vos plugins artistiques dans `plugins/` ou via l’API.
