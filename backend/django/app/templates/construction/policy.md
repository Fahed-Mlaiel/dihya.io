# 🏢 Dihya – Politique d’Utilisation & Sécurité des Templates Construction
...
Garantir la sécurité, la souveraineté, la conformité et la qualité des templates métiers utilisés pour la construction (chantiers, devis, rapports, audits, matériaux, IA, plugins) dans la plateforme Dihya.
...
- **Tests d’intégrité** : chaque template doit passer les scripts de validation fournis (`validate_construction_template.py`)
