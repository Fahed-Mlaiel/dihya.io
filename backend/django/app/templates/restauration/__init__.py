"""
Dihya – Module Restauration
---------------------------
Ce package fournit les templates et outils pour la gestion de la restauration (cantine, menus, réservations, allergies, etc.) sur la plateforme Dihya.
...
À importer dans vos vues, tests, ou scripts restauration.
"""
...
# Chargement dynamique des sous-modules restauration si besoin
try:
    import importlib
    import os
    ...
    logger.warning(f"Chargement dynamique restauration partiel : {e}")
