"""
Dihya - Industrie Templates
===========================

FR : Ce package contient les templates HTML du module "industrie" de Dihya.
EN : This package contains the HTML templates for the "industrie" (industry) module of Dihya.
AR : يحتوي هذا المجلد على قوالب HTML لوحدة "الصناعة" في ديهيا.
TZ : Asgwas agi yegber templates n HTML n uγmis "industrie" n Dihya.
