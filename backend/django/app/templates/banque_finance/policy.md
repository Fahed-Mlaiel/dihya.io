# 💳 Dihya – Politique d’Utilisation & Sécurité des Templates Banque & Finance
...
Garantir la sécurité, la souveraineté, la conformité et la qualité des templates métiers utilisés pour la banque et la finance (contrats, relevés, transactions, audits, IA, plugins) dans la plateforme Dihya.
...
- **Formats acceptés** : .json, .yaml, .yml, .py, .md, .pdf (contrats, relevés, scripts de génération uniquement)
...
- **Tests d’intégrité** : chaque template doit passer les scripts de validation fournis (`validate_banque_finance_template.py`)
...
- **Séparer** les templates par usage (contrats, relevés, transactions, audits, scripts)
