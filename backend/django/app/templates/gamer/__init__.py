...
FR : Ce package contient les templates HTML du module "gamer" de Dihya.
EN : This package contains the HTML templates for the "gamer" module of Dihya.
AR : يحتوي هذا المجلد على قوالب HTML لوحدة "gamer" في ديهيا.
TZ : Asgwas agi yegber templates n HTML n uγmis "gamer" n Dihya.
