...
FR : Ce package contient les templates HTML du module "hotellerie" de Dihya.
EN : This package contains the HTML templates for the "hotellerie" module of Dihya.
AR : يحتوي هذا المجلد على قوالب HTML لوحدة "الفندقة" في ديهيا.
TZ : Asgwas agi yegber templates n HTML n uγmis "hotellerie" n Dihya.
