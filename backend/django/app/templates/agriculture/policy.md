# 🌱 Dihya – Politique d’Utilisation & Sécurité des Templates Agriculture
...
Garantir la sécurité, la souveraineté, la conformité et la qualité des templates métiers utilisés pour l’agriculture (fiches cultures, modèles météo, rapports, workflows, IA, plugins) dans la plateforme Dihya.
...
- **Formats acceptés** : .json, .yaml, .yml, .py, .md, .pdf (fiches, modèles, scripts de génération uniquement)
...
- **Tests d’intégrité** : chaque template doit passer les scripts de validation fournis (`validate_agriculture_template.py`)
...
- **Séparer** les templates par usage (fiches, modèles météo, rapports, workflows, scripts)
