...
FR : Ce package contient les templates HTML du module "health" de Dihya.
EN : This package contains the HTML templates for the "health" module of Dihya.
AR : يحتوي هذا المجلد على قوالب HTML لوحدة "health" في ديهيا.
TZ : Asgwas agi yegber templates n HTML n uγmis "health" n Dihya.
