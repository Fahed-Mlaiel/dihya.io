"""
Dihya – Audit et traçabilité pour Services à la Personne
- Logs, conformité RGPD, sécurité, multilingue
"""
import logging
from django.utils.translation import gettext_lazy as _

auditor = logging.getLogger('services_personne.audit')
...
def log_action(user, action, obj=None, extra=None):
    ...
    try:
        import csv
        with open('/tmp/services_personne_audit.csv', 'a') as f:
            writer = csv.writer(f)
