"""
Gestion avancée des plugins banque/finance (ajout, suppression, audit, sécurité, i18n).
"""
from typing import List, Dict, Any
import logging

class BanqueFinancePluginManager:
    def __init__(self):
        self.plugins: List[Dict[str, Any]] = []
        self.audit_logger = logging.getLogger("dihya.banque_finance.plugins")
...
plugin_manager = BanqueFinancePluginManager()
plugin_manager.register_plugin({
    'name': 'open_banking',
    'version': '1.0',
    'description': {
        'fr': 'Intégration Open Banking',
        'en': 'Open Banking integration',
        'ar': 'تكامل البنوك المفتوحة',
        'tzm': 'Asefru n open banking',
    },
    'author': 'Dihya',
    'license': 'AGPL',
    'multitenant': True,
