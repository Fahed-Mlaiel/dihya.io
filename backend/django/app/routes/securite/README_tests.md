# 🧪 Dihya – Tests du module Sécurité

## Objectif
Garantir la robustesse, la sécurité, la conformité RGPD, la souveraineté et la qualité du module sécurité via des tests unitaires, d’intégration et E2E.
...
## Exécution
```bash
python manage.py test backend/django/app/routes/securite/
```
