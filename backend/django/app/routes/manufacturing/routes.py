"""
Dihya – Django Manufacturing API Routes Ultra Avancé
---------------------------------------------------
- Endpoints REST pour usines, lignes de production, ordres de fabrication, équipements, stocks, incidents, maintenance, IA manufacturing, logs, audit
...
🇫🇷 Routes Django REST manufacturing (sécurité, multilingue, souveraineté)
🇬🇧 Django REST manufacturing routes (security, multilingual, sovereignty)
🇦🇪 مسارات Django REST للتصنيع (الأمان، متعدد اللغات، السيادة)
ⵣ Iwalen Django REST n tazwart n manufacturing (amatu, multilingual, sovereignty)
"""
...
router.register(r'ia', views.IAManufacturingViewSet, basename='ia-manufacturing')
