"""
Test d'intégration avancé pour la gestion Mode dans Dihya.
...
def test_mode_routes_security_i18n(api_client):
    ...
    ia_url = reverse('mode-ia-generate')
    response = api_client.post(ia_url, {'prompt': 'Génère une tendance'}, format='json')
